...
| ByteRTCWarningCodeInvalidCanvasHandle | -6001 | 指定的内部渲染画布句柄无效。  <br><br/>当你调用 [setLocalVideoCanvas:withCanvas:](70086.md#ByteRTCVideo-setlocalvideocanvas-withcanvas) 或 [setRemoteVideoCanvas:withIndex:withCanvas:](70086.md#ByteRTCVideo-setremotevideocanvas-withindex-withcanvas) 时指定了无效的画布句柄，触发此回调。 |
