...
成功调用 [createPages](131850#WhiteBoard-createpages) 或 [removePages](131850#WhiteBoard-removepages) 后，在本端和远端触发本回调。
...
+ 调用 [setBoardBackground](131850#WhiteBoard-setboardbackground) 后在本端和远端触发本回调。
