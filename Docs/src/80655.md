...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=UnbanUserStream&Version=2020-12-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=UnbanUserStream&serviceCode=rtc&version=2020-12-01&groupName=房间管理" />
...
const data = [
  ...
  },
  {
    "name": "Video",
    "key": "0-4",
    "title": "是否解封视频流，置为 true 时，表示解封视频流",
  ...
  },
  {
    "name": "Audio",
    "key": "0-5",
    "title": "是否解封音频流，置为 true 时，表示解封音频流",
    "example": "<code>true</code>",
    "required": "否",
    "type": "Boolean"
  }
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=UnbanUserStream&Version=2020-12-01
{
    "AppId": "You****pId",
    "RoomId": "Your_RoomId",
    "UserId": "Your_UserId",
