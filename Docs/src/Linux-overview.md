...
| [pullExternalAudioFrame](Linux-api.md#IRTCVideo-pullexternalaudioframe) | 拉取远端音频数据。<br><br/>可用于自定义音频渲染。 |
...
| [startAudioRecording](Linux-api.md#IRTCVideo-startaudiorecording) | 开启录制语音通话，生成本地文件。 |
...
| [onLicenseWillExpire](Linux-callback.md#IRTCVideoEventHandler-onlicensewillexpire) | license过期时间提醒 |
...
| 回调 | 描述 |
| --- | --- |
| [isSupportClientPushStream](Linux-callback.md#ITranscoderObserver-issupportclientpushstream) | 是否具有推流能力。  <br><br/>+ false：不具备推流能力（默认值）  <br><br/>+ true：具备推流能力 |
| [onMixingAudioFrame](Linux-callback.md#ITranscoderObserver-onmixingaudioframe) | 合流音频回调，运行在音频回调线程 |
| [onMixingVideoFrame](Linux-callback.md#ITranscoderObserver-onmixingvideoframe) | 合流视频回调，运行在视频回调线程 |
| [onMixingDataFrame](Linux-callback.md#ITranscoderObserver-onmixingdataframe) | 视频 SEI 帧回调，运行在视频回调线程 |
