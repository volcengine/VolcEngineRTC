...
| 在当前所在房间内发布本地通过摄像头/麦克风采集的媒体流 | [publishStream](70080#publishstream) |
| 停止将本地摄像头/麦克风采集的媒体流发布到当前所在房间中 | [unpublishStream](70080#unpublishstream) |
...
| 开启/关闭耳返功能 | [setEarMonitorMode](70080#setearmonitormode)  |
| 设置耳返的音量 |  [setEarMonitorVolume](70080#setearmonitorvolume) |
...
| 收到音频同步信息 | [onStreamSyncInfoReceived](70081#onstreamsyncinforeceived) |
| 音乐文件播放状态改变回调 | [onMediaPlayerStateChanged](70081#IMediaPlayerEventHandler-onmediaplayerstatechanged) |
| 收到音乐文件播放进度回调 | [onMediaPlayerPlayingProgress](70081#onmediaplayerplayingprogress) |
