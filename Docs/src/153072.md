...
| 开启内部音频采集 | [startAudioCapture](Android-api.md#startaudiocapture) |
| 关闭内部音频采集 |  [stopAudioCapture](Android-api.md#stopaudiocapture)  |
| 设置当前音频播放路由 | [setDefaultAudioRoute](Android-api.md#setdefaultaudioroute) |
| 设置音质档位 | [setAudioProfile:](Android-api.md#setaudioprofile) |
| 开启音量信息提示 | [enableAudioPropertiesReport](Android-api.md#enableaudiopropertiesreport) |
...
| 在当前所在房间内发布本地通过摄像头/麦克风采集的媒体流 | [publishStream](Android-api.md#publishstream) |
| 停止将本地摄像头/麦克风采集的媒体流发布到当前所在房间中 | [unpublishStream](Android-api.md#unpublishstream) |
| 开启混音播放 | [startAudioMixing](Android-api.md#startaudiomixing)  |
| 关闭混音播放 | [stopAudioMixing](Android-api.md#stopaudiomixing)|
...
| 开启/关闭耳返功能 | [setEarMonitorMode](Android-api.md#setearmonitormode)  |
| 设置耳返的音量 |  [setEarMonitorVolume](Android-api.md#setearmonitorvolume) |
...
| 收到音频同步信息 | [onStreamSyncInfoReceived](Android-callback.md#onstreamsyncinforeceived) |
| 音乐文件播放状态改变回调 | [onAudioMixingStateChanged](Android-callback.md#onaudiomixingstatechanged) |
| 收到音乐文件播放进度回调 | [onAudioMixingPlayingProgress](Android-callback.md#onaudiomixingplayingprogress) |