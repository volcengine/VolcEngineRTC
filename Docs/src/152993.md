...
| 开启内部视频采集 | [startVideoCapture](Android-api.md#startvideocapture) |
| 创建 RTC 房间 | [createRTCRoom](Android-api.md#creatertcroom) |
| 设置用户可见性 |  [setUserVisibility](Android-api.md#setuservisibility)|
| 加入RTC 房间 | [joinRoom](Android-api.md#joinroom) |
| 开始播放音频文件 | [startAudioMixing](Android-api.md#startaudiomixing)  |
| 设置混音时音频文件播放进度回调的间隔 | [setAudioMixingProgressInterval](Android-api.md#setaudiomixingprogressinterval) |
| 发送音频流同步信息 | [sendStreamSyncInfo](Android-api.md#sendstreamsyncinfo) |
| 订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [subscribeStream](Android-api.md#subscribestream) |
| 取消订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [unSubscribeStream](Android-api.md#unsubscribestream) |
| 启动 PCM 音频数据混音 | [enableAudioMixingFrame](Android-api.md#enableaudiomixingframe) |
| 注册音频数据回调观察者。 | [registerAudioFrameObserver](Android-api.md#registeraudioframeobserver) |
| 开启音频回调 |[enableAudioFrameCallback](Android-api.md#enableaudioframecallback) |
| 推送 PCM 音频帧数据用于混音 |[pushAudioMixingFrame](Android-api.md#pushaudiomixingframe) |
| 关闭 PCM 混音 |  [disableAudioMixingFrame](Android-api.md#disableaudiomixingframe) |
| 启用音频信息提示。 | [enableAudioPropertiesReport](Android-api.md#enableaudiopropertiesreport) |
| 设置当前音频文件的声道模式 | [setAudioMixingDualMonoMode](Android-api.md#setaudiomixingdualmonomode) |
| 暂停播放音频文件 | [pauseAudioMixing](Android-api.md#pauseaudiomixing)  |
| 恢复播放音频文件 |  [resumeAudioMixing](Android-api.md#resumeaudiomixing)|
| 打开/关闭耳返功能 |  [setEarMonitorMode](Android-api.md#setearmonitormode) |
| 设置耳返音量 |  [setEarMonitorVolume](Android-api.md#setearmonitorvolume) |
| 调节混音的音量大小，包括音频文件混音和 PCM 混音 |  [setAudioMixingVolume](Android-api.md#setaudiomixingvolume) |
| 调节音频采集音量 |  [setCaptureVolume](Android-api.md#setcapturevolume) |
| 设置混响特效类型 |  [setVoiceReverbType](Android-api.md#setvoicereverbtype) |
| 离开 RTC 房间 | [leaveRoom](Android-api.md#leaveroom)  |
| 销毁 RTC 房间引擎 | [destroy](Android-api.md#destroy) |
| 关闭内部音频采集 |  [stopAudioCapture](Android-api.md#stopaudiocapture) |
| 销毁 RTCVideo 对象 |  [destroyRTCVideo](Android-api.md#destroyrtcvideo) |
...
| 音频流同步信息回调 | [onStreamSyncInfoReceived](Android-callback.md#onstreamsyncinforeceived) |
| 返回远端单个用户的音频数据 | [onRemoteUserAudioFrame](Android-callback.md#onremoteuseraudioframe) |
...
| 音频混音文件播放状态改变时回调 | [onAudioMixingStateChanged](Android-callback.md#onaudiomixingstatechanged)|
| 音频播放路由变化回调 |[onAudioRouteChanged](Android-callback.md#onaudioroutechanged) |
| 混音音频文件播放进度回调 | [onAudioMixingPlayingProgress](Android-callback.md#onaudiomixingplayingprogress)|
| 远端视频流的状态改变回调 | [onRemoteVideoStateChanged](Android-callback.md#onremotevideostatechanged) |