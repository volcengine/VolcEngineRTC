...
| 开启内部视频采集 | [startVideoCapture](Android-api#startvideocapture) |
| 创建 RTC 房间 | [createRTCRoom](Android-api#creatertcroom) |
| 设置用户可见性 |  [setUserVisibility](Android-api#setuservisibility)|
| 加入RTC 房间 | [joinRoom](Android-api#joinroom) |
| 开始播放音频文件 | [open](Android-api#IMediaPlayer-open) |
...
| 订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [subscribeStream](Android-api#subscribestream) |
| 取消订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [unSubscribeStream](Android-api#unsubscribestream) |
| 启动 PCM 音频数据混音 | [openWithCustomSource](Android-api#IMediaPlayer-openwithcustomsource) |
| 注册音频数据回调观察者。 | [registerAudioFrameObserver](Android-api#registeraudioframeobserver) |
| 开启音频回调 |[enableAudioFrameCallback](Android-api#enableaudioframecallback) |
| 推送 PCM 音频帧数据用于混音 |[pushExternalAudioFrame](Android-api#pushexternalaudioframe) |
| 启用音频信息提示。 | [enableAudioPropertiesReport](Android-api#enableaudiopropertiesreport) |
...
| 打开/关闭耳返功能 |  [setEarMonitorMode](Android-api#setearmonitormode) |
| 设置耳返音量 |  [setEarMonitorVolume](Android-api#setearmonitorvolume) |
| 调节混音的音量大小，包括音频文件混音和 PCM 混音 | [setVolume](Android-api#IMediaPlayer-setvolume) |
...
| 销毁 RTC 房间引擎 | [destroy](Android-api#destroy) |
| 关闭内部音频采集 |  [stopAudioCapture](Android-api#stopaudiocapture) |
| 销毁 RTCVideo 对象 |  [destroyRTCVideo](Android-api#destroyrtcvideo) |
...
| 音频流同步信息回调 | [onStreamSyncInfoReceived](Android-callback#onstreamsyncinforeceived) |
| 返回远端单个用户的音频数据 | [onRemoteUserAudioFrame](Android-callback#onremoteuseraudioframe) |
| 本地音频的相关信息回调|[onLocalAudioPropertiesReport](Android-callback#onlocalaudiopropertiesreport) |
| 订阅的远端用户的音频信息回调 | [onRemoteAudioPropertiesReport](Android-callback#onremoteaudiopropertiesreport) |
| 音频混音文件播放状态改变时回调 | [onAudioMixingStateChanged](Android-callback#onaudiomixingstatechanged)|
| 音频播放路由变化回调 |[onAudioRouteChanged](Android-callback#onaudioroutechanged) |
| 混音音频文件播放进度回调 | [onMediaPlayerPlayingProgress](Android-callback#IMediaPlayerEventHandler-onmediaplayerplayingprogress)|
| 远端视频流的状态改变回调 | [`onRemoteVideoStateChanged`](Android-callback#IRTCVideoEventHandler-onremotevideostatechanged) |
