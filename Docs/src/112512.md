...
| 设置本地渲染和编码镜像 |  [setLocalVideoMirrorType:](70086.md#setlocalvideomirrortype)  |
| 设置本地视频渲染视图 |  [setLocalVideoCanvas:withCanvas](70086.md#setlocalvideocanvas-withcanvas)  |
...
| 设置远端用户视频渲染视图 | [setRemoteVideoCanvas:withCanvas:](70086.md#setremotevideocanvas-withcanvas)  |
| 开启PCM 音频数据混音 | [enableAudioMixingFrame:type:](70086.md#enableaudiomixingframe-type)|
...
| 给房间内的所有其他用户发送文本消息 | [sendRoomMessage:](70086.md#sendroommessage) |
| 调节远端用户用通话音量 | [setPlaybackVolume: ](70086.md#setplaybackvolume) |
| 打开音量闪避功能 | [enablePlaybackDucking:](70086.md#enableplaybackducking) |
...
| 销毁 RTCVideo 对象 | [destroy](70086.md#destroy) |
...
| 音频播放路由变化时，收到该回调 | [rtcEngine:onAudioRouteChanged:](70087.md#rtcengine-onaudioroutechanged)  |
...
| 收到房间内广播文本消息回调 | [rtcRoom:onRoomMessageReceived:message:](70087.md#rtcroom-onroommessagereceived-message) |