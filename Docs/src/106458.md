...
- Android
	- [setVideoRotationMode](Android-api.md#setvideorotationmode)
		
	- [setRemoteVideoCanvas](Android-api.md#setremotevideocanvas)
		

- iOS
	- [setVideoRotationMode](iOS-api.md#setvideorotationmode)
		
	- [setRemoteVideoCanvas](iOS-api.md#setremotevideocanvas-withindex-withcanvas)