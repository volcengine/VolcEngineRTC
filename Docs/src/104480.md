...
混音错误码，通过 [onAudioMixingStateChanged](104479.md#onaudiomixingstatechanged) 回调。
...
转推直播错误码，通过 [onStreamMixingEvent](104479.md#onstreammixingevent) 回调。
...
跨房间转发媒体流错误码，通过 [onForwardStreamError](104479.md#onforwardstreamerror) 回调。
