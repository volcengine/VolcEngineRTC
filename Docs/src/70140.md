...
1. 确保当前使用内部视频采集模块： `VIDEO_SOURCE_TYPE_INTERNAL`。默认为内部采集，如果当前为外部采集应先调用 [`setVideoSourceType`](70080#RTCVideo-setvideosourcetype) 设置视频源及屏幕流。
	
2. 发送端调用 SEI 发送接口 [`sendSEIMessage`](70080#RTCVideo-sendseimessage-2)，随视频帧发送 SEI。
...
3. 接收端会收到 SEI 回调： [`onSEIMessageReceived`](70081#IRTCVideoEventHandler-onseimessagereceived)
	

1. 对于纯音频应用，通过黑帧视频流发送 SEI 数据时。流的发送状态会通过 [`onSEIStreamUpdate`](70081#IRTCVideoEventHandler-onseistreamupdate) 通知远端用户。 手动订阅模式下，需要订阅该黑帧视频流。
...
1. 调用 [`GLTextureVideoFrameBuilder-setExternalDataInfo`](70083#GLTextureVideoFrameBuilder-setexternaldatainfo)，可设置纹理格式视频数据返回帧的 SEI 数据。

2. 调用 [`CpuBufferVideoFrameBuilder-setExternalDataInfo`](70083#CpuBufferVideoFrameBuilder-setexternaldatainfo) ，可设置 CpuBuffer 视频帧的 SEI 数据。

3. 调用 [`pushExternalVideoFrame`](70080#RTCVideo-pushexternalvideoframe)，可将视频帧数据用 [`VideoFrame`](70083#videoframe) 类封装后传递给 SDK。
4. 调用 [`getExternalDataInfo`](70083#VideoFrame-getexternaldatainfo)，可获取 SEI 数据。
...
1. 调用 [`sendStreamSyncInfo`](70080#RTCVideo-sendstreamsyncinfo) 发送 SEI 。
...
2. 调用成功后，远端收到 SEI 回调： [`onStreamSyncInfoReceived`](70081#IRTCVideoEventHandler-onstreamsyncinforeceived)
...
```
2. 主持人端调用 [`startPushMixedStreamToCDN`](70080#RTCVideo-startpushmixedstreamtocdn) 和 [`updatePushMixedStreamToCDN`](70080#RTCVideo-updatepushmixedstreamtocdn) 接口发起和更新转推直播任务时，合流布局和背景等信息作为 SEI 透传到 RTMP 流中。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 发送 SEI | [`sendSEIMessage`](70080#RTCVideo-sendseimessage-2) | [`sendSEIMessage:andMessage:andRepeatCount:andCountPerFrame:`](70086#ByteRTCVideo-sendseimessage-andmessage-andrepeatcount-andcountperframe) | [`sendSEIMessage:andMessage:andRepeatCount:andCountPerFrame:`](70092#ByteRTCVideo-sendseimessage-andmessage-andrepeatcount-andcountperframe) | [`sendSEIMessage`](70095#IRTCVideo-sendseimessage) | [`sendSEIMessage`](85516#IRTCVideo-sendseimessage) | [`sendSEIMessage`](85532#rtcvideo-sendseimessage) | [`sendSEIMessage`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/sendSEIMessage.html) | [`SendSEIMessage`](191859#IRTCVideo-sendseimessage) | [`sendSEIMessage`](104478#rtcengine-sendseimessage) |
| 接收 SEI | [`onSEIMessageReceived`](70081#IRTCVideoEventHandler-onseimessagereceived) | [`rtcEngine:onSEIMessageReceived:andMessage:`](70087#ByteRTCVideoDelegate-rtcengine-onseimessagereceived-andmessage) | [`rtcEngine:onSEIMessageReceived:andMessage:`](70093#ByteRTCVideoDelegate-rtcengine-onseimessagereceived-andmessage) | [`onSEIMessageReceived`](70096#IRTCVideoEventHandler-onseimessagereceived) | [`onSEIMessageReceived`](85517#IRTCVideoEventHandler-onseimessagereceived) | [`onSEIMessageReceived`](85533#rtcvideocallback-onseimessagereceived) | [`onSEIMessageReceived`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_event_handler/RTCVideoEventHandler/onSEIMessageReceived.html) | [`OnSEIMessageReceivedEventHandler`](191860#onseimessagereceivedeventhandler) | [`onSEIMessageReceived`](104479#engineevents-onseimessagereceived) |
| 将 SEI 插入外部视频源 | [`GLTextureVideoFrameBuilder-setExternalDataInfo`](70083#GLTextureVideoFrameBuilder-setexternaldatainfo) | [`extendedData`](70088#ByteRTCVideoFrame-extendeddata) | [`extendedData`](70089#ByteRTCVideoFrame-extendeddata) | [`extra_data`](70098#VideoFrameBuilder-extra_data) |  | 无 | 无 | 无 | 无 |
| 获取外部视频源携带 SEI | [`getExternalDataInfo`](70083#VideoFrame-getexternaldatainfo) | [`onFrame:`](70088#ByteRTCVideoSinkDelegate-onframe) | [`onFrame:`](70089#ByteRTCVideoSinkDelegate-onframe) | [`getExtraDataInfo`](70098#IVideoFrame-getextradatainfo) |  | 无 | 无 | 无 | 无 |
| 音频扩展头发送数据消息 | [`sendStreamSyncInfo`](70080#RTCVideo-sendstreamsyncinfo) | [`sendStreamSyncInfo:config:`](70086#ByteRTCVideo-sendstreamsyncinfo-config) | [`sendStreamSyncInfo:config:`](70092#ByteRTCVideo-sendstreamsyncinfo-config) | [`sendStreamSyncInfo`](70095#IRTCVideo-sendstreamsyncinfo) | [`sendStreamSyncInfo`](85516#IRTCVideo-sendstreamsyncinfo) | [`sendStreamSyncInfo`](85532#rtcvideo-sendstreamsyncinfo) | [`sendStreamSyncInfo`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/sendStreamSyncInfo.html) | [`SendStreamSyncInfo`](191859#IRTCVideo-sendstreamsyncinfo) | 无 |
| 接收音频扩展头数据消息 | [`onStreamSyncInfoReceived`](70081#IRTCVideoEventHandler-onstreamsyncinforeceived) | [`rtcEngine:onStreamSyncInfoReceived:streamType:data:`](70087#ByteRTCVideoDelegate-rtcengine-onstreamsyncinforeceived-streamtype-data) | [`rtcEngine:onStreamSyncInfoReceived:streamType:data:`](70093#ByteRTCVideoDelegate-rtcengine-onstreamsyncinforeceived-streamtype-data) | [`onStreamSyncInfoReceived`](70096#IRTCVideoEventHandler-onstreamsyncinforeceived) | [`onStreamSyncInfoReceived`](85517#IRTCVideoEventHandler-onstreamsyncinforeceived) | [`onStreamSyncInfoReceived`](85533#rtcvideocallback-onstreamsyncinforeceived) | [`onStreamSyncInfoReceived`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_event_handler/RTCVideoEventHandler/onStreamSyncInfoReceived.html) | [`OnStreamSyncInfoReceivedEventHandler`](191860#onstreamsyncinforeceivedeventhandler) | 无 |
| 发起转推直播 | [`startPushMixedStreamToCDN`](70080#RTCVideo-startpushmixedstreamtocdn) | [`startPushMixedStreamToCDN:mixedConfig:observer:`](70086#ByteRTCVideo-startpushmixedstreamtocdn-mixedconfig-observer) | [`startPushMixedStreamToCDN:mixedConfig:observer:`](70092#ByteRTCVideo-startpushmixedstreamtocdn-mixedconfig-observer) | [`startPushMixedStreamToCDN`](70095#IRTCVideo-startpushmixedstreamtocdn) | 无 | [`startPushMixedStreamToCDN`](85532#rtcvideo-startpushmixedstreamtocdn) | [`startPushMixedStreamToCDN`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/startPushMixedStreamToCDN.html) | 无 | [`startLiveTranscoding`](104478#rtcengine-startlivetranscoding) |
| 更新转推直播 | [`updatePushMixedStreamToCDN`](70080#RTCVideo-updatepushmixedstreamtocdn) | [`updatePushMixedStreamToCDN:mixedConfig:`](70086#ByteRTCVideo-updatepushmixedstreamtocdn-mixedconfig) | [`updatePushMixedStreamToCDN:mixedConfig:`](70092#ByteRTCVideo-updatepushmixedstreamtocdn-mixedconfig) | [`updatePushMixedStreamToCDN`](70095#IRTCVideo-updatepushmixedstreamtocdn) | 无 | [`updatePushMixedStreamToCDN`](85532#rtcvideo-updatepushmixedstreamtocdn) | [`updatePushMixedStreamToCDN`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/updatePushMixedStreamToCDN.html) | 无 | [`updateLiveTranscoding`](104478#rtcengine-updatelivetranscoding) |
