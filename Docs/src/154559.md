...
| 给房间内的所有其他用户发送文本消息 | [sendRoomMessage](70080#sendroommessage) |
...
| 音频播放路由变化时，收到该回调 | [onAudioRouteChanged](70081#onaudioroutechanged)  |
...
| 收到房间内广播文本消息回调 | [onRoomMessageReceived](70081#onroommessagereceived) |
