...
| 音频播放路由变化时，收到该回调 | [onAudioRouteChanged](Android-callback.md#onaudioroutechanged)  |
...
| 房间内新增远端媒体流回调 |  [onUserPublishStream](Android-callback.md#onuserpublishstream)  |
| 收到房间内广播文本消息回调 | [onRoomMessageReceived](Android-callback.md#onroommessagereceived) |