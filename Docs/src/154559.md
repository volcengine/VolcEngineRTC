...
| 给房间内的所有其他用户发送文本消息 | [sendRoomMessage](Android-api#sendroommessage) |
...
| 音频播放路由变化时，收到该回调 | [onAudioRouteChanged](Android-callback#onaudioroutechanged)  |
...
| 房间内新增远端媒体流回调 |  [onUserPublishStream](Android-callback#onuserpublishstream)  |
| 收到房间内广播文本消息回调 | [onRoomMessageReceived](Android-callback#onroommessagereceived) |
