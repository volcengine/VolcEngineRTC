...
| 关闭内部视频采集 | [stopVideoCapture](70086#startvideocapture) |
| 开启内部音频采集 | [startAudioCapture](70086#startaudiocapture) |
| 关闭内部音频采集 | [stopAudioCapture](70086#stopaudiocapture) |
| 设置 RTC 编码分辨率等参数 |  [SetVideoEncoderConfig:](70086#setvideoencoderconfig) |
| 为采集到的视频流开启镜像 | [setLocalVideoMirrorType:](70086#setlocalvideomirrortype) |
...
| 在当前所在房间内发布媒体流 | [publishStream:](70086#publishstream) |
| 停止媒体流发布到当前所在房间中 | [unpublishStream:](70086#unpublishstream)  |
| 开始跨房间转发媒体流 | [startForwardStreamToRooms:](70086#startforwardstreamtorooms) |
| 停止跨房间转发媒体流 | [stopForwardStreamToRooms](70086#stopforwardstreamtorooms) |
| 设置本地视频渲染 |  [setLocalVideoCanvas:withCanvas:](70086#setlocalvideocanvas-withcanvas)  |
| 设置远端视频渲染 |  [setRemoteVideoCanvas:withCanvas:](70086#setremotevideocanvas-withcanvas) |
...
| 跨房间媒体流转发状态和错误回调 | [rtcRoom:onForwardStreamStateChanged:](70087#rtcroom-onforwardstreamstatechanged) |
