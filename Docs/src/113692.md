...
| 关闭内部视频采集 | [stopVideoCapture](iOS-api.md#startvideocapture) |
| 开启内部音频采集 | [startAudioCapture](iOS-api.md#startaudiocapture) |
| 关闭内部音频采集 | [stopAudioCapture](iOS-api.md#stopaudiocapture) |
| 设置 RTC 编码分辨率等参数 |  [SetVideoEncoderConfig:](iOS-api.md#setvideoencoderconfig) |
| 为采集到的视频流开启镜像 | [setLocalVideoMirrorType:](iOS-api.md#setlocalvideomirrortype) |
...
| 在当前所在房间内发布媒体流 | [publishStream:](iOS-api.md#publishstream) |
| 停止媒体流发布到当前所在房间中 | [unpublishStream:](iOS-api.md#unpublishstream)  |
| 开始跨房间转发媒体流 | [startForwardStreamToRooms:](iOS-api.md#startforwardstreamtorooms) |
| 停止跨房间转发媒体流 | [stopForwardStreamToRooms](iOS-api.md#stopforwardstreamtorooms) |
| 设置本地视频渲染 |  [setLocalVideoCanvas:withCanvas:](iOS-api.md#setlocalvideocanvas-withcanvas)  |
| 设置远端视频渲染 |  [setRemoteVideoCanvas:withCanvas:](iOS-api.md#setremotevideocanvas-withcanvas) |
...
| 跨房间媒体流转发状态和错误回调 | [rtcRoom:onForwardStreamStateChanged:](iOS-callback.md#rtcroom-onforwardstreamstatechanged) |