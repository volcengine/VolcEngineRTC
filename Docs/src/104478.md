...
- **返回值**
  ...
  类型: <code>Promise<[CompatibilityCheckResult](104481#compatibilitycheckresult)\></code>
...
- **参数**
  ...
  - **beautyMode**
    ...
    类型: <code>[EffectBeautyMode](104481#effectbeautymode)</code>
...
- **参数**
  ...
  - **mode**
    ...
    类型: <code>[BackgroundMode](104481#backgroundmode)</code>
...
- **参数**
  ...
  - **type**
    ...
    类型: <code>[BackgroundAIModelType](104481#backgroundaimodeltype)</code>
...
- **参数**
  ...
  - **options**
    ...
    类型: <code>[IRTCBeautyExtensionConfig](104481#irtcbeautyextensionconfig) | undefined</code>
...
- **注意**
  ...
  + 通过 [onLocalAudioPropertiesReport](104479#onlocalaudiopropertiesreport) 或 [onRemoteAudioPropertiesReport](104479#onremoteaudiopropertiesreport) 回调或 [getAudioLevel](getAudioLevel) 接口获取到的音量不会为 `0`。
