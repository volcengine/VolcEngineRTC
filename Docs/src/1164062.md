...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=SendRoomUnicast&Version=2023-07-20**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=SendRoomUnicast&serviceCode=rtc&version=2023-07-20&groupName=" />
...
const data = [
  {
    ...
    "type": "String",
    "required": "是",
    "example": "<code>SendRoomUnicast</code>",
    "description": "接口名称。当前 API 的名称为 <code>SendRoomUnicast</code>。",
    "key": "Action"
  },
  {
    "name": "Version",
...
const data = [
  ...
  },
  {
    "name": "To",
    "key": "0-3",
    "title": "消息接收用户调用 <code>login</code> 接口登录时设置的 ID，可用于接收房间内消息",
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=SendRoomUnicast&Version=2023-07-20
{
    "AppId": "661e****543cf",
    "From": "from_user_id",
    "To": "to_user_id",
