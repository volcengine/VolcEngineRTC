...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=UpdatePushMixedStreamToCDN&Version=2020-12-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=UpdatePushMixedStreamToCDN&serviceCode=rtc&version=2020-12-01&groupName=转推直播" />
...
const data = [
  ...
  },
  {
    "name": "SequenceNumber",
    "key": "0-9",
    "title": "更新请求序列号。填写该参数后，服务端会对请求进行校验，请确保最后一次更新请求的序列号大于前一次请求的序列号。<br><br>\n建议更新部分参数场景下传入此参数，以确保服务端按照最新请求进行更新。",
    "example": "<code>0</code>",
    "required": "否",
    "type": "Integer"
  }
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=UpdatePushMixedStreamToCDN&Version=2020-12-01
{
    "AppId": "Your_AppId",
