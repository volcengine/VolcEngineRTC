...
| [enablePlaybackDucking](#rtcvideo-enableplaybackducking) | 打开/关闭音量闪避功能，适用于在 RTC 通话过程中会同时播放短视频或音乐的场景，如“一起看”、“在线 KTV”等。<br>开启该功能后，当检测到远端人声时，本地的媒体播放音量会自动减弱，从而保证远端人声的清晰可辨；当远端人声消失时，本地媒体音量会恢复到闪避前的音量水平。 |
...
| `static` [setLogConfig](#rtcvideo-static-setlogconfig) | 设置日志文件 |
| `static` [getErrorDescription](#rtcvideo-static-geterrordescription) | 获取错误码的描述 |
| `static` [getCurrentProcessId](#rtcvideo-static-getcurrentprocessid) | 获取加载引擎进程的 ID 方便调试 |
| `static` [setRenderType](#rtcvideo-static-setrendertype) | 设置渲染类型 |
...
- **注意**
  ...
  + 使用此功能需要集成特效 SDK，建议使用特效 SDK V4.3.2+ 版本。
...
### static-getSDKVersion <span id="rtcvideo-static-getsdkversion"></span> 
...
### static-setLogConfig <span id="rtcvideo-static-setlogconfig"></span> 
...
### static-getErrorDescription <span id="rtcvideo-static-geterrordescription"></span> 
...
### static-getCurrentProcessId <span id="rtcvideo-static-getcurrentprocessid"></span> 
...
### static-setRenderType <span id="rtcvideo-static-setrendertype"></span> 
