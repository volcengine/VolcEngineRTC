...
| 关闭内部视频采集 | [stopVideoCapture](Android-api.md#startvideocapture) |
| 开启内部音频采集 | [startAudioCapture](Android-api.md#startaudiocapture) |
| 关闭内部音频采集 | [stopAudioCapture](Android-api.md#stopaudiocapture) |
| 设置 RTC 编码分辨率等参数 |  [SetVideoEncoderConfig](Android-api.md#setvideoencoderconfig) |
| 为采集到的视频流开启镜像 | [setLocalVideoMirrorType](Android-api.md#setlocalvideomirrortype)  |
...
| 在当前所在房间内发布媒体流 | [publishStream](Android-api.md#publishstream) |
| 停止媒体流发布到当前所在房间中 | [unpublishStream](Android-api.md#unpublishstream)  |
| 开始跨房间转发媒体流 | [startForwardStreamToRooms](Android-api.md#startforwardstreamtorooms) |
| 停止跨房间转发媒体流 | [stopForwardStreamToRooms](Android-api.md#stopforwardstreamtorooms) |
| 设置本地视频渲染 |  [setLocalVideoCanvas](Android-api.md#setlocalvideocanvas)  |
| 设置远端视频渲染 |  [setRemoteVideoCanvas](Android-api.md#setremotevideocanvas) |
...
| 跨房间媒体流转发状态和错误回调 | [onForwardStreamStateChanged](Android-callback.md#onforwardstreamstatechanged) |