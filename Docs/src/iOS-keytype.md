...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCAudioScenarioMusic | 0 | （默认）音乐场景。<br/><br>此场景适用于对音乐表现力有要求的场景，如音乐直播等。<br><b>注意</b>：在此场景下，使用内置扬声器/听筒时，开关麦可能发生音量突变。<br/><br><br/>不同音频设备，开麦和闭麦状态下的使用的音量类型：<br/><table><br/><tr><th></th><th>闭麦</th><th>开麦</th></tr><br/><tr><td>内置扬声器</td><td>媒体音量</td><td>通话音量</td></tr><br/><tr><td>内置听筒</td><td>媒体音量</td><td>通话音量</td></tr><br/><tr><td>有线耳机/ USB 耳机/ 外置声卡</td><td>媒体音量</td><td>媒体音量</td></tr><br/><tr><td>蓝牙耳机</td><td>媒体音量</td><td>媒体音量</td></tr><br/></table> |
| ByteRTCAudioScenarioHighqualityCommunication | 1 | 高质量通话场景。兼顾外放/蓝牙耳机时的音频体验。<br><br/><b>注意</b>：在此场景下，使用内置扬声器/听筒时，开关麦可能发生音量突变。使用 `ByteRTCAudioScenarioHighqualityChat` 可以避免此种情况。<br><br/>不同音频设备，开麦和闭麦状态下的使用的音量类型：<br/><table><br/><tr><th></th><th>闭麦</th><th>开麦</th></tr><br/><tr><td>内置扬声器</td><td>媒体音量</td><td>通话音量</td></tr><br/><tr><td>内置听筒</td><td>媒体音量</td><td>通话音量</td></tr><br/><tr><td>有线耳机/ USB 耳机/ 外置声卡</td><td>媒体音量</td><td>媒体音量</td></tr><br/><tr><td>蓝牙耳机</td><td>通话音量</td><td>通话音量</td></tr><br/></table> |
| ByteRTCAudioScenarioCommunication | 2 | 纯通话音量场景。<br>可以最大程度地消除回声，使通话清晰度达到最优。全程使用通话音量，不会有音量突变的听感。<br/><br/>适用于需要频繁上下麦的通话或会议场景。<br><br/>但是，此场景会压低使用媒体音量进行播放的其他音频的音量，且音质会变差。 |
| ByteRTCAudioScenarioMedia | 3 | 媒体场景。<br><br/>全程使用媒体音量，不会有音量突变的听感。<br><br/>外放通话时，可能出现回声和啸叫，请联系技术支持人员。 |
| ByteRTCAudioScenarioGameStreaming | 4 | 游戏媒体场景。<br/><br>若外放通话且无游戏音效消除优化时音质不理想，请联系技术支持人员。<br/><br>不同音频设备，开麦和闭麦状态下的使用的音量类型：<br><br/><table><br/><tr><th></th><th>闭麦</th><th>开麦</th></tr><br/><tr><td>内置扬声器</td><td>媒体音量</td><td>媒体音量</td></tr><br/><tr><td>听筒</td><td>媒体音量</td><td>媒体音量</td></tr><br/><tr><td>有线耳机/ USB 耳机/ 外置声卡</td><td>媒体音量</td><td>媒体音量</td></tr><br/><tr><td>蓝牙耳机</td><td>通话音量</td><td>通话音量</td></tr><br/></table>  |
| ByteRTCAudioScenarioHighqualityChat | 5 | 高质量畅聊场景。  <br><br/>此场景和 `ByteRTCAudioScenarioHighqualityCommunication` 高度类似，唯一的差异在于：此场景下，在使用设备自带的麦克风和扬声器/听筒进行通话时，开关麦始终采用通话音量，不会引起音量类型突变。 <br><br/>不同音频设备，开麦和闭麦状态下的使用的音量类型：<table><br/><tr><th></th><th>闭麦</th><th>开麦</th></tr><br/><tr><td>内置扬声器</td><td>通话音量</td><td>通话音量</td></tr><br/><tr><td>听筒</td><td>通话音量</td><td>通话音量</td></tr><br/><tr><td>有线耳机/ USB 耳机/ 外置声卡</td><td>媒体音量</td><td>媒体音量</td></tr><br/><tr><td>蓝牙耳机</td><td>通话音量</td><td>通话音量</td></tr><br/></table> |
...
降噪模式。降噪算法受调用 [joinRoom:userInfo:roomConfig:](iOS-api.md#ByteRTCRoom-joinroom-userinfo-roomconfig) 时设置的房间模式影响。
...
@property(assign, nonatomic) NSInteger callbackOnProgressInterval;
```
设置音频文件混音时，收到 [onMediaPlayerPlayingProgress:progress:](iOS-callback.md#ByteRTCMediaPlayerEventHandler-onmediaplayerplayingprogress-progress) 的间隔。单位毫秒。
...
```
是否自动播放。如果不自动播放，调用 [start](iOS-api.md#ByteRTCMediaPlayer-start) 播放音乐文件。默认为 True。
...
```
仅在使用内存播放时，传入对应的 [ByteRTCMediaPlayerCustomSourceProvider](iOS-callback.md#bytertcmediaplayercustomsourceprovider) 实例。
...
| ByteRTCMediaDeviceErrorNotAvailableInBackground | 9 | 视频采集中断：因用户使用系统相机，应用切换到后台运行，导致采集中断。 |
| ByteRTCMediaDeviceErrorVideoInUseByAnotherClient | 10 | 视频采集中断：可能由于其他应用占用系统相机，导致视频设备暂时不可用，从而造成采集中断。 |
| ByteRTCMediaDeviceErrorNotAvailableWithMultipleForegroundApps | 11 | 视频采集中断：当前应用处于侧拉、分屏或者画中画模式时，导致采集中断。 |
| ByteRTCMediaDeviceErrorNotAvailableDueToSystemPressure | 12 | 视频采集中断：由于系统性能不足导致中断，比如设备过热。 |
...
| ByteRTCMediaDeviceWarningSetAudioRouteNotVoipMode | 23 | 当前非通话模式 ByteRTCAudioScenarioCommunication，不支持设置音频路由 |
| ByteRTCMediaDeviceWarningSetAudioRouteDeviceNotStart | 24 | 音频设备未启动，设置音频路由失败 |
| ByteRTCMediaDeviceWarningSetBluetoothModeScenarioUnsupport | 25 | 非纯媒体音频场景，此时不支持切换蓝牙传输协议。待切换至纯媒体音频场景后生效。 |
| ByteRTCMediaDeviceWarningSetBluetoothModeUnsupport | 26 | 当前不支持设置 HFP。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCVideoSuperResolutionModeOff | 0 | 关闭超分。 |
| ByteRTCVideoSuperResolutionModeOn | 1 | 开启超分。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCVideoDenoiseModeOff | 0 | 视频降噪关闭。 |
| ByteRTCVideoDenoiseModeAuto | 1 | 视频降噪开启，由 ByteRTC 后台配置视频降噪算法。 |
...
| **ByteRTCVideoDenoiseMode** | [videoDenoiseMode](#ByteRTCLocalVideoStats-videodenoisemode) |
...
<span id="ByteRTCLocalVideoStats-videodenoisemode"></span>
### videoDenoiseMode
```objectivec
@property(assign, nonatomic) ByteRTCVideoDenoiseMode videoDenoiseMode;
```
视频降噪模式。具体参看 [ByteRTCVideoDenoiseMode](#bytertcvideodenoisemode) 。
...
| **ByteRTCVideoSuperResolutionMode** | [superResolutionMode](#ByteRTCRemoteVideoStats-superresolutionmode) |
...
<span id="ByteRTCRemoteVideoStats-superresolutionmode"></span>
### superResolutionMode
```objectivec
@property(assign, nonatomic) ByteRTCVideoSuperResolutionMode superResolutionMode;
```
远端视频超分模式，参看 [ByteRTCVideoSuperResolutionMode](#bytertcvideosuperresolutionmode)。
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCMusicHotTypeContentCenter | 1 << 0 | 火山内容中心热歌榜。 |
| ByteRTCMusicHotTypeProject | 1 << 1 | 项目热歌榜。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCPlayStatePlaying | 1 | 播放中。 |
| ByteRTCPlayStatePaused | 2 | 暂停中。 |
| ByteRTCPlayStateStoped | 3 | 已停止。 |
| ByteRTCPlayStateFailed | 4 | 播放失败。 |
| ByteRTCPlayStateFinished | 5 | 播放结束。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCAudioTrackTypeOriginal | 1 | 播放原唱。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCAudioPlayTypeLocal | 0 | 仅本地播放。 |
| ByteRTCAudioPlayTypeRemote | 1 | 仅远端播放。 |
| ByteRTCAudioPlayTypeLocalAndRemote | 2 | 本地、远端同时播放。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCLyricStatusNone | 0 | 无歌词。 |
| ByteRTCLyricStatusKRC | 1 | KRC 歌词。 |
| ByteRTCLyricStatusLRC | 2 | LRC 歌词。 |
| ByteRTCLyricStatusKRCAndLRC | 3 | KRC 歌词和 LRC 歌词均有。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCDownloadFileTypeMusic | 1 | 音频文件。 |
| ByteRTCDownloadFileTypeKRC | 2 | KRC 歌词文件。 |
| ByteRTCDownloadFileTypeLRC | 3 | LRC 歌词文件。 |
| ByteRTCDownloadFileTypeMIDI | 4 | MIDI 文件。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCDownloadLyricTypeKRC | 0 | KRC 歌词文件。 |
| ByteRTCDownloadLyricTypeLRC | 1 | LRC 歌词文件。 |
...
# ByteRTCMusicInfo
```objectivec
@interface ByteRTCMusicInfo : NSObject
```
...
# ByteRTCHotMusicInfo
```objectivec
@interface ByteRTCHotMusicInfo : NSObject
```
...
| 类型 | 名称 |
| --- | --- |
| **ByteRTCMusicHotType** | [hotType](#ByteRTCHotMusicInfo-hottype) |
| **NSString*** | [hotName](#ByteRTCHotMusicInfo-hotname) |
| **NSArray<ByteRTCMusicInfo*>*** | [musics](#ByteRTCHotMusicInfo-musics) |


## 变量说明
<span id="ByteRTCHotMusicInfo-hottype"></span>
### hotType
```objectivec
@property (nonatomic, assign) ByteRTCMusicHotType hotType;
```
榜单类别，参看 [ByteRTCMusicHotType](#bytertcmusichottype)。


<span id="ByteRTCHotMusicInfo-hotname"></span>
### hotName
```objectivec
...
<span id="ByteRTCHotMusicInfo-musics"></span>
### musics
```objectivec
@property (nonatomic, copy) NSArray<ByteRTCMusicInfo *> * _Nullable musics;
```
歌曲数据，参看 [ByteRTCMusicInfo](#bytertcmusicinfo)。



# ByteRTCDownloadResult
```objectivec
@interface ByteRTCDownloadResult : NSObject
```
...
| 类型 | 名称 |
| --- | --- |
| **NSString*** | [musicId](#ByteRTCDownloadResult-musicid) |
| **ByteRTCDownloadFileType** | [fileType](#ByteRTCDownloadResult-filetype) |
| **NSString*** | [filePath](#ByteRTCDownloadResult-filepath) |


## 变量说明
<span id="ByteRTCDownloadResult-musicid"></span>
### musicId
```objectivec
@property (nonatomic, copy) NSString * _Nonnull musicId;
```
...
<span id="ByteRTCDownloadResult-filetype"></span>
### fileType
```objectivec
@property (nonatomic, assign) ByteRTCDownloadFileType fileType;
```
下载文件类型，参看 [ByteRTCDownloadFileType](#bytertcdownloadfiletype)。


<span id="ByteRTCDownloadResult-filepath"></span>
### filePath
```objectivec
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCVideoSuperResolutionModeChangedReasonAPIOff | 0 | 调用 [setRemoteVideoSuperResolution:withMode:](iOS-api.md#ByteRTCVideo-setremotevideosuperresolution-withmode) 成功关闭超分。 |
| ByteRTCVideoSuperResolutionModeChangedReasonAPIOn | 1 | 调用 [setRemoteVideoSuperResolution:withMode:](iOS-api.md#ByteRTCVideo-setremotevideosuperresolution-withmode) 成功开启超分。 |
| ByteRTCVideoSuperResolutionModeChangedReasonResolutionExceed | 2 | 开启超分失败，远端视频流的原始视频分辨率超过 640 × 360 px。 |
| ByteRTCVideoSuperResolutionModeChangedReasonOverUse | 3 | 开启超分失败，已对一路远端流开启超分。 |
| ByteRTCVideoSuperResolutionModeChangedReasonDeviceNotSupport | 4 | 设备不支持使用超分辨率。 |
| ByteRTCVideoSuperResolutionModeChangedReasonDynamicClose | 5 | 当前设备性能存在风险，已动态关闭 |
| ByteRTCVideoSuperResolutionModeChangedReasonOtherSettingDisabled | 6 | 超分因其他原因关闭。 |
| ByteRTCVideoSuperResolutionModeChangedReasonOtherSettingEnabled | 7 | 超分因其他原因开启。 |
| ByteRTCVideoSuperResolutionModeChangedReasonNoComponent | 8 | SDK 没有编译超分组件。 |
| ByteRTCVideoSuperResolutionModeChangedReasonStreamNotExist | 9 | 远端流不存在。房间 ID 或用户 ID 无效，或对方没有发布流。 |
...
| 类型 | 值 | 说明 |
| --- | --- | --- |
| ByteRTCVideoDenoiseModeChangedReasonNull | -1 | 未知原因导致视频降噪状态改变。 |
| ByteRTCVideoDenoiseModeChangedReasonApiOff | 0 | 通过调用 [setVideoDenoiser:](iOS-api.md#ByteRTCVideo-setvideodenoiser) 成功关闭视频降噪。 |
| ByteRTCVideoDenoiseModeChangedReasonApiOn | 1 | 通过调用 [setVideoDenoiser:](iOS-api.md#ByteRTCVideo-setvideodenoiser) 成功开启视频降噪。 |
| ByteRTCVideoDenoiseModeChangedReasonConfigDisabled | 2 | 后台未配置视频降噪，视频降噪开启失败，请联系技术人员解决。 |
| ByteRTCVideoDenoiseModeChangedReasonConfigEnabled | 3 | 后台配置开启了视频降噪。 |
| ByteRTCVideoDenoiseModeChangedReasonInternalException | 4 | 由于内部发生了异常，视频降噪关闭。 |
| ByteRTCVideoDenoiseModeChangedReasonDynamicClose | 5 | 当前设备性能过载，已动态关闭视频降噪。 |
| ByteRTCVideoDenoiseModeChangedReasonDynamicOpen | 6 | 当前设备性能裕量充足，已动态开启视频降噪。 |
| ByteRTCVideoDenoiseModeChangedReasonResolution | 7 | 分辨率导致视频降噪状态发生改变。分辨率过高会导致性能消耗过大，从而导致视频降噪关闭。如若希望继续使用视频降噪，可选择降低分辨率。 |
...
| 类型 | 名称 |
| --- | --- |
| **BOOL** | [enhanceSignaling](#ByteRTCMediaTypeEnhancementConfig-enhancesignaling) |
| **BOOL** | [enhanceAudio](#ByteRTCMediaTypeEnhancementConfig-enhanceaudio) |
| **BOOL** | [enhanceVideo](#ByteRTCMediaTypeEnhancementConfig-enhancevideo) |
| **BOOL** | [enhanceScreenAudio](#ByteRTCMediaTypeEnhancementConfig-enhancescreenaudio) |
| **BOOL** | [enhanceScreenVideo](#ByteRTCMediaTypeEnhancementConfig-enhancescreenvideo) |


## 变量说明
<span id="ByteRTCMediaTypeEnhancementConfig-enhancesignaling"></span>
### enhanceSignaling
```objectivec
@property (assign, nonatomic) BOOL enhanceSignaling;
```
...
<span id="ByteRTCMediaTypeEnhancementConfig-enhanceaudio"></span>
### enhanceAudio
```objectivec
@property (assign, nonatomic) BOOL enhanceAudio;
```
...
<span id="ByteRTCMediaTypeEnhancementConfig-enhancevideo"></span>
### enhanceVideo
```objectivec
...
<span id="ByteRTCMediaTypeEnhancementConfig-enhancescreenaudio"></span>
### enhanceScreenAudio
```objectivec
...
<span id="ByteRTCMediaTypeEnhancementConfig-enhancescreenvideo"></span>
### enhanceScreenVideo
```objectivec
