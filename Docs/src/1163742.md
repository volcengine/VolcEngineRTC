...
关于如何启用云端录制，参看[开始云端录制 StartRecord](1163741)。
## 使用说明
### 接口行为
...
在开始录制前，你必须已经启用云端录制，并启用了合流录制。参看[开始云端录制 StartRecord](1163741)。
...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=UpdateRecord&Version=2023-06-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=UpdateRecord&serviceCode=rtc&version=2023-06-01&groupName=云端录制" />
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=UpdateRecord&Version=2023-06-01
{
    "AppId": "Your_AppId",
