...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=BanRoomUser&Version=2020-12-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=BanRoomUser&serviceCode=rtc&version=2020-12-01&groupName=房间管理" />
