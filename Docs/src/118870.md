...
| 开启内部音频采集 |  [startAudioCapture](70086#startaudiocapture)  |
| 关闭内部音频采集 |  [stopAudioCapture](70086#stopaudiocapture) |
| 设置当前音频播放路由 | [setDefaultAudioRoute:](70086#setdefaultaudioroute) |
| 设置音质档位 |  [setAudioProfile:](70086#setaudioprofile) |
| 开启音量信息提示 | [enableAudioPropertiesReport:](70086#enableaudiopropertiesreport) |
...
| 在当前所在房间内发布本地通过摄像头/麦克风采集的媒体流 | [publishStream](70086#publishstream) |
| 停止将本地摄像头/麦克风采集的媒体流发布到当前所在房间中 | [unpublishStream](70086#unpublishstream) |
| 开启混音播放 | [open:config:](70086#ByteRTCMediaPlayer-open-config)  |
| 关闭混音播放 | [stop](70086#ByteRTCMediaPlayer-stop)|·
...
| 开启/关闭耳返功能 |  [setEarMonitorMode:](70086#setearmonitormode) |
| 设置耳返的音量 |  [setEarMonitorVolume:](70086#setearmonitorvolume)  |
...
| 远端用户加入 RTC 回调 | [onUserJoined](70087#rtcroom-onuserjoined-elapsed) |
| 本地用户音量回调 | [onLocalAudioPropertiesReport](70087#rtcengine-onlocalaudiopropertiesreport) |
...
| 收到音频同步信息 | [rtcEngine:onStreamSyncInfoReceived:streamType:data:](70087#rtcengine-onstreamsyncinforeceived-streamtype-data) |
| 音乐文件播放状态改变回调 | [onMediaPlayerStateChanged:state:error: ](70087#onmediaplayerstatechanged-state-error)|
| 收到音乐文件播放进度回调 | [onMediaPlayerPlayingProgress:progress:](70087#onmediaplayerplayingprogress-progress) |
