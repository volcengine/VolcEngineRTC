...
| **int** | [ERROR_CODE_EXXEEDS_THE_UPPER_LIMIT](#ErrorCode-error_code_exxeeds_the_upper_limit) |
...
<span id="ErrorCode-error_code_exxeeds_the_upper_limit"></span>
### ERROR_CODE_EXXEEDS_THE_UPPER_LIMIT
```java
public static final int com.ss.bytertc.engine.type.ErrorCode.ERROR_CODE_EXXEEDS_THE_UPPER_LIMIT = -1018;
```
加入房间错误。 <br>
