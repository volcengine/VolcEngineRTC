...
## 请求说明
- 请求方式：**GET**
- 请求地址：**https://rtc.volcengineapi.com?Action=GetPushSingleStreamToCDNTask&Version=2020-12-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=GetPushSingleStreamToCDNTask&serviceCode=rtc&version=2020-12-01&groupName=转推直播" />
...
## 请求示例
```json
GET https://rtc.volcengineapi.com?Action=GetPushSingleStreamToCDNTask&Version=2020-12-01&AppId=Your_AppId&RoomId=Your_RoomId&TaskId=Your_TaskId&UserId=Your_UserId
```
## 返回示例
```json
{
