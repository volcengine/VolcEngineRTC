...
SDK 回调给应用层的 delegate 对象，详见 [ByteRTCVideoDelegate](70093.md#bytertcvideodelegate)
...
音频播放设备发生变化时，会收到 [rtcEngine:onAudioPlaybackDeviceChanged:](70093.md#ByteRTCVideoDelegate-rtcengine-onaudioplaybackdevicechanged) 回调。  <br>

**传入参数**

| 参数名 | 类型 | 说明 |
| --- | --- | --- |
| audioPlaybackDevice | **ByteRTCAudioPlaybackDevice** | 音频播放设备（扬声器或者听筒），详见 [ByteRTCAudioPlaybackDevice](70089.md#bytertcaudioplaybackdevice)。 |
...
+ 连接有线或者蓝牙音频播放设备后，音频路由将切换至有线耳机或者蓝牙耳机。不同音频场景中，音频路由和发布订阅状态到音量类型的映射关系详见 [ByteRTCAudioScenarioType](70089.md#bytertcaudioscenariotype) 。  
...
**注意**
注册音频数据回调观察者并调用 [enableAudioFrameCallback:format:](#ByteRTCVideo-enableaudioframecallback-format) 后，[ByteRTCAudioFrameObserver](70093.md#bytertcaudioframeobserver) 会收到对应的音频回调。
...
| 参数名 | 类型 | 说明 |
| --- | --- | --- |
| types | **NSArray<ByteRTCProblemOption*>*** | 预设问题列表，参看 [ByteRTCProblemOption](70089.md#bytertcproblemoption) |
