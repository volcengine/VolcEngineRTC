...
同一个用户可以加入多个房间，分别订阅和接收这些房间中的音视频流，并在其中一个房间中发布音视频。也可以[发送和接收实时消息](Android-overview#%E6%B6%88%E6%81%AF)。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 音视频引擎类 | [`RTCVideo`](Android-api#rtcvideo) | [`ByteRTCVideo`](iOS-api#bytertcvideo) | [`ByteRTCVideo`](macOS-api#bytertcvideo) | [`IRTCVideo`](Windows-api#irtcvideo) | [`IRTCVideo`](Linux-api#irtcvideo) | [`RTCVideo`](Electron-api#rtcvideo) | [`RTCVideo`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo-class.html) | [`IRTCVideo`](191859#irtcvideo) |
| 开启视频采集 | [`startVideoCapture`](Android-api#RTCVideo-startvideocapture) | [`startVideoCapture`](iOS-api#ByteRTCVideo-startvideocapture) | [`startVideoCapture`](macOS-api#ByteRTCVideo-startvideocapture) | [`startVideoCapture`](Windows-api#IRTCVideo-startvideocapture) | [`startVideoCapture`](Linux-api#IRTCVideo-startvideocapture) | [`startVideoCapture`](Electron-api#rtcvideo-startvideocapture) | [`startVideoCapture`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/startVideoCapture.html) | [`StartVideoCapture`](191859#IRTCVideo-startvideocapture) |
| 开始音频采集 | [`startAudioCapture`](Android-api#RTCVideo-startaudiocapture) | [`startAudioCapture`](iOS-api#ByteRTCVideo-startaudiocapture) | [`startAudioCapture`](macOS-api#ByteRTCVideo-startaudiocapture) | [`startAudioCapture`](Windows-api#IRTCVideo-startaudiocapture) | [`startAudioCapture`](Linux-api#IRTCVideo-startaudiocapture) | [`startAudioCapture`](Electron-api#rtcvideo-startaudiocapture) | [`startAudioCapture`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/startAudioCapture.html) | [`StartAudioCapture`](191859#IRTCVideo-startaudiocapture) |
| 设置本地视图 | [`setLocalVideoCanvas`](Android-api#RTCVideo-setlocalvideocanvas) | [`setLocalVideoCanvas:withCanvas:`](iOS-api#ByteRTCVideo-setlocalvideocanvas-withcanvas) | [`setLocalVideoCanvas:withCanvas:`](macOS-api#ByteRTCVideo-setlocalvideocanvas-withcanvas) | [`setLocalVideoCanvas`](Windows-api#IRTCVideo-setlocalvideocanvas) | [`setLocalVideoCanvas`](Linux-api#IRTCVideo-setlocalvideocanvas) | [`setupLocalVideo`](Electron-api#rtcvideo-setuplocalvideo) | [`RTCViewContext`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_render_view/RTCViewContext-class.html) | [`SetLocalVideoSink`](191859#IRTCVideo-setlocalvideosink) |
| 创建房间 | [`createRTCRoom`](Android-api#RTCVideo-creatertcroom) | [`createRTCRoom:`](iOS-api#ByteRTCVideo-creatertcroom) | [`createRTCRoom:`](macOS-api#ByteRTCVideo-creatertcroom) | [`createRTCRoom`](Windows-api#IRTCVideo-creatertcroom) | [`createRTCRoom`](Linux-api#IRTCVideo-creatertcroom) | [`createRTCRoom`](Electron-api#rtcvideo-creatertcroom) | [`createRTCRoom`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/createRTCRoom.html) | [`CreateRTCRoom`](191859#IRTCVideo-creatertcroom) |
| 音视频房间类 | [`RTCRoom`](Android-api#rtcroom) | [`ByteRTCRoom`](iOS-api#bytertcroom) | [`ByteRTCRoom`](macOS-api#bytertcroom) | [`IRTCRoom`](Windows-api#irtcroom) | [`IRTCRoom`](Linux-api#irtcroom) | [`RTCRoom`](Electron-api#rtcroom) | [`RTCRoom`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_api/RTCRoom-class.html) | [`IRTCVideoRoom`](191859#irtcvideoroom) |
| 设置房间回调 | [`setRTCRoomEventHandler`](Android-api#RTCRoom-setrtcroomeventhandler) | [`setRTCRoomDelegate:`](iOS-api#setrtcroomdelegate) | [`setRTCRoomDelegate:`](macOS-api#ByteRTCRoom-setrtcroomdelegate) | [`setRTCRoomEventHandler`](Windows-api#IRTCRoom-setrtcroomeventhandler) | [`setRTCRoomEventHandler`](Linux-api#IRTCRoom-setrtcroomeventhandler) | 无 | [`setRTCRoomEventHandler`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_api/RTCRoom/setRTCRoomEventHandler.html) | 无 |
| 加入房间 | [`joinRoom`](Android-api#RTCRoom-joinroom) | [`joinRoom:userInfo:roomConfig:`](iOS-api#ByteRTCRoom-joinroom-userinfo-roomconfig) | [`joinRoom:userInfo:roomConfig:`](macOS-api#ByteRTCRoom-joinroom-userinfo-roomconfig) | [`joinRoom`](Windows-api#IRTCRoom-joinroom) | [`joinRoom`](Linux-api#IRTCRoom-joinroom) | [`joinRoom`](Electron-api#rtcroom-joinroom) | [`joinRoom`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_api/RTCRoom/joinRoom.html) | [`JoinRoom`](191859#IRTCVideoRoom-joinroom) |
| 房间状态回调 | [`onRoomStateChanged`](Android-callback#IRTCRoomEventHandler-onroomstatechanged) | [`rtcRoom:onRoomStateChanged:withUid:state:extraInfo:`](iOS-callback#ByteRTCRoomDelegate-rtcroom-onroomstatechanged-withuid-state-extrainfo) | [`rtcRoom:onRoomStateChanged:withUid:state:extraInfo:`](macOS-callback#ByteRTCRoomDelegate-rtcroom-onroomstatechanged-withuid-state-extrainfo) | [`onRoomStateChanged`](Windows-callback#IRTCRoomEventHandler-onroomstatechanged) | [`onRoomStateChanged`](Linux-callback#IRTCRoomEventHandler-onroomstatechanged) | [`onRoomStateChanged`](Electron-event#rtcroomcallback-onroomstatechanged) | [`onRoomStateChanged`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_event_handler/RTCRoomEventHandler/onRoomStateChanged.html) | [`OnRoomStateChangedEventHandler`](191860#onroomstatechangedeventhandler) |
| 发布回调 | [`onUserPublishStream`](Android-callback#IRTCRoomEventHandler-onuserpublishstream) | [`rtcRoom:onUserPublishStream:type:`](iOS-callback#ByteRTCRoomDelegate-rtcroom-onuserpublishstream-type) | [`rtcRoom:onUserPublishStream:type:`](macOS-callback#ByteRTCRoomDelegate-rtcroom-onuserpublishstream-type) | [`onUserPublishStream`](Windows-callback#IRTCRoomEventHandler-onuserpublishstream) | [`onUserPublishStream`](Linux-callback#IRTCRoomEventHandler-onuserpublishstream) | [`onUserPublishStream`](Electron-event#rtcroomcallback-onuserpublishstream) | [`onUserPublishStream`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_event_handler/RTCRoomEventHandler/onUserPublishStream.html) | [`OnUserPublishStreamEventHandler`](191860#onuserpublishstreameventhandler) |
| 取消发布回调 | [`onUserUnpublishStream`](Android-callback#IRTCRoomEventHandler-onuserunpublishstream) | [`rtcRoom:onUserUnpublishStream:type:reason:`](iOS-callback#ByteRTCRoomDelegate-rtcroom-onuserunpublishstream-type-reason) | [`rtcRoom:onUserUnpublishStream:type:reason:`](macOS-callback#ByteRTCRoomDelegate-rtcroom-onuserunpublishstream-type-reason) | [`onUserUnpublishStream`](Windows-callback#IRTCRoomEventHandler-onuserunpublishstream) | [`onUserUnpublishStream`](Linux-callback#IRTCRoomEventHandler-onuserunpublishstream) | [`onUserUnpublishStream`](Electron-event#rtcroomcallback-onuserunpublishstream) | [`onUserUnpublishStream`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_event_handler/RTCRoomEventHandler/onUserUnpublishStream.html) | [`OnUserUnPublishStreamEventHandler`](191860#onuserunpublishstreameventhandler) |
| 离开房间 | [`leaveRoom`](Android-api#RTCRoom-leaveroom) | [`leaveRoom`](iOS-api#ByteRTCRoom-leaveroom) | [`leaveRoom`](macOS-api#ByteRTCRoom-leaveroom) | [`leaveRoom`](Windows-api#IRTCRoom-leaveroom) | [`leaveRoom`](Linux-api#IRTCRoom-leaveroom) | [`leaveRoom`](Electron-api#rtcroom-leaveroom) | [`leaveRoom`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_api/RTCRoom/leaveRoom.html) | [`LeaveRoom`](191859#IRTCVideoRoom-leaveroom) |
| 销毁房间 | [`destroy`](Android-api#RTCRoom-destroy) | [`destroy`](iOS-api#ByteRTCRoom-destroy) | [`destroy`](macOS-api#ByteRTCRoom-destroy) | [`destroy`](Windows-api#IRTCRoom-destroy) | [`destroy`](Linux-api#IRTCRoom-destroy) | [`destroy`](Electron-api#rtcroom-destroy) | [`destroy`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_room_api/RTCRoom/destroy.html) | [`Destroy`](191859#IRTCVideoRoom-destroy) |
| 销毁音视频引擎 | [`destroyRTCVideo`](Android-api#RTCVideo-destroyrtcvideo) | [`destroyRTCVideo`](iOS-api#ByteRTCVideo-destroyrtcvideo) | [`destroyRTCVideo`](macOS-api#ByteRTCVideo-destroyrtcvideo) | [`destroyRTCVideo`](Windows-api#destroyrtcvideo) | [`destroyRTCVideo`](Linux-api#destroyrtcvideo) | [`destroyRTCVideo`](Electron-api#rtcvideo-destroyrtcvideo) | [`destroy`](https://pub.dev/documentation/volc_engine_rtc/latest/api_bytertc_video_api/RTCVideo/destroy.html) | [`Release`](191859#IRTCVideo-release) |
