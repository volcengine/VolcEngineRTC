...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=StopSegment&Version=2022-06-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=StopSegment&serviceCode=rtc&version=2022-06-01&groupName=音频切片" />
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=StopSegment&Version=2022-06-01
{
    "AppId": "Your_AppId",
