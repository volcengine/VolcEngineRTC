...
| --- | --- | --- | --- | --- | --- | --- |
| 错误码 | [ByteRTCTranscoderErrorCode](70082#bytertctranscodererrorcode) | [ByteRTCStreamMixingErrorCode](70085#bytertcstreammixingerrorcode) | [ByteRTCStreamMixingErrorCode](70091#bytertcstreammixingerrorcode) | [StreamMixingErrorCode](70097#streammixingerrorcode) |[StreamMixingErrorCode](85518#streammixingerrorcode)|[StreamMixingEventErrorCode](104481.md#streammixingeventerrorcode)|
...
- 使用 [`startPushMixedStreamToCDN`](70080#RTCVideo-startpushmixedstreamtocdn) 开启转推。其中，任务参数为 [`MixedStreamConfig`](70083.md#mixedstreamconfig) 结构体，使用 [`defaultMixedStreamConfig`](70083.md#MixedStreamConfig-defaultmixedstreamconfig) 进行参数初始化。
- 使用 [`updatePushMixedStreamToCDN`](70080.md#RTCVideo-updatepushmixedstreamtocdn) 更改音视频参数和视频布局。
- 使用 [`stopPushStreamToCDN`](70080.md#stoppushstreamtocdn) 停止转推直播。

### iOS

- 使用 [`startPushMixedStreamToCDN:mixedConfig:observer:`](70086#ByteRTCVideo-startpushmixedstreamtocdn-mixedconfig-observer) 开启转推。其中，任务参数为 [`ByteRTCMixedStreamConfig`](70088.md#bytertcmixedstreamconfig) 结构体，使用 [`defaultMixedStreamConfig`](70088.md#ByteRTCMixedStreamConfig-defaultmixedstreamconfig) 进行参数初始化。
- 使用 [`updatePushMixedStreamToCDN:mixedConfig:`](70086.md#ByteRTCVideo-updatepushmixedstreamtocdn-mixedconfig) 更改音视频参数和视频布局。
- 使用 [`stopPushStreamToCDN:`](70086.md#stoppushstreamtocdn) 停止转推直播。

### Mac

- 使用 [`startPushMixedStreamToCDN:mixedConfig:observer:`](70092#ByteRTCVideo-startpushmixedstreamtocdn-mixedconfig-observer)  开启转推。其中，任务参数为 [`ByteRTCMixedStreamConfig`](70089.md#bytertcmixedstreamconfig) 结构体，使用 [`defaultMixedStreamConfig`](70089.md#ByteRTCMixedStreamConfig-defaultmixedstreamconfig) 进行参数初始化。
- 使用 [`updatePushMixedStreamToCDN:mixedConfig:`](70092.md#ByteRTCVideo-updatepushmixedstreamtocdn-mixedconfig) 更改音视频参数和视频布局。
- 使用 [`stopPushStreamToCDN:`](70092.md#stoppushstreamtocdn) 停止转推直播。

### Windows

- 使用 [`startPushMixedStreamToCDN`](70095#IRTCVideo-startpushmixedstreamtocdn) 开启转推直播。其中，任务参数为 [`IMixedStreamConfig`](70098.md#imixedstreamconfig) 结构体，使用 [`defaultMixedStreamConfig`](70098.md#IMixedStreamConfig-defaultmixedstreamconfig) 进行参数初始化。
- 使用 [`updatePushMixedStreamToCDN`](70095.md#IRTCVideo-updatepushmixedstreamtocdn) 更改音视频参数和视频布局。
- 使用 [`stopPushStreamToCDN`](70095.md#stoppushstreamtocdn) 停止转推直播。

### Web

- 使用 [`startLiveTranscoding`](104478.md#startlivetranscoding) 开启转推直播。
- 使用 [`updateLiveTranscoding`](104478.md#updatelivetranscoding) 更改音视频参数和视频布局。
- 使用 [`stopLiveTranscoding`](104478.md#stoplivetranscoding) 停止转推直播。