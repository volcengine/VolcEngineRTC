...
调用 [createRTCVideo](https://www.volcengine.com/docs/6348/70080#RTCVideo-creatertcvideo) 初始化 RTCVideo 引擎，所有 RTC 相关的 API 调用都要在创建引擎之后。
...
创建引擎后，调用 [startVideoCapture](https://www.volcengine.com/docs/6348/70080#RTCVideo-startvideocapture) 开启视频采集，调用 [startAudioCapture](https://www.volcengine.com/docs/6348/70080#RTCVideo-startaudiocapture) 开启音频采集。
...
调用 [setLocalVideoCanvas](https://www.volcengine.com/docs/6348/70080#RTCVideo-setlocalvideocanvas) 设置本端渲染窗口，支持 TextureView 和 SurfaceView。
...
1. 调用 [createRTCRoom](https://www.volcengine.com/docs/6348/70080#RTCVideo-creatertcroom) 创建 RTC 房间，所有和房间相关的 API 都在 RTCRoom 类。
	
2. 调用 [setRTCRoomEventHandler](https://www.volcengine.com/docs/6348/70080#RTCRoom-setrtcroomeventhandler) 设置房间回调监听。
	
3. 调用 [joinRoom](https://www.volcengine.com/docs/6348/70080#RTCRoom-joinroom) 加入房间。
...
当远端用户加入频道并发布视频流时，在 [onUserPublishStream](https://www.volcengine.com/docs/6348/70081#IRTCRoomEventHandler-onuserpublishstream) 回调中调用 [setRemoteVideoCanvas](https://www.volcengine.com/docs/6348/70080#RTCVideo-setremotevideocanvas) 设置并渲染远端视图。
...
调用 [leaveRoom](https://www.volcengine.com/docs/6348/70080#RTCRoom-leaveroom) 离开房间， 并调用 [destroy](https://www.volcengine.com/docs/6348/70080#RTCRoom-destroy) 销毁房间实例。
...
退出 app 时，调用 [destroyRTCVideo](https://www.volcengine.com/docs/6348/70080#RTCVideo-destroyrtcvideo) 销毁 RTCVideo 引擎。
