...
`setVideoWatermark` 的必填参数 `watermarkConfig` 类型为 `ByteWatermark`, 包含水印图片的分辨率大小和位置坐标。详见 [`RTCWatermarkConfig`](70083#bytewatermark)。
