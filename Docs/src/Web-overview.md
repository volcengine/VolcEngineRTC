...
| [setAudioFrameCallback](Web-api.md#rtcengine-setaudioframecallback) | 开关音频帧 PCM 数据回调。 |
...
| [logout](Web-api.md#rtcengine-logout) | 登出 RTS 服务器。调用本接口登出后，无法调用房间外消息以及端到服务器消息相关的方法或收到相关回调。 |
