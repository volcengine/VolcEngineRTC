...
| 设置相机采集参数 |   [setVideoCaptureConfig](70080#setvideocaptureconfig) |
| 设置视频发布参数 |   [setVideoEncoderConfig](70080#setvideoencoderconfig) |
| 设置镜像 |   [setLocalVideoMirrorType](70080#setlocalvideomirrortype) |
| 获取合流转推默认配置参数   | [LiveTranscoding.getDefualtLiveTranscode](70083#getdefualtlivetranscode) |
| 加入RTC房间   | [joinRoom](70080#joinroom) |
| 离开RTC房间   | [leaveRoom](70080#leaveroom) |
| 销毁房间对象  | [destroy](70080#destroy) |
| 开启合流转推   | [startLiveTranscoding](70080#startlivetranscoding)|
| 更新合流转推参数   | [updateLiveTranscoding](70080#updatelivetranscoding) |
| 关闭合流转推   | [stopLiveTranscoding](70080#stoplivetranscoding) |
| 开启跨房间转推   | [startForwardStreamToRooms:](70080#startforwardstreamtorooms) |
| 关闭跨房间转推   | [stopForwardStreamToRooms](70080#stopforwardstreamtorooms) |
| 开启相机采集   | [startVideoCapture](70080#startvideocapture) |
| 关闭相机采集   | [stopVideoCapture](70080#stopvideocapture) |
| 开启麦克风采集   | [startAudioCapture](70080#startaudiocapture) |
| 关闭麦克风采集   | [stopAudioCapture](70080#stopaudiocapture) |
| 切换前置/后置摄像头   | [switchCamera](70080#switchcamera) |
| 暂停接收来自远端的媒体流   | [pauseAllSubscribedStream](70080#pauseallsubscribedstream) |
| 恢复接收来自远端的媒体流   | [resumeAllSubscribedStream](70080#resumeallsubscribedstream) |
...
| 收到远端用户音视频流回调 |   [onUserPublishStream](70081#onuserpublishstream) |
| 本地流数据统计以及网络质量回调   | [onLocalStreamStats](70081#onlocalstreamstats) |
| 远端流数据统计以及网络质量回调   | [onRemoteStreamStats](70081#onremotestreamstats) |
