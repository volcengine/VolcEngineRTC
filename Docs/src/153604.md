...
#### 时序图
![alt](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_fa90c29719be6c63f2b3814379b48cf4.jpg =60%x)#{style="margin: auto"}#
#### 示例代码
```Java
/**
* 开启PCM混音
 ...
 * @param playerId 混音播放器 ID
 * @param volume 混音音量相对原音量的比值。范围为 `[0, 400]`，建议范围是 `[0, 100]`。
 */
public void setAudioMixingVolume(int playerId, int volume) {
    IMediaPlayer player = mEngine.getMediaPlayer(playerId);
    player.setVolume(volume, AudioMixingType.AUDIO_MIXING_TYPE_PLAYOUT);
}
...
| **功能点** | **API** |
| --- | --- |
| 创建 RTCVideo 对象 | [createRTCVideo](70080#creatertcvideo) |
| 创建 RTCRoom 对象 |  [createRTCRoom](70080#creatertcroom)  |
| 设置用户可见性 | [setUserVisibility](70080#setuservisibility) |
| 设置本地渲染和编码镜像 |  [setLocalVideoMirrorType](70080#setlocalvideomirrortype)  |
| 设置本地视频渲染视图 |  [setLocalVideoCanvas](70080#setlocalvideocanvas) |
...
| 设置远端用户视频渲染视图 | [setRemoteVideoCanvas](70080#setremotevideocanvas)  |
| 开启PCM 音频数据混音 | [openWithCustomSource](70080#IMediaPlayer-openwithcustomsource)|
| 推送 PCM 音频帧数据用于混音 | [pushExternalAudioFrame](70080#pushexternalaudioframe) |
| 调节混音的音量大小 |  [setVolume](70080#IMediaPlayer-setvolume) |
| 调节远端用户用通话音量 |[setPlaybackVolume ](70080#setplaybackvolume)|
| 打开音量闪避功能 | [enablePlaybackDucking](70080#enableplaybackducking)  |
| 离开房间 | [leaveRoom](70080#leaveroom)|
| 销毁 RTCRoom 对象 | [destroy](70080#destroy) |
| 关闭内部音频采集 | [stopAudioCapture](70080#stopaudiocapture) |
| 关闭内部视频采集 | [stopVideoCapture](70080#stopvideocapture) |
| 销毁 RTCVideo 对象 | [destroy](70080#destroy)|
...
|功能点|回调|
|--|--|
| 本地用户加入 RTC 房间回调 |  [onRoomStateChanged](70081#onroomstatechanged) |
...
| 远端用户加入 RTC 房间回调 |[onUserJoined](70081#onuserjoined)|
| 房间内新增远端摄像头/麦克风采集的媒体流回调 |  [onUserPublishStream](70081#onuserpublishstream)  |
