...
| 设置本地渲染和编码镜像 |  [setLocalVideoMirrorType](Android-api#setlocalvideomirrortype)  |
| 设置本地视频渲染视图 |  [setLocalVideoCanvas](Android-api#setlocalvideocanvas) |
...
| 设置远端用户视频渲染视图 | [setRemoteVideoCanvas](Android-api#setremotevideocanvas)  |
| 开启PCM 音频数据混音 | [openWithCustomSource](Android-api#IMediaPlayer-openwithcustomsource)|
| 推送 PCM 音频帧数据用于混音 | [pushExternalAudioFrame](Android-api#pushexternalaudioframe) |
| 调节混音的音量大小 |  [setVolume](Android-api#IMediaPlayer-setvolume) |
| 调节远端用户用通话音量 |[setPlaybackVolume ](Android-api#setplaybackvolume)|
| 打开音量闪避功能 | [enablePlaybackDucking](Android-api#enableplaybackducking)  |
...
| 销毁 RTCVideo 对象 | [destroy](Android-api#destroy)|
...
| 远端用户加入 RTC 房间回调 |[onUserJoined](Android-callback#onuserjoined)|
| 房间内新增远端摄像头/麦克风采集的媒体流回调 |  [onUserPublishStream](Android-callback#onuserpublishstream)  |
