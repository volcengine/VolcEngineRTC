...
2. 创建 RTC 引擎后，调用 [setExtensionConfig:](70086.md#ByteRTCVideo-setextensionconfig) 接口，填写上一个步骤中创建的 App Group ID，响应从系统的控制中心发起的屏幕共享。
...
如果默认的编码参数不能满足你的要求，你可以在开始屏幕采集前，通过 [setScreenVideoEncoderConfig](https://www.volcengine.com/docs/6348/70086#setscreenvideoencoderconfig) 方法设置编码参数。
...
2. 指定为外部输入源。
    - 调用 [setScreenAudioSourceType:](70086.md#ByteRTCVideo-setscreenaudiosourcetype) 设置屏幕音频自定义采集。
    - 调用 [setVideoSourceType:WithStreamIndex:](70086.md#ByteRTCVideo-setvideosourcetype-withstreamindex) 设置屏幕视频自定义采集。
	

3. 调用 [pushScreenAudioFrame:](70086.md#ByteRTCVideo-pushscreenaudioframe) 和 [pushScreenVideoFrame:time:rotation:](70086.md#ByteRTCVideo-pushscreenvideoframe-time-rotation) 将采集得到的音视频帧推送到 RTC SDK 用于编码传输。
...
*   [setExtensionConfig:](70086.md#ByteRTCVideo-setextensionconfig)
*   [startScreenCapture:bundleId:](70086.md#ByteRTCVideo-startscreencapture-bundleid)
*   [updateScreenCapture:](70086.md#ByteRTCVideo-updatescreencapture)
*   [stopScreenCapture](70086.md#ByteRTCVideo-stopscreencapture)
*   [publishScreen:](70086.md#ByteRTCRoom-publishscreen)
*   [unpublishScreen:](70086.md#ByteRTCRoom-unpublishscreen)
*   [setScreenAudioSourceType:](70086.md#ByteRTCVideo-setscreenaudiosourcetype)
*   [pushScreenAudioFrame:](70086.md#ByteRTCVideo-pushscreenaudioframe)
*   [pushScreenVideoFrame:time:rotation:](70086.md#ByteRTCVideo-pushscreenvideoframe-time-rotation)
...
- 3.50.1 版本中
  ...
  - 自定义屏幕流相关的接口名称和行为有变更。
- 3.43.1 版本中
  - [`publishScreen:`](70086.md#ByteRTCRoom-publishscreen) 和 [`unpublishScreen:`](70086.md#ByteRTCRoom-unpublishscreen) 的类名由 `ByteRTCEngineKit` 变更为 `RTCRoom`。其他方法的类名变更为 `RTCVideo`。
