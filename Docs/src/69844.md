...
你需要在接口调用中配置存储空间，将录制结果存储在点播空间中。<br>
...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=StartRecord&Version=2020-12-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=StartRecord&serviceCode=rtc&version=2020-12-01&groupName=云端录制" />
...
const data = [
  ...
  },
  {
    ...
    "children": [
      ...
      },
      {
        ...
        "key": "0-9-4",
        "title": "(仅对转推直播有效）用户说话音量的回调间隔，单位为秒，取值范围为<code>[1,∞]</code>，默认值为 <code>2</code>。",
        "example": "<code>2</code>",
        "required": "否",
        "type": "Integer"
      },
      {
        ...
        "key": "0-9-5",
        "title": "(仅对转推直播有效）是否开启音量指示模式。默认值为 <code>false</code>。<br><br>\n若 <code>VolumeIndicationMode</code> = <code>true</code> 的同时设置 <code>MediaType</code> = <code>1</code>，该流推向 CDN 地址时，服务端会补黑帧。",
      ...
      },
      {
        "name": "TalkVolume",
        "key": "0-9-6",
        "title": "(仅对转推直播有效）有效说话音量大小。取值范围为<code>[0,255]</code>，默认值为<code>0</code>。",
  ...
  },
  {
    "name": "Vod",
    "key": "0-10",
    "title": "<a href=\"https://www.volcengine.com/product/vod\" target=\"_blank\" class=\"external\">火山引擎视频点播 VOD</a> 服务的配置信息，用于存储录制结果。",
    "example": "",
    "required": "是",
    "type": "Object",
    "children": [
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=StartRecord&Version=2020-12-01
{
    "AppId": "You****pId",
