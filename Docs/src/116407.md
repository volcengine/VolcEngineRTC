...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=StopRecord&Version=2022-06-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=StopRecord&serviceCode=rtc&version=2022-06-01&groupName=云端录制" />
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=StopRecord&Version=2022-06-01
{
    "AppId": "You****pId",
    "RoomId": "Your_RoomId",
    "TaskId": "Your_TaskId"
