...
| 远端用户加入 RTC 房间回调 | [rtcRoom:onUserJoined:elapsed:](70087.md#rtcroom-onuserjoined-elapsed)|
| 房间内新增远端摄像头/麦克风采集的媒体流流的回调 | [rtcRoom:onUserPublishStream:type:](70087.md#rtcroom-onuserpublishstream-type) |
