...
```
[onLocalAudioPropertiesReport](70081.md#IRTCVideoEventHandler-onlocalaudiopropertiesreport) 中包含音频数据的范围。参看 [AudioPropertiesMode](#audiopropertiesmode)。
...
[onLocalAudioPropertiesReport](70081.md#IRTCVideoEventHandler-onlocalaudiopropertiesreport) 中包含的音频信息的范围。
...
> Deprecated since 3.36 and will be deleted in 3.51, use [onNetworkQuality](70081.md#IRTCRoomEventHandler-onnetworkquality) instead.
