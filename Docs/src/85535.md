...
- **成员**
  ...
  | 属性 | 值 | 描述 |
  | :-- | :-- | :-- |
  | kVideoEncodePreferenceDisabled | `0` | 无偏好 |
  | kVideoEncodePreferenceFramerate | `1` | 帧率优先 |
  | kVideoEncodePreferenceQuality | `2` | 质量优先 |
  | kVideoEncodePreferenceBalance | `3` | 平衡质量与帧率 |
...
## ITranscoderParam <span id="itranscoderparam"></span>
...
| 方法 | 描述 |
| :-- | :-- |
| [expected_mix_type](#itranscoderparam-expected_mix_type) | 设置合流类型。本参数不支持过程中更新。 |
| [room_id](#itranscoderparam-room_id) | 媒体流所在的房间 ID。必填。 |
| [user_id](#itranscoderparam-user_id) | 媒体流所属的用户 ID |
| [uri](#itranscoderparam-uri) | 推流地址 |
| [audio_param](#itranscoderparam-audio_param) | 音频参数 |
| [video_param](#itranscoderparam-video_param) | 视频参数 |
| [layout_regions](#itranscoderparam-layout_regions) | 布局设置。必填。 |
| [background_color](#itranscoderparam-background_color) | 背景颜色 |
| [app_data](#itranscoderparam-app_data) | 设置透传的 App 数据 |


<p style="font-size: 16px;font-weight: bolder;"> expected_mix_type <span id="itranscoderparam-expected_mix_type"></span></p> 

类型: [StreamMixingType](#streammixingtype)

设置合流类型。本参数不支持过程中更新。

<p style="font-size: 16px;font-weight: bolder;"> room_id <span id="itranscoderparam-room_id"></span></p> 

类型: string

媒体流所在的房间 ID。必填。

<p style="font-size: 16px;font-weight: bolder;"> user_id <span id="itranscoderparam-user_id"></span></p> 

类型: string

媒体流所属的用户 ID

<p style="font-size: 16px;font-weight: bolder;"> uri <span id="itranscoderparam-uri"></span></p> 

类型: string

推流地址

<p style="font-size: 16px;font-weight: bolder;"> audio_param <span id="itranscoderparam-audio_param"></span></p> 

类型: [TranscoderAudioParam](#transcoderaudioparam)

音频参数

<p style="font-size: 16px;font-weight: bolder;"> video_param <span id="itranscoderparam-video_param"></span></p> 

类型: [TranscoderVideoParam](#transcodervideoparam)

视频参数

<p style="font-size: 16px;font-weight: bolder;"> layout_regions <span id="itranscoderparam-layout_regions"></span></p> 

类型: [TranscoderLayoutRegion](#transcoderlayoutregion)[]

布局设置

<p style="font-size: 16px;font-weight: bolder;"> background_color <span id="itranscoderparam-background_color"></span></p> 

类型: string

背景颜色

<p style="font-size: 16px;font-weight: bolder;"> app_data <span id="itranscoderparam-app_data"></span></p> 
...
## StreamMixingType <span id="streammixingtype"></span>
...
## TranscoderAudioParam <span id="transcoderaudioparam"></span>
...
| 方法 | 描述 |
| :-- | :-- |
| [i32_sample_rate](#transcoderaudioparam-i32_sample_rate) | 音频采样率，单位 kHz。可取 32Khz、44.1Khz、48Khz，默认值为 48Khz。 |
| [i32_channel_num](#transcoderaudioparam-i32_channel_num) | 音频声道数。可取 1、2，默认值为 2。 |
| [i32_bitrate_kbps](#transcoderaudioparam-i32_bitrate_kbps) | 音频码率，单位 Kbps。可取范围 [32Kbps, 192Kbps]，默认值为 64Kbps。 |
| [audio_codec_profile](#transcoderaudioparam-audio_codec_profile) | AAC 等级。默认值为 0。 |
| [audio_codec_type](#transcoderaudioparam-audio_codec_type) | 音频编码格式。默认值为 `0`。 |


<p style="font-size: 16px;font-weight: bolder;"> i32_sample_rate <span id="transcoderaudioparam-i32_sample_rate"></span></p> 

类型: number

音频采样率，单位 kHz。可取 32Khz、44.1Khz、48Khz，默认值为 48Khz。

<p style="font-size: 16px;font-weight: bolder;"> i32_channel_num <span id="transcoderaudioparam-i32_channel_num"></span></p> 

类型: number

音频声道数。可取 1、2，默认值为 2。

<p style="font-size: 16px;font-weight: bolder;"> i32_bitrate_kbps <span id="transcoderaudioparam-i32_bitrate_kbps"></span></p> 

类型: number

音频码率，单位 Kbps。可取范围 [32Kbps, 192Kbps]，默认值为 64Kbps。

<p style="font-size: 16px;font-weight: bolder;"> audio_codec_profile <span id="transcoderaudioparam-audio_codec_profile"></span></p> 

类型: [TranscoderAudioCodecProfile](#transcoderaudiocodecprofile)

AAC 等级。默认值为 0。

<p style="font-size: 16px;font-weight: bolder;"> audio_codec_type <span id="transcoderaudioparam-audio_codec_type"></span></p> 

类型: TranscoderAudioCodecType
...
## TranscoderAudioCodecProfile <span id="transcoderaudiocodecprofile"></span>
...
- **成员**
  ...
  | kByteAACProfileHEv1 | `1` | HE-AAC v1 |
  | kByteAACProfileHEv2 | `2` | HE-AAC v2 |



## TranscoderVideoParam <span id="transcodervideoparam"></span>
...
| 方法 | 描述 |
| :-- | :-- |
| [i32_width](#transcodervideoparam-i32_width) | 合流视频宽度，单位：px。<br>仅支持设为偶数，如果设为奇数，后处理会直接拒绝，导致合流失败。 |
| [i32_height](#transcodervideoparam-i32_height) | 合流视频高度，单位：px。<br>仅支持设为偶数，如果设为奇数，后处理会直接拒绝，导致合流失败。 |
| [i32_fps](#transcodervideoparam-i32_fps) | 合流的视频帧率。默认值为 15，取值范围是 [1, 60]。值不合法时，自动调整为默认值。 |
| [i32_gop](#transcodervideoparam-i32_gop) | I 帧间隔。默认值为 4，取值范围为 [1, 5]，单位为秒。值不合法时，自动调整为默认值。 |
| [i32_bitrate_kbps](#transcodervideoparam-i32_bitrate_kbps) | 合流视频码率。单位为 kbps，取值范围为 [1,10000]，默认值为自适应。值不合法时，自动调整为默认值。 |
| [video_codec_type](#transcodervideoparam-video_codec_type) | 编码参数规格 |
| [bFrame](#transcodervideoparam-bframe) | 是否在合流中开启B帧，仅服务端合流支持：<br>+ true: 是<br>+ false: 否 |


<p style="font-size: 16px;font-weight: bolder;"> i32_width <span id="transcodervideoparam-i32_width"></span></p> 
...
<p style="font-size: 16px;font-weight: bolder;"> i32_height <span id="transcodervideoparam-i32_height"></span></p> 
...
<p style="font-size: 16px;font-weight: bolder;"> i32_fps <span id="transcodervideoparam-i32_fps"></span></p> 

类型: number

合流的视频帧率。默认值为 15，取值范围是 [1, 60]。值不合法时，自动调整为默认值。

<p style="font-size: 16px;font-weight: bolder;"> i32_gop <span id="transcodervideoparam-i32_gop"></span></p> 

类型: number

I 帧间隔。默认值为 4，取值范围为 [1, 5]，单位为秒。值不合法时，自动调整为默认值。

<p style="font-size: 16px;font-weight: bolder;"> i32_bitrate_kbps <span id="transcodervideoparam-i32_bitrate_kbps"></span></p> 

类型: number

合流视频码率。单位为 kbps，取值范围为 [1,10000]，默认值为自适应。值不合法时，自动调整为默认值。

<p style="font-size: 16px;font-weight: bolder;"> video_codec_type <span id="transcodervideoparam-video_codec_type"></span></p> 

类型: [TranscoderVideoCodecType](#transcodervideocodectype) | undefined

编码参数规格

<p style="font-size: 16px;font-weight: bolder;"> bFrame <span id="transcodervideoparam-bframe"></span></p> 
...
## TranscoderVideoCodecType <span id="transcodervideocodectype"></span>
...
## TranscoderLayoutRegion <span id="transcoderlayoutregion"></span>

类型: `interface`

单个图片或视频流在合流中的布局信息。
开启转推直播功能后，在多路图片或视频流合流时，你可以设置其中一路流在合流中的预设布局信息。以下参数都是必填的。

- **API**

| 方法 | 描述 |
| :-- | :-- |
| [region_id](#transcoderlayoutregion-region_id) | 合流用户的 ID。 |
| [room_id](#transcoderlayoutregion-room_id) | 媒体流所在房间的房间 ID。<br>如果此图片或视频流是通过 startForwardStreamToRooms 转发到你所在房间的媒体流时，你应将房间 ID 设置为你所在的房间 ID。 |
| [x](#transcoderlayoutregion-x) | 用户视频布局相对画布左侧的偏移量，取值的范围为 [0.0, 1.0) |
| [y](#transcoderlayoutregion-y) | 用户视频布局相对画布顶端的偏移量，取值的范围为 [0.0, 1.0) |
| [width](#transcoderlayoutregion-width) | 用户视频宽度相对画布宽度的比例，取值的范围为 (0.0, 1.0] |
| [height](#transcoderlayoutregion-height) | 用户视频高度相对画布高度的比例，取值的范围为 (0.0, 1.0] |
| [alpha](#transcoderlayoutregion-alpha) | 透明度，取值范围 [0，255] |
| [corner_radius](#transcoderlayoutregion-corner_radius) | 圆角半径相对画布宽度的比例。默认值为 `0.0`。 |
| [i32_z_order](#transcoderlayoutregion-i32_z_order) | 用户视频布局在画布中的层级，取值范围 [0，100]，0 为底层，值越大层级越高 |
| [local_user](#transcoderlayoutregion-local_user) | 是否为本地用户 |
| [screen_stream](#transcoderlayoutregion-screen_stream) | 是否为屏幕流 |
| [content_control](#transcoderlayoutregion-content_control) | 合流内容控制。默认值为 `kHasAudioAndVideo` |
| [render_mode](#transcoderlayoutregion-render_mode) | 渲染时，视频内容缩放模式 |
| [type](#transcoderlayoutregion-type) | 合流布局区域类型 |
| [data](#transcoderlayoutregion-data) | 图片合流布局区域类型对应的数据。类型为图片时传入图片 RGBA 数据，当类型为视频流时传空。 |
| [data_param](#transcoderlayoutregion-data_param) | 图片合流相关参数 |
| [spatial_position](#transcoderlayoutregion-spatial_position) | 空间位置 |


<p style="font-size: 16px;font-weight: bolder;"> region_id <span id="transcoderlayoutregion-region_id"></span></p> 

类型: string

合流用户的 ID。

<p style="font-size: 16px;font-weight: bolder;"> room_id <span id="transcoderlayoutregion-room_id"></span></p> 
...
<p style="font-size: 16px;font-weight: bolder;"> x <span id="transcoderlayoutregion-x"></span></p> 

类型: number

用户视频布局相对画布左侧的偏移量，取值的范围为 [0.0, 1.0)

<p style="font-size: 16px;font-weight: bolder;"> y <span id="transcoderlayoutregion-y"></span></p> 

类型: number

用户视频布局相对画布顶端的偏移量，取值的范围为 [0.0, 1.0)

<p style="font-size: 16px;font-weight: bolder;"> width <span id="transcoderlayoutregion-width"></span></p> 

类型: number

用户视频宽度相对画布宽度的比例，取值的范围为 (0.0, 1.0]

<p style="font-size: 16px;font-weight: bolder;"> height <span id="transcoderlayoutregion-height"></span></p> 

类型: number

用户视频高度相对画布高度的比例，取值的范围为 (0.0, 1.0]

<p style="font-size: 16px;font-weight: bolder;"> alpha <span id="transcoderlayoutregion-alpha"></span></p> 

类型: number

透明度，取值范围 [0，255]

<p style="font-size: 16px;font-weight: bolder;"> corner_radius <span id="transcoderlayoutregion-corner_radius"></span></p> 
...
<p style="font-size: 16px;font-weight: bolder;"> i32_z_order <span id="transcoderlayoutregion-i32_z_order"></span></p> 

类型: number

用户视频布局在画布中的层级，取值范围 [0，100]，0 为底层，值越大层级越高

<p style="font-size: 16px;font-weight: bolder;"> local_user <span id="transcoderlayoutregion-local_user"></span></p> 

类型: boolean

是否为本地用户

<p style="font-size: 16px;font-weight: bolder;"> screen_stream <span id="transcoderlayoutregion-screen_stream"></span></p> 

类型: boolean

是否为屏幕流

<p style="font-size: 16px;font-weight: bolder;"> content_control <span id="transcoderlayoutregion-content_control"></span></p> 

类型: [TranscoderContentControlType](#transcodercontentcontroltype)

合流内容控制。默认值为 `kHasAudioAndVideo`

<p style="font-size: 16px;font-weight: bolder;"> render_mode <span id="transcoderlayoutregion-render_mode"></span></p> 

类型: [TranscoderRenderMode](#transcoderrendermode)

渲染时，视频内容缩放模式

<p style="font-size: 16px;font-weight: bolder;"> type <span id="transcoderlayoutregion-type"></span></p> 

类型: [TranscoderLayoutRegionType](#transcoderlayoutregiontype)

合流布局区域类型

<p style="font-size: 16px;font-weight: bolder;"> data <span id="transcoderlayoutregion-data"></span></p> 

类型: Uint8Array | undefined

图片合流布局区域类型对应的数据。类型为图片时传入图片 RGBA 数据，当类型为视频流时传空。

<p style="font-size: 16px;font-weight: bolder;"> data_param <span id="transcoderlayoutregion-data_param"></span></p> 

类型: [TranscoderLayoutRegionDataParam](#transcoderlayoutregiondataparam) | undefined

图片合流相关参数

<p style="font-size: 16px;font-weight: bolder;"> spatial_position <span id="transcoderlayoutregion-spatial_position"></span></p> 
...
## TranscoderRenderMode <span id="transcoderrendermode"></span>
...
## TranscoderLayoutRegionType <span id="transcoderlayoutregiontype"></span>
...
## TranscoderLayoutRegionDataParam <span id="transcoderlayoutregiondataparam"></span>
...
| 方法 | 描述 |
| :-- | :-- |
| [image_width](#transcoderlayoutregiondataparam-image_width) | 原始图片的宽度，单位为 px。 |
| [image_height](#transcoderlayoutregiondataparam-image_height) | 原始图片的高度，单位为 px。 |


<p style="font-size: 16px;font-weight: bolder;"> image_width <span id="transcoderlayoutregiondataparam-image_width"></span></p> 

类型: number

原始图片的宽度，单位为 px。

<p style="font-size: 16px;font-weight: bolder;"> image_height <span id="transcoderlayoutregiondataparam-image_height"></span></p> 
...
| [public_stream_id](#ivideoframe-public_stream_id) |  |
...
## SEIMessageSourceType <span id="seimessagesourcetype"></span>
...
| [spectrum](#audiopropertiesinfo-spectrum) |  |
