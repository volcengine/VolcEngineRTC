...
|  | Android | iOS | Windows |
| --- | --- | --- | --- |
| 文本消息 | [onRoomMessageReceived](https://www.volcengine.com/docs/6348/Android-callback#onroommessagereceived) | [rtcRoom:onUserMessageReceived:message:](https://www.volcengine.com/docs/6348/iOS-callback#ByteRTCRoomDelegate-rtcroom-onusermessagereceived-message) | [OnRoomMessageReceived](https://www.volcengine.com/docs/6348/Windows-callback#onroommessagereceived) |
| 二进制消息 | [onRoomBinaryMessageReceived](https://www.volcengine.com/docs/6348/Android-callback#onroombinarymessagereceived) | [rtcRoom:onUserBinaryMessageReceived:message:](https://www.volcengine.com/docs/6348/iOS-callback#ByteRTCRoomDelegate-rtcroom-onuserbinarymessagereceived-message) | [OnUserBinaryMessageReceived](https://www.volcengine.com/docs/6348/Windows-callback#onuserbinarymessagereceived) |
## 注意事项
