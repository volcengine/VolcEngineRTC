...
| [stopAllAudioMixing](Windows-api.md#IAudioMixingManager-stopallaudiomixing) | 停止播放所有音频文件及混音。 |
| [pauseAllAudioMixing](Windows-api.md#IAudioMixingManager-pauseallaudiomixing) | 暂停播放所有音频文件及混音。 |
| [resumeAllAudioMixing](Windows-api.md#IAudioMixingManager-resumeallaudiomixing) | 恢复播放所有音频文件及混音。 |
...
| [onLicenseWillExpire](Windows-callback.md#IRTCVideoEventHandler-onlicensewillexpire) | license 过期提醒。在剩余天数低于 30 天时，收到此回调。 |
...
| [onLocalProxyStateChanged](Windows-callback#IRTCVideoEventHandler-onlocalproxystatechanged) | 本地代理状态发生改变回调。调用 [setLocalProxy](Windows-api.md#IRTCVideo-setlocalproxy) 设置本地代理后，SDK 会触发此回调，返回代理连接的状态。  <br> |
