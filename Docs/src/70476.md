...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=StopSnapshot&Version=2020-12-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=StopSnapshot&serviceCode=rtc&version=2020-12-01&groupName=抽帧截图" />
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=StopSnapshot&Version=2020-12-01
{
    "AppId": "Your_AppId",
