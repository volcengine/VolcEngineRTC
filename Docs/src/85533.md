...
| [onAudioRecordingStateUpdate](#rtcvideocallback-onaudiorecordingstateupdate) | 调用 [startAudioRecording](85532#startaudiorecording) 或 [stopAudioRecording](85532#stopaudiorecording) 改变音频文件录制状态时，收到此回调。 |
...
| [onPublicStreamDataMessageReceived](#rtcvideocallback-onpublicstreamdatamessagereceived) | 回调公共流中包含的数据信息。<br>通过 [`startPlayPublicStream`](85532#rtcvideo-startplaypublicstream)  订阅公共流后，通过监听本回调获取公共流中的数据消息，包括调用 Open API 发送的 SEI 消息和音量回调。 |
| [onHardwareEchoDetectionResult](#rtcvideocallback-onhardwareechodetectionresult) | 通话前回声检测结果回调。 |
| [onLocalProxyStateChanged](#rtcvideocallback-onlocalproxystatechanged) | 本地代理状态发生改变回调。调用 [setLocalProxy](85532#rtcvideo-setlocalproxy) 设置本地代理后，SDK 会触发此回调，返回代理连接的状态。 |
...
| [onPublicStreamSEIMessageReceived](#rtcvideocallback-onpublicstreamseimessagereceived) | 回调公共流中包含的 SEI 信息。<br>调用 [`startPlayPublicStream`](85532#startplaypublicstream) 接口启动拉公共流功能后，通过此回调收到公共流中的 SEI 消息。 |
| [onPlayPublicStreamResult](#rtcvideocallback-onplaypublicstreamresult) | 订阅公共流的结果回调<br>通过 [`startPlayPublicStream`](85532#rtcvideo-startplaypublicstream)  订阅公共流后，可以通过本回调获取订阅结果。 |
...
| [onPerformanceAlarms](#rtcvideocallback-onperformancealarms) | 本地未通过 [`setPublishFallbackOption`](85532#rtcvideo-setpublishfallbackoption) 开启发布性能回退，检测到设备性能不足时，收到此回调。本地通过 [`setPublishFallbackOption`](85532#rtcvideo-setpublishfallbackoption) 开启发布性能回退，因设备性能/网络原因，造成发布性能回退/恢复时，收到此回调。 |
...
- **参数**
  ...
  - **music_infos**
    ...
    类型: [KTVErrorCode](85534#ktverrorcode)
...
- **参数**
  ...
  - **error_code**
    ...
    类型: [HotMusicInfo](85535#hotmusicinfo)[]
...
- **参数**
  ...
  - **download_info**
    ...
    类型: [DownloadResult](85535#downloadresult)
...
- **参数**
  ...
  - **play_state**
    ...
    类型: [PlayState](85535#playstate)

    音乐播放状态。

  - **error_code**

    类型: [KTVPlayerErrorCode](85534#ktvplayererrorcode)
...
- **参数**
  ...
  - **taskId**
    ...
    本地截图任务的编号。和 [takeLocalSnapshot](85532#takelocalsnapshot) 的返回值一致。
...
- **参数**
  ...
  - **taskId**
    ...
    远端截图任务的编号。和 [takeRemoteSnapshot](85532#takeremotesnapshot) 的返回值一致。
...
- **参数**
  ...
  - **user**
    ...
    类型: [RtcUser](85535#rtcuser)

    本地用户信息

  - **state**

    类型: [FirstFrameSendState](85535#firstframesendstate)
...
- **参数**
  ...
  - **state**
    ...
    类型: [FirstFramePlayState](85535#firstframeplaystate)
...
- **参数**
  ...
  - **result**
    ...
    类型: [FaceDetectResult](85535#facedetectresult)
...
- **参数**
  ...
  - **device_type**
    ...
    类型: [RTCAudioDeviceType](85535#rtcaudiodevicetype)
...
- **注意**
  ...
  调用 [startSingScoring](85532#startsingscoring) 后，会收到该回调。

- **参数**

  - **info**

    类型: [SingScoringRealtimeInfo](85535#singscoringrealtimeinfo)

    实时评分信息。

### onAudioRecordingStateUpdate <span id="rtcvideocallback-onaudiorecordingstateupdate"></span> 

调用 [startAudioRecording](85532#startaudiorecording) 或 [stopAudioRecording](85532#stopaudiorecording) 改变音频文件录制状态时，收到此回调。
...
- **参数**
  ...
  - **state**
    ...
    类型: [AudioRecordingState](85535#audiorecordingstate)

    录制状态

  - **errorCode**

    类型: [AudioRecordingErrorCode](85534#audiorecordingerrorcode)
...
回调公共流中包含的数据信息。
通过 [`startPlayPublicStream`](85532#rtcvideo-startplaypublicstream)  订阅公共流后，通过监听本回调获取公共流中的数据消息，包括调用 Open API 发送的 SEI 消息和音量回调。
...
- **注意**
  ...
  通过调用客户端 API 插入的 SEI 信息，应通过回调 [`onPublicStreamSEIMessageReceived`](85533#rtcvideocallback-onpublicstreamseimessagereceived) 获取。
...
```
  ...
  - **message_length**
    ...
    类型: [DataMessageSourceType](85535#datamessagesourcetype)
...
- **注意**
  ...
  * + 通话前调用 [startHardwareEchoDetection](85532#rtcvideo-starthardwareechodetection) 后，将触发本回调返回检测结果。
...
- **参数**
  ...
  - **hardwareEchoDetectionResult**
    ...
    类型: [HardwareEchoDetectionResult](85535#hardwareechodetectionresult)

    通话前回声检测结果

### onLocalProxyStateChanged <span id="rtcvideocallback-onlocalproxystatechanged"></span> 

本地代理状态发生改变回调。调用 [setLocalProxy](85532#rtcvideo-setlocalproxy) 设置本地代理后，SDK 会触发此回调，返回代理连接的状态。
...
- **参数**
  ...
  - **localProxyType**
    ...
    类型: [LocalProxyType](85535#localproxytype)

    本地代理类型。

  - **localProxyState**

    类型: [LocalProxyState](85535#localproxystate)

    本地代理状态。

  - **localProxyError**

    类型: [LocalProxyError](85534#localproxyerror)
...
- **参数**
  ...
  - **event**
    ...
    类型: [StreamMixingEvent](85535#streammixingevent)
  ...
  - **error**
    ...
    类型: [StreamMixingErrorCode](85534#streammixingerrorcode)

    转推直播错误码

  - **mix_type**

    类型: [MixedStreamType](85535#mixedstreamtype)
...
- **参数**
  ...
  - **video_frame**
    ...
    类型: [IVideoFrame](85535#ivideoframe)
...
- **参数**
  ...
  - **audio_frame**
    ...
    类型: [IAudioFrame](85535#iaudioframe)
...
- **参数**
  ...
  - **data_frame**
    ...
    类型: [IDataFrame](85535#idataframe)
...
- **注意**
  ...
  关于订阅公共流，详见 [`startPlayPublicStream`](85532#startplaypublicstream)。
...
- **参数**
  ...
  - **error_code**
    ...
    类型: [PublicStreamErrorCode](85534#publicstreamerrorcode)
...
- **参数**
  ...
  - **info**
    ...
    类型: [VideoFrameInfo](85535#videoframeinfo)
...
回调公共流中包含的 SEI 信息。
调用 [`startPlayPublicStream`](85532#startplaypublicstream) 接口启动拉公共流功能后，通过此回调收到公共流中的 SEI 消息。
...
- **注意**
  ...
  通过 Open API 插入的自定义信息，应通过回调 [`onPublicStreamDataMessageReceived`](85533#rtcvideocallback-onpublicstreamdatamessagereceived) 获取。
...
- **参数**
  ...
  - **warn**
    ...
    类型: [WarningCode](85534#warningcode)
...
- **注意**
  ...
  当调用 [startAudioMixing](85532#startaudiomixing) 启动的混音文件播放结束后，会触发该回调。
...
- **注意**
  ...
  + 当调用 [startAudioMixing](85532#startaudiomixing) 方法成功后，会触发 state 值为 kAudioMixingStatePlaying 回调；否则触发 state 值为 kAudioMixingStateFailed 的回调。
...
- **参数**
  ...
  - **state**
    ...
    类型: [AudioMixingState](85535#audiomixingstate)

    混音状态

  - **error**

    类型: [AudioMixingError](85534#audiomixingerror)
...
- **注意**
  ...
  调用 [setAudioMixingProgressInterval](85532#setaudiomixingprogressinterval) 将时间间隔设为大于 0 的值后，或调用 [startAudioMixing](85532#startaudiomixing) 将 AudioMixingConfig 中的时间间隔设为大于 0 的值后，SDK 会按照设置的时间间隔回调该事件。
...
- **参数**
  ...
  - **state**
    ...
    类型: [ConnectionState](85535#connectionstate)
...
- **参数**
  ...
  - **type**
    ...
    类型: [NetworkType](85535#networktype)

    SDK 当前的网络连接类型

### onPerformanceAlarms <span id="rtcvideocallback-onperformancealarms"></span> 

本地未通过 [`setPublishFallbackOption`](85532#rtcvideo-setpublishfallbackoption) 开启发布性能回退，检测到设备性能不足时，收到此回调。本地通过 [`setPublishFallbackOption`](85532#rtcvideo-setpublishfallbackoption) 开启发布性能回退，因设备性能/网络原因，造成发布性能回退/恢复时，收到此回调。
...
- **参数**
  ...
  - **mode**
    ...
    类型: [PerformanceAlarmMode](85535#performancealarmmode)
  ...
  - **reason**
    ...
    类型: [PerformanceAlarmReason](85535#performancealarmreason)

    告警原因

  - **data**

    类型: [SourceWantedData](85535#sourcewanteddata)
...
- **参数**
  ...
  - **event**
    ...
    类型: [RemoteStreamSwitch](85535#remotestreamswitch)
...
- **参数**
  ...
  - **state**
    ...
    类型: [LocalAudioStreamState](85535#localaudiostreamstate)

    本地音频设备的状态

  - **error**

    类型: [LocalAudioStreamError](85534#localaudiostreamerror)
...
- **参数**
  ...
  - **state**
    ...
    类型: [RemoteAudioState](85535#remoteaudiostate)

    远端音频流状态

  - **reason**

    类型: [RemoteAudioStateChangeReason](85535#remoteaudiostatechangereason)
...
- **参数**
  ...
  - **state**
    ...
    类型: [LocalVideoStreamState](85535#localvideostreamstate)

    本地视频流状态

  - **error**

    类型: [LocalVideoStreamError](85534#localvideostreamerror)
...
- **参数**
  ...
  - **state**
    ...
    类型: [RemoteVideoState](85535#remotevideostate)

    远端视频流状态

  - **reason**

    类型: [RemoteVideoStateChangeReason](85535#remotevideostatechangereason)
...
- **参数**
  ...
  - **error**
    ...
    类型: [MessageSendResultCode](85534#messagesendresultcode)
...
- **注意**
  ...
  同一房间内其他用户调用 [sendUserBinaryMessage](85532#senduserbinarymessage) 发送二进制消息给本地用户时，本地用户会收到该回调。
...
- **参数**
  ...
  - **state_code**
    ...
    类型: [SubscribeState](85535#subscribestate)
  ...
  - **info**
    ...
    类型: [SubscribeConfig](85535#subscribeconfig)
...
- **参数**
  ...
  - **event**
    ...
    类型: [SingleStreamPushEvent](85535#singlestreampushevent)
...
- **注意**
  ...
  该回调由 [`startFileRecording`](85532#startfilerecording) 或 [`stopFileRecording`](85532#stopfilerecording) 触发。
...
- **参数**
  ...
  - **info**
    ...
    类型: [RecordingInfo](85535#recordinginfo)
...
- **注意**
  ...
  该回调由 [`startFileRecording`](85532#startfilerecording) 触发，录制状态正常时，系统每秒钟都会通过该回调提示录制进度。
...
- **参数**
  ...
  - **process**
    ...
    类型: [RecordingProgress](85535#recordingprogress)
...
- **参数**
  ...
  - **elapsed**
    ...
    从调用 [login](85532#rtcvideo-login) 接口开始到返回结果所用时长，单位为 ms。
...
- **注意**
  ...
  调用 [logout](85532#rtcvideo-logout) 后，会收到此回调。

- **参数**

  - **reason**

    类型: [LogoutReason](85535#logoutreason)
...
- **注意**
  ...
  调用 [setServerParams](85532#setserverparams) 后，会收到此回调。
...
- **注意**
  ...
  必须先调用 [getPeeronlineStatus](85532#getpeeronlinestatus)，才能收到此回调。
...
- **注意**
  ...
  当调用 [sendUserMessageOutsideRoom](85532#sendusermessageoutsideroom) 或 [sendUserBinaryMessageOutsideRoom](85532#senduserbinarymessageoutsideroom) 发送消息后，会收到此回调。
...
- **注意**
  ...
  当调用 [sendServerMessage](85532#sendservermessage) 或 [sendServerBinaryMessage](85532#sendserverbinarymessage) 接口发送消息后，会收到此回调。
...
- **参数**
  ...
  - **audio_properties_infos**
    ...
    类型: [LocalAudioPropertiesInfo](85535#localaudiopropertiesinfo)[]
...
- **参数**
  ...
  - **audio_properties_infos**
    ...
    类型: [RemoteAudioPropertiesInfo](85535#remoteaudiopropertiesinfo)[]
...
- **参数**
  ...
  - **result**
    ...
    类型: [EchoTestResult](85535#echotestresult)
...
- **注意**
  ...
  调用 [`startAudioPlaybackDeviceTest`](85532#startaudioplaybackdevicetest) 开始播放音频文件或录音时，将开启该回调。本回调为周期性回调，回调周期由上述接口的 `interval` 参数指定。
...
- **参数**
  ...
  - **device_warning**
    ...
    类型: [MediaDeviceWarning](85535#mediadevicewarning)
...
- **参数**
  ...
  - **type**
    ...
    类型: [SEIStreamEventType](85535#seistreameventtype)
...
| 方法 | 描述 |
| :-- | :-- |
| [onUserVisibilityChanged](#rtcroomcallback-onuservisibilitychanged) | 用户调用 [setUserVisibility](85532#rtcroom-setuservisibility) 设置用户可见性的回调。 |
...
| [onSetRoomExtraInfoResult](#rtcroomcallback-onsetroomextrainforesult) | 调用 [setRoomExtraInfo](85532#rtcroom-setroomextrainfo) 设置房间附加信息结果的回调。 |
| [onRoomExtraInfoUpdate](#rtcroomcallback-onroomextrainfoupdate) | 接收同一房间内，其他用户调用 [setRoomExtraInfo](85532#rtcroom-setroomextrainfo) 设置的房间附加信息的回调。 |
| [onSubtitleStateChanged](#rtcroomcallback-onsubtitlestatechanged) | 字幕状态发生改变回调。<br>当用户调用 [startSubtitle](85532#startsubtitle) 和 [stopSubtitle](85532#stopsubtitle) 使字幕状态发生改变或字幕任务出现错误时，触发该回调。 |
| [onSubtitleMessageReceived](#rtcroomcallback-onsubtitlemessagereceived) | 字幕相关内容回调。<br>当用户成功调用 [startSubtitle](85532#startsubtitle) 后会收到此回调，通知字幕的相关信息。 |

### onUserVisibilityChanged <span id="rtcroomcallback-onuservisibilitychanged"></span> 

用户调用 [setUserVisibility](85532#rtcroom-setuservisibility) 设置用户可见性的回调。
...
+ false: 不可见，用户不可以在房间内发布音视频流，房间中的其他用户不会收到用户的行为通知，例如进房、开启视频采集和退房。
  ...
  - **error_code**
    ...
    类型: [UserVisibilityChangeError](85534#uservisibilitychangeerror)
...
- **参数**
  ...
  - **state**
    ...
    流状态码，参看 [ErrorCode](85534#errorcode) 及 [WarningCode](85534#warningcode)。
...
- **注意**
  ...
  + 用户调用 [`leaveRoom`](85532#leaveroom) 方法后，SDK 会停止所有的发布订阅流，并在释放所有通话相关的音视频资源后，通过此回调通知用户离开房间成功。
...
- **参数**
  ...
  - **stats**
    ...
    类型: [RtcRoomStats](85535#rtcroomstats)
...
- **参数**
  ...
  - **elapsed**
    ...
    可见角色用户调用 [joinRoom](85532#joinroom) 加入房间到房间内其他用户收到该事件经历的时间，单位为 ms。
...
- **参数**
  ...
  - **reason**
    ...
    类型: [UserOfflineReasonType](85535#userofflinereasontype)
...
- **注意**
  ...
  调用 [updateToken](85532#updatetoken) 更新 Token。否则 Token 过期后，用户将被移出房间无法继续进行音视频通话。
...
- **参数**
  ...
  - **state**
    ...
    类型: [AVSyncState](85535#avsyncstate)
...
- **参数**
  ...
  - **stats**
    ...
    类型: [LocalStreamStats](85535#localstreamstats)
...
- **参数**
  ...
  - **stats**
    ...
    类型: [RemoteStreamStats](85535#remotestreamstats)
...
- **注意**
  ...
  当房间内的远端用户调用 [publishStream](85532#publishstream) 成功发布由麦克风采集的音频流时，本地用户会收到该回调，此时本地用户可以自行选择是否调用 [subscribeStream](85532#subscribestream) 订阅此流。
...
- **注意**
  ...
  收到该回调通知后，你可以自行选择是否调用 [unsubscribeStream](85532#unsubscribestream) 取消订阅此流。
...
- **参数**
  ...
  - **reason**
    ...
    类型: [StreamRemoveReason](85535#streamremovereason)
...
- **注意**
  ...
  当房间内的远端用户调用 [publishScreen](85532#publishscreen) 成功发布来自屏幕共享的音视频流时，本地用户会收到该回调，此时本地用户可以自行选择是否调用 [subscribeScreen](85532#subscribescreen) 订阅此流。
...
- **注意**
  ...
  收到该回调通知后，你可以自行选择是否调用 [unsubscribeScreen](85532#unsubscribescreen) 取消订阅此流。
...
- **注意**
  ...
  房间内其他用户调用 [`sendRoomMessage`](85532#sendroommessage) 发送广播消息时，收到此回调。
...
- **注意**
  ...
  房间内其他用户调用 [`sendRoomBinaryMessage`](85532#sendroombinarymessage) 发送广播二进制消息时，收到此回调。
...
- **注意**
  ...
  调用 [sendUserMessage](85532#sendusermessage) 或 [sendUserBinaryMessage](85532#senduserbinarymessage) 接口，才能收到此回调。
...
- **参数**
  ...
  - **infos**
    ...
    类型: [ForwardStreamStateInfo](85535#forwardstreamstateinfo)[]
...
- **参数**
  ...
  - **infos**
    ...
    类型: [ForwardStreamEventInfo](85535#forwardstreameventinfo)[]
...
- **参数**
  ...
  - **localQuality**
    ...
    类型: [NetworkQualityStats](85535#networkqualitystats)
...
- **注意**
  ...
  收到该回调后，你需调用 [updateToken](85532#updatetoken) 更新 Token 发布权限。若收到该回调后未及时更新 Token，Token 发布权限过期后：
...
- **注意**
  ...
  收到该回调后，你需调用 [updateToken](85532#updatetoken) 更新 Token 订阅权限有效期。若收到该回调后未及时更新 Token，Token 订阅权限过期后，尝试新订阅流会失败，已订阅的流会取消订阅，并且会收到 [onStreamStateChanged](#onstreamstatechanged) 回调，提示错误码为 `-1003` 没有订阅权限。

### onSetRoomExtraInfoResult <span id="rtcroomcallback-onsetroomextrainforesult"></span> 

调用 [setRoomExtraInfo](85532#rtcroom-setroomextrainfo) 设置房间附加信息结果的回调。
...
- **参数**
  ...
  - **error_code**
    ...
    类型: [SetRoomExtraInfoResult](85535#setroomextrainforesult)

    error_code 设置房间附加信息的结果。

### onRoomExtraInfoUpdate <span id="rtcroomcallback-onroomextrainfoupdate"></span> 

接收同一房间内，其他用户调用 [setRoomExtraInfo](85532#rtcroom-setroomextrainfo) 设置的房间附加信息的回调。
...
- **参数**
  ...
  - **state**
    ...
    类型: [SubtitleState](85535#subtitlestate)

    字幕状态。

  - **error_code**

    类型: [SubtitleErrorCode](85534#subtitleerrorcode)
...
- **参数**
  ...
  - **subtitles**
    ...
    类型: [SubtitleMessage](85535#subtitlemessage)[]
...
- **参数**
  ...
  - **effect_id**
    ...
    veRTCAudioEffectPlayer 的 ID。通过 [getAudioEffectPlayer](85532#rtcvideo-getaudioeffectplayer) 设置。

  - **state**

    类型: [PlayerState](85535#playerstate)

    混音状态。

  - **error**

    类型: [PlayerError](85534#playererror)
...
- **参数**
  ...
  - **player_id**
    ...
    veRTCMediaPlayer 的 ID。通过 [getMediaPlayer](85532#rtcvideo-getmediaplayer) 设置。
