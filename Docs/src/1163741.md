...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=StartRecord&Version=2023-06-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=StartRecord&serviceCode=rtc&version=2023-06-01&groupName=云端录制" />
...
const data = [
  ...
  },
  {
    "name": "StorageConfig",
    "key": "0-12",
    "title": "<p>录制文件的存储平台。</p>\n目前支持：<a href=\"https://www.volcengine.com/product/vod\" target=\"_blank\" class=\"external\">火山引擎视频点播 VOD</a> 、<a href=\"https://www.volcengine.com/product/tos\" target=\"_blank\" class=\"external\">火山引擎对象存储 TOS</a>、Amazon S3、阿里云对象存储 OSS、华为云 OBS、腾讯云 COS 和七牛云 Kodo。",
    "example": "<code>-</code>",
    "required": "是",
    "type": "Object",
    "children": [
      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            "name": "Region",
            "key": "0-12-4-1",
            "title": "不同存储平台支持的 Region 不同，具体参看 <a href=\"1167931#region\">Region对照表</a>默认值为<code>0</code>。",
            "example": "<code>-</code>",
            "required": "否",
            "type": "Integer"
          },
          {
            "name": "ServiceId",
            "key": "0-12-4-2",
            "title": "<p>服务 ID。</p>\n<ul>\n<li>你可以在 veImageX 控制台 <a href=\"https://console.volcengine.com/imagex/service_manage/\" target=\"_blank\" class=\"external\">服务管理</a>页面，通过创建好的图片服务中获取服务 ID。<br>\n你也可以通过 OpenAPI 的方式获取服务 ID，具体请参考<a href=\"https://www.volcengine.com/docs/508/9360\" target=\"_blank\" class=\"external\">获取所有服务信息</a>。</li>\n</ul>",
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=StartRecord&Version=2023-06-01
{
  "AppId": "You****pId",
