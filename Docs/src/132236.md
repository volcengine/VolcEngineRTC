...
关于完整的项目实现，参考 [Demo 工程文件](1163793)。

## 前提条件

- Flutter 2.0.0+
- Dart 2.12.0+
- 获取 [Appid](69865#步骤4：创建-rtc-应用，获取-appid)
- 如果目标平台为 Android：
	- Android Studio 3.5+
...
||| • 0: 加入房间成功； |\
||| • 非 0: 加入房间失败。具体原因参看 [ErrorCode](https://www.volcengine.com/docs/6348/Android-errorcode#errorcode) 及 [WarningCode](https://www.volcengine.com/docs/6348/Android-errorcode#warningcode)。 |
