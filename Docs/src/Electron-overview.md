...
| [feedback](85532.md#rtcvideo-feedback) | 将用户反馈的问题上报到 RTC |
...
| `static` [setLogConfig](85532.md#rtcvideo-static-setlogconfig) | 设置日志文件 |
| `static` [getErrorDescription](85532.md#rtcvideo-static-geterrordescription) | 获取错误码的描述 |
| `static` [getCurrentProcessId](85532.md#rtcvideo-static-getcurrentprocessid) | 获取加载引擎进程的 ID 方便调试 |
| `static` [setRenderType](85532.md#rtcvideo-static-setrendertype) | 设置渲染类型 |
...
| [onUserVisibilityChanged](85533#rtcroomcallback-onuservisibilitychanged) | 用户调用 [setUserVisibility](85532.md#rtcroom-setuservisibility) 设置用户可见性的回调。 |
| [updateToken](85532.md#rtcroom-updatetoken) | 更新 Token。Token 中同时包含进房、发布和订阅权限，各权限有一定的有效期，并且到期前 30 秒会触发回调，提示用户更新 Token 相关权限。此时需要重新获取 Token，并调用此方法更新 Token，以保证通话的正常进行。 |
...
| [onAudioDeviceWarning](85533.md#rtcvideocallback-onaudiodevicewarning) | 音频设备警告回调。音频设备包括音频采集设备和音频渲染设备。 |
...
| [startAudioDeviceRecordTest](85532.md#rtcvideo-startaudiodevicerecordtest) | 开始音频采集设备和音频播放设备测试。 |
| [stopAudioDeviceRecordAndPlayTest](85532.md#rtcvideo-stopaudiodevicerecordandplaytest) | 停止采集本地音频，并开始播放采集到的声音。录音播放完毕后，设备测试流程结束。 |
| [stopAudioDevicePlayTest](85532.md#rtcvideo-stopaudiodeviceplaytest) | 停止由调用 [startAudioDeviceRecordTest](85532.md#rtcvideo-startaudiodevicerecordtest) 开始的音频播放设备测试。 |
| [enableExternalSoundCard](85532.md#rtcvideo-enableexternalsoundcard) | 启用匹配外置声卡的音频处理模式 |
...
| [onVideoDeviceWarning](85533.md#rtcvideocallback-onvideodevicewarning) | 视频设备警告回调，包括视频采集设备等。 |
...
| [setDummyCaptureImagePath](85532.md#rtcvideo-setdummycaptureimagepath) | 摄像头处于关闭状态时，使用静态图片填充本地推送的视频流。可重复调用该接口来更新图片。若要停止发送图片，可传入空字符串或启用内部摄像头采集。 |
...
| [onRemoteAudioStateChanged](85533.md#rtcvideocallback-onremoteaudiostatechanged) | 用户订阅来自远端的音频流状态发生改变时，会收到此回调，了解当前的远端音频流状态。 |
...
| [onRemoteVideoStateChanged](85533.md#rtcvideocallback-onremotevideostatechanged) | 远端视频流的状态发生改变时，房间内订阅此流的用户会收到该事件。 |
...
| 方法 | 描述 |
| :-- | :-- |
| [setVoiceChangerType](85532.md#rtcvideo-setvoicechangertype) | 设置变声特效类型 |
| [setVoiceReverbType](85532.md#rtcvideo-setvoicereverbtype) | 设置混响特效类型 |
...
| [enablePlaybackDucking](85532.md#rtcvideo-enableplaybackducking) | 打开/关闭音量闪避功能，适用于在 RTC 通话过程中会同时播放短视频或音乐的场景，如“一起看”、“在线 KTV”等。<br>开启该功能后，当检测到远端人声时，本地的媒体播放音量会自动减弱，从而保证远端人声的清晰可辨；当远端人声消失时，本地媒体音量会恢复到闪避前的音量水平。 |
...
| 方法 | 描述 |
| :-- | :-- |
| [setLocalVideoSink](85532.md#rtcvideo-setlocalvideosink) | 获取本地视频流。 |
| [unsetLocalVideoSink](85532.md#rtcvideo-unsetlocalvideosink) | 停止获取本地视频流。 |
| [setRemoteVideoSink](85532.md#rtcvideo-setremotevideosink) | 获取远端视频流。 |
| [unsetRemoteVideoSink](85532.md#rtcvideo-unsetremotevideosink) | 停止获取远端视频流。 |
...
| [enableAudioFrameCallback](85532.md#rtcvideo-enableaudioframecallback) | 设置并开启指定的音频数据帧回调 |
| [disableAudioFrameCallback](85532.md#rtcvideo-disableaudioframecallback) | 关闭音频回调 |
...
| [onRemoteUserAudioFrame](85533.md#rtcvideocallback-onremoteuseraudioframe) | 返回远端单个用户的音频数据 |
| [onMixedAudioFrame](85533.md#rtcvideocallback-onmixedaudioframe) | 返回本地麦克风录制和远端所有用户混音后的音频数据 |
| [onRecordScreenAudioFrame](85533.md#rtcvideocallback-onrecordscreenaudioframe) | 返回本地屏幕录制的音频数据 |
...
| [onPerformanceAlarms](85533#rtcvideocallback-onperformancealarms) | 本地未通过 [setPublishFallbackOption](85532.md#rtcvideo-setpublishfallbackoption) 开启发布性能回退，检测到设备性能不足时，收到此回调。本地通过 [setPublishFallbackOption](85532.md#rtcvideo-setpublishfallbackoption) 开启发布性能回退，因设备性能/网络原因，造成发布性能回退/恢复时，收到此回调。 |
...
| [onSEIStreamUpdate](85533#rtcvideocallback-onseistreamupdate) | 黑帧视频流发布状态回调。  <br>在语音通话场景下，本地用户调用 [sendSEIMessage](85532.md#rtcvideo-sendseimessage) 通过黑帧视频流发送 SEI 数据时，流的发送状态会通过该回调通知远端用户。  <br>你可以通过此回调判断携带 SEI 数据的视频帧为黑帧，从而不对该视频帧进行渲染。 |
...
| [setAudioAlignmentProperty](85532.md#rtcvideo-setaudioalignmentproperty) | 在听众端，设置订阅的所有远端音频流精准对齐后播放。 |
...
| 方法 | 描述 |
| :-- | :-- |
| [getAudioEffectPlayer](85532.md#rtcvideo-getaudioeffectplayer) | 创建音效播放器实例。 |
| [start](85532.md#rtcaudioeffectplayer-start) | 开始播放音效文件。<br>可以通过传入不同的 ID 和 filepath 多次调用本方法，以实现同时播放多个音效文件，实现音效叠加。 |
| [stop](85532.md#rtcaudioeffectplayer-stop) | 停止播放音效文件。 |
| [stopAll](85532.md#rtcaudioeffectplayer-stopall) | 停止播放所有音效文件。 |
| [preload](85532.md#rtcaudioeffectplayer-preload) | 预加载指定音乐文件到内存中，以避免频繁播放同一文件时的重复加载，减少 CPU 占用。 |
| [unload](85532.md#rtcaudioeffectplayer-unload) | 卸载指定音效文件。 |
| [unloadAll](85532.md#rtcaudioeffectplayer-unloadall) | 卸载所有音效文件。 |
| [pause](85532.md#rtcaudioeffectplayer-pause) | 暂停播放音效文件。 |
| [pauseAll](85532.md#rtcaudioeffectplayer-pauseall) | 暂停播放所有音效文件。 |
| [resume](85532.md#rtcaudioeffectplayer-resume) | 恢复播放音效文件。 |
| [resumeAll](85532.md#rtcaudioeffectplayer-resumeall) | 恢复播放所有音效文件。 |
| [setPosition](85532.md#rtcaudioeffectplayer-setposition) | 设置音效文件的起始播放位置。 |
| [getPosition](85532.md#rtcaudioeffectplayer-getposition) | 获取音效文件播放进度。 |
| [setVolume](85532.md#rtcaudioeffectplayer-setvolume) | 调节指定音效的音量大小，包括音效文件和 PCM 音频。 |
| [setVolumeAll](85532.md#rtcaudioeffectplayer-setvolumeall) | 设置所有音效的音量大小，包括音效文件和 PCM 音效。 |
| [getVolume](85532.md#rtcaudioeffectplayer-getvolume) | 获取当前音量。 |
| [getDuration](85532.md#rtcaudioeffectplayer-getduration) | 获取音效文件时长。 |
| [setEventHandler](85532.md#rtcaudioeffectplayer-seteventhandler) | 设置回调句柄。 |
| [onAudioEffectPlayerStateChanged](85533.md#rtcaudioeffectplayercallback-onaudioeffectplayerstatechanged) | 播放状态改变时回调。 |
...
| 方法 | 描述 |
| :-- | :-- |
| [getMediaPlayer](85532.md#rtcvideo-getmediaplayer) | 创建音乐播放器实例。 |
| [open](85532.md#rtcmediaplayer-open) | 打开音乐文件。<br>一个播放器实例仅能够同时打开一个音乐文件。如果需要同时打开多个音乐文件，请创建多个音乐播放器实例。 |
| [start](85532.md#rtcmediaplayer-start) | 播放音乐。你仅需要在调用 [open](85532.md#rtcmediaplayer-open)，且未开启自动播放时，调用此方法。 |
| [stop](85532.md#rtcmediaplayer-stop) | 调用 [open](85532.md#rtcmediaplayer-open) 或 [start](85532.md#rtcmediaplayer-start) 开始播放后，可以调用本方法停止。 |
| [pause](85532.md#rtcmediaplayer-pause) | 调用 [open](85532.md#rtcmediaplayer-open)，或 [start](85532.md#rtcmediaplayer-start) 开始播放音频文件后，调用本方法暂停播放。 |
| [resume](85532.md#rtcmediaplayer-resume) | 调用 [pause](85532.md#rtcmediaplayer-pause) 暂停音频播放后，调用本方法恢复播放。 |
| [setVolume](85532.md#rtcmediaplayer-setvolume) | 调节指定混音的音量大小，包括音乐文件混音和 PCM 混音。 |
| [getVolume](85532.md#rtcmediaplayer-getvolume) | 获取当前音量 |
| [getTotalDuration](85532.md#rtcmediaplayer-gettotalduration) | 获取音乐文件时长。 |
| [getPlaybackDuration](85532.md#rtcmediaplayer-getplaybackduration) | 获取混音音乐文件的实际播放时长，单位为毫秒。 |
| [getPosition](85532.md#rtcmediaplayer-getposition) | 获取音乐文件播放进度。 |
| [setPosition](85532.md#rtcmediaplayer-setposition) | 设置音乐文件的起始播放位置。 |
| [setAudioPitch](85532.md#rtcmediaplayer-setaudiopitch) | 开启变调功能，多用于 K 歌场景。 |
| [setAudioDualMonoMode](85532.md#rtcmediaplayer-setaudiodualmonomode) | 设置当前音乐文件的声道模式 |
| [getAudioTrackCount](85532.md#rtcmediaplayer-getaudiotrackcount) | 获取当前音乐文件的音轨数 |
| [selectAudioTrack](85532.md#rtcmediaplayer-selectaudiotrack) | 指定当前音乐文件的播放音轨 |
| [setPlaybackSpeed](85532.md#rtcmediaplayer-setplaybackspeed) | 设置播放速度 |
| [setProgressInterval](85532#rtcmediaplayer-setprogressinterval) | 设置音频文件混音时，收到 [onMediaPlayerPlayingProgress](85533.md#rtcmediaplayercallback-onmediaplayerplayingprogress) 的间隔。 |
| [setLoudness](85532.md#rtcmediaplayer-setloudness) | 如果你需要使用 enableVocalInstrumentBalance#IRTCVideo#enableVocalInstrumentBalance 对音频文件/PCM 音频数据设置音量均衡，你必须通过此接口传入其原始响度。 |
| [setEventHandler](85532.md#rtcmediaplayer-seteventhandler) | 注册回调句柄以在本地音乐文件混音时，收到相关回调。 |
| [onMediaPlayerStateChanged](85533.md#rtcmediaplayercallback-onmediaplayerstatechanged) | 播放状态改变时回调。 |
| [onMediaPlayerPlayingProgress](85533.md#rtcmediaplayercallback-onmediaplayerplayingprogress) | 播放进度周期性回调。回调周期通过 [setAudioMixingProgressInterval] 设置。 |
...
| [onClearCacheResult](85533.md#rtcvideocallback-onclearcacheresult) | 清理文件缓存结果回调。 |
...
| [getStandardPitchCount](85532.md#rtcvideo-getstandardpitchcount) | 获取当前系统内音视频设备数量 |
| [getStandardPitchInfo](85532.md#rtcvideo-getstandardpitchinfo) | 获取每句歌词的标准音高信息 |
...
| [unsetPublicStreamVideoSink](85532.md#rtcvideo-unsetpublicstreamvideosink) | 为指定公共解绑自定义渲染器。 |
...
| [onPublicStreamDataMessageReceived](85533#rtcvideocallback-onpublicstreamdatamessagereceived) | 回调公共流中包含的数据信息。<br>通过 [startPlayPublicStream](85532.md#rtcvideo-startplaypublicstream) 开始播放公共流后，可以通过本回调获取发送端发送的数据消息。 |
...
| 方法 | 描述 |
| :-- | :-- |
| [initializePluginManager](85532.md#rtcvideo-initializepluginmanager) | 初始化插件管理器 |
| [registerPlugin](85532.md#rtcvideo-registerplugin) | 注册插件 |
| [getPlugin](85532.md#rtcvideo-getplugin) | 获取插件实例 |
| [unregisterPlugin](85532.md#rtcvideo-unregisterplugin) | 卸载插件 |
| [releasePluginManager](85532.md#rtcvideo-releasepluginmanager) | 释放插件管理器 |
...
| 方法 | 描述 |
| :-- | :-- |
| [setEarMonitorMode](85532.md#rtcvideo-setearmonitormode) | 开启/关闭耳返功能 |
| [setEarMonitorVolume](85532.md#rtcvideo-setearmonitorvolume) | 设置耳返的音量 |
