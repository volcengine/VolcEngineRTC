...
| --- | --- | --- | --- | --- | --- |
| 1 | 参数变更 | 消息 | `virtual void onLogout()` | [`virtual void onLogout(int reason)`](70081#IRTCVideoEventHandler-onlogout) | 在 `onLogout` 回调上新增 reason 参数，区分用户主动/被动登出。具体参数类型参看 `LogoutReason`。 |
...
| --- | --- | --- | --- | --- |
| 1 | 成员变量新增 | 字幕翻译服务 | [`SubtitleMessage`](85535#subtitlemessage) | 在字幕内容回调 `onSubtitleMessageReceived` 的参数 `SubtitleMessage` 中新增成员变量 `language` 和 `mode`，可用于同时收到字幕原文和字幕译文。 |
| 2 | 成员变量变更 | CDN 推流 | [`MixedStreamLayoutRegionConfig`](85535#mixedstreamlayoutregionconfig) | 转推直播单个用户画面由设置相对于整体画面的归一化比例变更为可设置像素绝对值。 |
| 3 | 成员变量新增 | 音频管理 | [`AudioPropertiesInfo`](85535#audiopropertiesinfo) | 新增变量 `voicePitch` 返回本地用户的人声基频。 |
| 4 | 成员变量新增 | 引擎管理 | [`LogConfig`](85535#logconfig) | 新增变量 `log_filename_prefix` 用于自定义日志文件前缀。|
...
| --- | --- | --- | --- | --- |
|拆分|音视频传输|[`setPublicStreamVideoSink`](85532#rtcvideo-setpublicstreamvideosink)|拆分为两个方法<br>绑定：[`setPublicStreamVideoSink`](85532#rtcvideo-setpublicstreamvideosink)<br>解绑：[`unsetPublicStreamVideoSink`](85532#rtcvideo-unsetpublicstreamvideosink)| |
|行为变更|音频管理|<ul><li>[`enumerateAudioCaptureDevices`](85532#rtcvideo-enumerateaudiocapturedevices)</li><li>[`enumerateAudioPlaybackDevices`](85532#rtcvideo-enumerateaudioplaybackdevices)</li></ul>||等待超时后返回空列表，超时时间默认为 10 s|
|行为变更|视频管理|[`enumerateVideoCaptureDevices`](85532#rtcvideo-enumeratevideocapturedevices)||等待超时后返回空列表，超时时间默认为 10 s|
|参数变更|引擎管理|[`createRTCVideo`](85532#rtcvideo-creatertcvideo)删除了入参 document_path。<br>使用 [`setLogConfig`](85532#setlogconfig) 指定日志相关配置。|| |
...
| 变更详情 | 数据类型 | 说明 |
| --- | --- | --- |
|参数变更|[`IAudioFrame`](85535#iaudioframe)|变量 `type` 名称变更为 `frame_type`|
|类型变更|[`format`](85535#ivideoframe-format)|类型由 `number` 变更为枚举类 [`VideoPixelFormat`](85535#videopixelformat)|
|参数增删|[`IDataFrame`](85535#idataframe)|删除无意义字段 `u32_data_size`|
|参数增删|[`IPublicStreamParam`](85535#ipublicstreamparam)|增加参数 [`bg_color`](85535#ipublicstreamparam-bg_color)|
...
| --- | --- | --- | --- | --- | --- |
| 混音主调接口 | 将音效文件加载至内存 | - `preloadAudioMixing` | - [`preload`](85532#rtcaudioeffectplayer-preload) | - [`open`](85532#rtcmediaplayer-open) |  |\
||| - `unloadAudioMixing` | - [`unload`](85532#rtcaudioeffectplayer-unload) |\
|||| - [`unloadAll`](85532#rtcaudioeffectplayer-unloadall) |
|^^  | 播放/停止/暂停/恢复 | - `startAudioMixing` | - [`start`](85532#rtcaudioeffectplayer-start) | - [`start`](85532#rtcmediaplayer-start) |  |\
||| - `stopAudioMixing` | - [`stop`](85532#rtcaudioeffectplayer-stop) | - [`stop`](85532#rtcmediaplayer-stop) |\
||| - `stopAllAudioMixing` | - [`stopAll`](85532#rtcaudioeffectplayer-stopall) | - [`pause`](85532#rtcmediaplayer-pause) |\
||| - `pauseAudioMixing` | - [`pause`](85532#rtcaudioeffectplayer-pause) | - [`resume`](85532#rtcmediaplayer-resume) |\
||| - `pauseAllAudioMixing` | - [`pauseAll`](85532#rtcaudioeffectplayer-pauseall) |\
||| - `resumeAudioMixing` | - [`resume`](85532#rtcaudioeffectplayer-resume) |\
||| - `resumeAllAudioMixing` | - [`resumeAll`](85532#rtcaudioeffectplayer-resumeall) |
|^^  | 获取/指定位置/时长 | - `setAudioMixingPosition` | - [`setPosition`](85532#rtcaudioeffectplayer-setposition) | - [`setPosition`](85532#rtcmediaplayer-setposition) |  |\
||| - `getAudioMixingCurrentPosition` | - [`getPosition`](85532#rtcaudioeffectplayer-getposition) | - [`getPosition`](85532#rtcmediaplayer-getposition) |\
||| - `getAudioMixingDuration` | - [`getDuration`](85532#rtcaudioeffectplayer-getduration) | - [`getTotalDuration`](85532#rtcmediaplayer-gettotalduration) |\
||||| - [`getPlaybackDuration`](85532#rtcmediaplayer-getplaybackduration) |
| ^^ | 获取/指定音量 | - `setAudioMixingVolume` | - [`setVolume`](85532#rtcaudioeffectplayer-setvolume) | - [`setVolume`](85532#rtcmediaplayer-setvolume) |  |\
||| - NA | - [`setVolumeAll`](85532#rtcaudioeffectplayer-setvolumeall) | - [`getVolume`](85532#rtcmediaplayer-getvolume) |\
|||| - [`getVolume`](85532#rtcaudioeffectplayer-getvolume) |
| ^^ | 调整音调 |  `setAudioMixingPitch` | NA | [`setAudioPitch`](85532#rtcmediaplayer-setaudiopitch) |  |
| ^^ | 设置声道模式 | `setAudioMixingDualMonoMode` | NA | [`setAudioDualMonoMode`](85532#rtcmediaplayer-setaudiodualmonomode) |  |
| ^^ | 获取/设置音轨数 | - `getAudioTrackCount` | NA | - [`getAudioTrackCount`](85532#rtcmediaplayer-getaudiotrackcount) | `Index` 取值修改为从 0 开始 |\
||| - `selectAudioTrack` || - [`selectAudioTrack`](85532#rtcmediaplayer-selectaudiotrack) |
| ^^ | 设置播放速度 | `setAudioMixingPlaybackSpeed` | NA | [`setPlaybackSpeed`](85532#rtcmediaplayer-setplaybackspeed) |  |
| ^^ | 设置播放进度回调间隔 | `setAudioMixingProgressInterval` | NA | [`setProgressInterval`](85532#rtcmediaplayer-setprogressinterval) |  |
| ^^ | 设置响度 | `setAudioMixingLoudness` | NA | [`setLoudness`](85532#rtcmediaplayer-setloudness) |  |
| 混音回调接口 | 播放状态回调 | `onAudioMixingStateChanged` | - [`setEventHandler`](85532#rtcaudioeffectplayer-seteventhandler) | - [`setEventHandler`](85532#rtcmediaplayer-seteventhandler) |  |\
|||| - [`onAudioEffectPlayerStateChanged`](85533#rtcaudioeffectplayercallback-onaudioeffectplayerstatechanged) | - [`onMediaPlayerStateChanged`](85533#rtcmediaplayercallback-onmediaplayerstatechanged) |\
||||| - [`onMediaPlayerPlayingProgress`](85533#rtcmediaplayercallback-onmediaplayerplayingprogress) |
...
| 变更详情 | 功能模块 | 方法 | 说明 |
| --- | --- | --- | --- |
| 参数变更 | 引擎管理 | [`feedback`](85532#rtcvideo-feedback) | 参数数据类型变更 |
| 接口名称变更 | CDN 推流 | `startLiveTranscoding` | 用 [`startPushMixedStreamToCDN`](85532#rtcvideo-startpushmixedstreamtocdn) 替代 |
| ^^ | ^^ | `stopLiveTranscoding` | 用 [`stopPushStreamToCDN`](85532#rtcvideo-stoppushstreamtocdn) 替代 |
| ^^ | ^^ | `updateLiveTranscoding` | 用 [`updatePushMixedStreamToCDN`](85532#rtcvideo-updatepushmixedstreamtocdn) 替代 |
| 接口废弃 | 高级功能 | `updatePosition` | 用 [`updateSelfPosition()`](85532#updateselfposition) 替代，新接口支持本地用户同时设置自己的发声位置和发声朝向。 |\
||| `updateSelfOrientation` |
| ^^ | ^^ | `updateListenerPosition` | 用 [`updateRemotePosition()`](85532#updateremoteposition)替代，新接口支持本地用户设置远端用户的发声位置和发声朝向。 |\
...
||| 拆分为： |\
||||\
||| - [`onPublicStreamSEIMessageReceived`](85533#rtcroomcallback-onpublicstreamseimessagereceived)：接收客户端插入的 SEI 消息。 |\
||| - [`onPublicStreamDataMessageReceived`](85533#rtcroomcallback-onpublicstreamdatamessagereceived)：接收服务端插入的 SEI 消息和其他数据信息，例如音量信息。 |

### 错误码变更

| **变更详情** | **错误码** | **说明** |
| --- | --- | --- |
| 枚举值变更 | [`PublicStreamErrorCode`](85535#publicstreamerrorcode)` | 新增枚举值： |\
||||\
...
| ^^ | [`ErrorCode`](85534#errorcode) | 新增错误码枚举值：`kErrorCodeJoinRoomRoomForbidden=-1025` 和 `kErrorCodeJoinRoomUserForbidden=-1026`。当服务端在指定房间封禁指定用户，而此用户加入房间失败，或从房间中被踢出时收到。 |
