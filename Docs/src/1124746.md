...
如需体验海外环境，还需将 `IS_OVERSEA` 设为 `true`，demo 会自动连接到海外端点。

![](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_75545015fbb3d4f59efb7d407a3cda42.png =660x)
