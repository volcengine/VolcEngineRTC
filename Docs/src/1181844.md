...
调用 [createRTCVideo](https://www.volcengine.com/docs/6348/70086#ByteRTCVideo-creatertcvideo-delegate-parameters) 创建引擎，所有 RTC 相关的 API 调用都要在创建引擎之后。
...
创建引擎后，调用 [startVideoCapture](https://www.volcengine.com/docs/6348/70086#ByteRTCVideo-startvideocapture) 开启视频采集，调用 [startAudioCapture](https://www.volcengine.com/docs/6348/70086#ByteRTCVideo-startaudiocapture) 开启音频采集。
...
调用 [createRTCRoom](https://www.volcengine.com/docs/6348/70086#ByteRTCVideo-creatertcroom) 创建 RTC 房间，所有和房间相关的 API 都在 ByteRTCRoom 类。
[joinRoom](https://www.volcengine.com/docs/6348/70086#ByteRTCRoom-joinroom-userinfo-roomconfig) 表示进房，进房状态可以通过 ByteRTCRoomDelegate 中 [onRoomStateChanged](https://www.volcengine.com/docs/6348/70087#ByteRTCRoomDelegate-rtcroom-onroomstatechanged-withuid-state-extrainfo) 回调。
...
调用 [setLocalVideoCanvas](https://www.volcengine.com/docs/6348/70086#setlocalvideocanvas-withcanvas) 设置本端渲染窗口。
...
在收到远端用户的 [onUserPublishStream](https://www.volcengine.com/docs/6348/70087#ByteRTCRoomDelegate-rtcroom-onuserpublishstream-type) 回调后，你需要调用 [setRemoteVideoCanvas](https://www.volcengine.com/docs/6348/70086#ByteRTCVideo-setremotevideocanvas-withcanvas) 设置远端视图以在通话中查看远端视频。
...
在收到远端用户的 [onUserUnpublishStream](https://www.volcengine.com/docs/6348/70087#ByteRTCRoomDelegate-rtcroom-onuserunpublishstream-type-reason) 回调后，你需要停止渲染远端视频。
...
以下代码在 `ViewController.swift` 的析构函数中执行。调用 [leaveRoom](https://www.volcengine.com/docs/6348/70086#ByteRTCRoom-leaveroom) 离开房间，[destroy](https://www.volcengine.com/docs/6348/70086#ByteRTCRoom-destroy) 销毁房间；调用 [destroyRTCVideo](https://www.volcengine.com/docs/6348/70086#ByteRTCVideo-destroyrtcvideo) 销毁 RTC 引擎。
