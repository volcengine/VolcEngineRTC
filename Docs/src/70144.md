...
|---|---|---|---|---|
|获取共享对象 |[getScreenCaptureSourceList](70095#IRTCVideo-getscreencapturesourcelist) |[getScreenCaptureSourceList](70092#ByteRTCVideo-getscreencapturesourcelist) |[getScreenCaptureSourceList](85516#IRTCVideo-getscreencapturesourcelist) | X | 
|获取共享对象缩略图 |[getThumbnail](70095#IRTCVideo-getthumbnail) |[getThumbnail:sourceId:maxWidth:maxHeight:](70092#ByteRTCVideo-getthumbnail-sourceid-maxwidth-maxheight) | [getThumbnail](70095#IRTCVideo-getthumbnail) | X |
|获取共享窗体程序图标 |[getWindowAppIcon](70095#IRTCVideo-getwindowappicon) |[getWindowAppIcon](70092#ByteRTCVideo-getwindowappicon-width-height) | [getWindowAppIcon](85516#IRTCVideo-getwindowappicon) | X |
|设置屏幕流编码属性 |[setScreenVideoEncoderConfig](70095#IRTCVideo-setscreenvideoencoderconfig) |[setScreenVideoEncoderConfig:](70092#ByteRTCVideo-setscreenvideoencoderconfig) |[setScreenVideoEncoderConfig](85516#IRTCVideo-setscreenvideoencoderconfig) | 同左侧 |
|开始屏幕采集 |[startScreenVideoCapture](70095#IRTCVideo-startscreenvideocapture) |[startScreenVideoCapture:captureParameters:](70092#ByteRTCVideo-startscreenvideocapture-captureparameters) | [startScreenVideoCapture](85516#IRTCVideo-startscreenvideocapture) | 同左侧 |
|开始设备音频采集 |[startScreenAudioCapture](70095#IRTCVideo-startscreenaudiocapture) |[startScreenAudioCapture:](70092#ByteRTCVideo-startscreenaudiocapture) | X | X |
|更新采集区域 |[updateScreenCaptureRegion](70095#IRTCVideo-updatescreencaptureregion) |[updateScreenCaptureRegion:](70092#ByteRTCVideo-updatescreencaptureregion) | [updateScreenCaptureRegion](85516#IRTCVideo-updatescreencaptureregion) | 同左侧 |
|更新高亮控制项 |[updateScreenCaptureHighlightConfig](70095#IRTCVideo-updatescreencapturehighlightconfig) |[updateScreenCaptureHighlightConfig:](70092#ByteRTCVideo-updatescreencapturehighlightconfig) |[updateScreenCaptureHighlightConfig](85516#IRTCVideo-updatescreencapturehighlightconfig) | X |
|更新过滤选项 |[updateScreenCaptureFilterConfig](70095#IRTCVideo-updatescreencapturefilterconfig) |[updateScreenCaptureFilterConfig:](70092#ByteRTCVideo-updatescreencapturefilterconfig) | X | X |
|更新鼠标捕获选项 |[updateScreenCaptureMouseCursor](70095#IRTCVideo-updatescreencapturemousecursor) |[updateScreenCaptureMouseCursor:](70092#ByteRTCVideo-updatescreencapturemousecursor) |[updateScreenCaptureMouseCursor](85516#IRTCVideo-updatescreencapturemousecursor) | 同左侧 |
|发布屏幕流 |[publishScreen](70095#IRTCRoom-publishscreen) |[publishScreen:](70092#ByteRTCRoom-publishscreen) |[publishScreen](85516#IRTCRoom-publishscreen) | 同左侧 |[publishScreen](85532#publishscreen) |
|停止发布屏幕流 |[unpublishScreen](70095#IRTCRoom-unpublishscreen) |[unpublishScreen:](70092#ByteRTCRoom-unpublishscreen) |[unpublishScreen](85516#IRTCRoom-unpublishscreen) | 同左侧 |[unpublishScreen](85532#unpublishscreen) |
|切换外部屏幕采集 |[setScreenAudioSourceType](70095#IRTCVideo-setscreenaudiosourcetype) |[setScreenAudioSourceType:](70092#ByteRTCVideo-setscreenaudiosourcetype) | X | X | Not supported. |
|推送自定义设备音频采集数据 |[pushScreenAudioFrame](70095#IRTCVideo-pushscreenaudioframe) |[pushScreenAudioFrame:](70092#ByteRTCVideo-pushscreenaudioframe) | X | X | Not supported. |
|推送自定义屏幕采集数据 |[pushScreenVideoFrame](70095#IRTCVideo-pushscreenvideoframe) |[pushScreenVideoFrame:time:rotation:](70092#ByteRTCVideo-pushscreenvideoframe-time-rotation) |[pushScreenVideoFrame](70095#IRTCVideo-pushscreenvideoframe) | 同左侧 | Not supported. |
...
- 3.43.1 版本中
  ...
  |--|--|--|--|
  | API | [`publishScreen:`](70092#ByteRTCRoom-publishscreen) 和 [`unpublishScreen:`](70092#ByteRTCRoom-unpublishscreen) 的类名由 `ByteRTCEngineKit` 变更为 `RTCRoom`。其他方法的类名变更为 `RTCVideo`。 |  [`publishScreen`](70095#IRTCRoom-publishscreen) 和 [`unpublishScreen`](70095#IRTCRoom-unpublishscreen) 的类名由 `IRtcEngine` 变更为 `IRTCRoom`。其他方法的类名由 `IRtcEngine` 变更为 `IRTCVideo`。| [`publishScreen`](85516#IRTCRoom-publishscreen) 和 [`unpublishScreen`](85516#IRTCRoom-unpublishscreen) 的类名由 `IRtcEngine` 变更为 `IRTCRoom`。其他方法的类名由 `IRtcEngine` 变更为 `IRTCVideo`。 |
