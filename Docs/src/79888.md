...
| :-- | :-- | :-- | :-- | :-- | :-- |
| 视频处理器接口 | [`IVideoProcessor`](Android-api#ivideoprocessor) | [`ByteRTCVideoProcessorDelegate`](iOS-callback#bytertcvideoprocessordelegate) | [`ByteRTCVideoProcessorDelegate`](macOS-callback#bytertcvideoprocessordelegate) | [`IVideoProcessor`](Windows-api#ivideoprocessor) | [`IVideoProcessor`](Linux-api#ivideoprocessor) |
| 注册视频处理器 | [`registerLocalVideoProcessor`](Android-api#registerlocalvideoprocessor) | [`registerLocalVideoProcessor:withConfig:`](iOS-api#registerlocalvideoprocessor-withconfig) | [`registerLocalVideoProcessor:withConfig:`](macOS-api#registerlocalvideoprocessor-withconfig) | [`RegisterLocalVideoProcessor`](Windows-api#registerlocalvideoprocessor) | [`RegisterLocalVideoProcessor`](Linux-api#registerlocalvideoprocessor) |
