...
创建引擎放在 `mainwindow.cpp` MainWindow::MainWindow 构造函数中。[bytertc::createRTCVideo](https://www.volcengine.com/docs/6348/70095#creatertcvideo) 用于创建 RTC 引擎，所有 RTC 相关的 API 调用都要在创建引擎之后。
