...
## 请求说明
- 请求方式：**GET**
- 请求地址：**https://rtc.volcengineapi.com?Action=GetSegmentTask&Version=2023-11-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=GetSegmentTask&serviceCode=rtc&version=2023-11-01&groupName=音频切片" />
