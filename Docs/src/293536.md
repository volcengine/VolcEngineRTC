...
- **注意**
  ...
  可设置 [IMOption.disableInitPull](293539.md#imoption-disableinitpull) 关闭历史信息同步。
...
- **返回值**
  ...
  类型: <code>Promise<[InitResult](293539.md#initresult)\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); content: string; clientId?: string | undefined; ext?: { [k: string]: string; } | undefined; mentionedUsers?: string[] | undefined; insert?: boolean | undefined; referenceMessage?: [Message](293539.md#message) | undefined; referenceHint?: string | undefined; }</code>
...
- **返回值**
  ...
  创建的消息，参看 [Message](293539.md#message)。
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ message: [Message](293539.md#message); priority?: im_proto.[MessagePriority](293539.md#messagepriority) | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ message: [Message](293539.md#message); localOnly?: boolean | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ message: [Message](293539.md#message); }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); serverMessageId: string; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<[Message](293539.md#message)[]\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ message: [Message](293539.md#message); modifyContent: Array<{ key: string; operation?: im_proto.[OPERATION_TYPE](293539.md#operation_type); value?: string; idempotentId?: string;}\>; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<[ModifyMessagePropertyResult](293539.md#modifymessagepropertyresult)\></code>
...
- **返回值**
  ...
  参看 [Conversation](293539.md#conversation)。
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversationId: string; shortId: string; type: im_proto.[ConversationType](293539.md#conversationtype); }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ filter?: ((c: [Conversation](293539.md#conversation)) =\> boolean) | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); cursor?: string | Long | [Message](293539.md#message) | undefined; direction?: number | undefined; limit?: number | undefined; limitIndex?: Long | undefined; }</code>
...
- **返回值**
  ...
  会话内的消息列表，其中消息结构参看 [Message](293539.md#message)。
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ type: im_proto.[ConversationType](293539.md#conversationtype); inboxType?: number | undefined; cursor?: string | Long | undefined; limit?: number | undefined; sortType?: im_proto.[SortType](293539.md#sorttype) | undefined; includeRole?: number | undefined; excludeRole?: number | undefined; withCold?: boolean | undefined; }</code>
    ...
    - **成员**
      ...
      | includeRole | `number | undefined` | 查询群聊类型时，包含的群聊角色，参看 [GroupRole](293539.md#grouprole)。 |
      | excludeRole | `number | undefined` | 查询群聊类型时，排除的群聊角色，参看 [GroupRole](293539.md#grouprole)。 |
      | withCold | `boolean | undefined` | 保留参数，无意义。 |


- **返回值**

  用户会话列表，其中会话结构参看 [Conversation](293539.md#conversation)。
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ participants: string[] | string; bizExt?: { [k: string]: string; } | undefined; inboxType?: number | undefined; type?: im_proto.[ConversationType](293539.md#conversationtype) | undefined; persistent?: boolean | undefined; idempotentId?: string | undefined; name?: string | undefined; avatarUrl?: string | undefined; desc?: string | undefined; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<[CreateConversationResult](293539.md#createconversationresult)\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); localOnly?: boolean | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); stickOnTop?: boolean | undefined; mute?: boolean | undefined; favorite?: boolean | undefined; pushStatus?: [PushStatus](293539.md#pushstatus) | undefined; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<[SetConversationSettingInfoResult](293539.md#setconversationsettinginforesult)\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); config: [ConversationSettingWeakMuteInfo](293539.md#conversationsettingweakmuteinfo); }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); ext?: { [k: string]: string; } | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); name?: string | undefined; desc?: string | undefined; icon?: string | undefined; notice?: string | undefined; isNameSet?: boolean | undefined; isDescSet?: boolean | undefined; isIconSet?: boolean | undefined; isNoticeSet?: boolean | undefined; ext?: { [k: string]: string; } | undefined; bizExt?: { [k: string]: string; } | undefined; }</code>
...
- **返回值**
  ...
  获取到的会话，其中会话结构参看 [Conversation](293539.md#conversation)。
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); readIndex?: string | Long | [Message](293539.md#message) | undefined; convUnreadCount?: number | undefined; totalUnreadCount?: number | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); participant: [Participant](293539.md#participant) | [Participant](293539.md#participant)[] | string[] | string; bizExt?: { [k: string]: string; } | undefined; isDropReconnect?: boolean | undefined; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<[AddParticipantResult](293539.md#addparticipantresult)\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); participant: [Participant](293539.md#participant) | [Participant](293539.md#participant)[] | string | string[]; bizExt?: { [k: string]: string; } | undefined; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<[RemoveParticipantResult](293539.md#removeparticipantresult)\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); userId: string; role?: number | undefined; alias?: string | undefined; bizExt?: { [k: string]: string; } | undefined; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<[UpdateParticipantResult](293539.md#updateparticipantresult)\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); limit?: number | undefined; cursor?: Long | undefined; }</code>
...
- **返回值**
  ...
  群成员列表，其中成员结构参看 [Participant](293539.md#participant)。
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); block: boolean; normalOnly?: boolean | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); block: boolean; blockDuration: { [k: string]: string | number | Long; }; bizExt?: { [k: string]: string; } | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); fileInfo: [FileInfo](293539.md#fileinfo); clientId?: string | undefined; ext?: { [k: string]: string; } | undefined; mentionedUsers?: string[] | undefined; insert?: boolean | undefined; referenceMessage?: [Message](293539.md#message) | undefined; referenceHint?: string | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ message: [Message](293539.md#message); ignoreCache?: boolean | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ message: [Message](293539.md#message); delta?: number | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); bizExt?: { [key: string]: string; } | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); cursor?: Long | undefined; limit?: number | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); participantIds: string[]; }</code>
...
- **返回值**
  ...
  类型: <code>Promise<Record<string, im_proto.[IMemberInfo](293539.md#imemberinfo) | undefined\>\></code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ conversation: [Conversation](293539.md#conversation); limit?: number | undefined; fromIndex?: Long | undefined; direction?: im_proto.[MessageDirection](293539.md#messagedirection) | undefined; }</code>
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ cursor?: Long | undefined; limit?: number | undefined; direction?: im_proto.[MessageDirection](293539.md#messagedirection) | undefined; }</code>
...
- **返回值**
  ...
  好友申请列表与分页信息，其中好友申请列表参看 [FriendApply](293539.md#friendapply)。
...
- **类型**
  ...
  ```ts
  (params: { cursor?: Long; limit?: number;}) => Promise<{ list: Friend[]; totalCount: Long | null | undefined; cursor: Long | null | undefined; hasMore: boolean | null | undefined; }>
  ```
...
- **返回值**
  ...
  好友列表与分页信息，其中好友信息参看 [Friend](293539.md#friend)。
...
- **参数**
  ...
  - **params**
    ...
    类型: <code>{ userId: string; attitude: [ReplyFriendAttitude](293539.md#replyfriendattitude); ext?: { [key: string]: string; } | undefined; }</code>
...
- **参数**
  ...
  - **event**
    ...
    事件类型，参看 [IMEvent](293537.md#imevent)。

  - **func**

    类型: <code>[EventHandler](293539#eventhandler)<[IMEventTypeMap](293537.md#imeventtypemap)[T]\></code>

    事件回调函数。

- **返回值**

  类型: <code>Subscription<[IMEventTypeMap](293537.md#imeventtypemap)[T]\></code>
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[IMEvent](293537.md#imevent)</code>

    事件类型

  - **handler**

    类型: <code>[Subscription](293539.md#subscription)<any\></code>
