...
| 设置默认音频播放路由 | [setDefaultAudioRoute:](70086#setdefaultaudioroute)
| 设置视频朝向 |[setVideoOrientation:](70086#setvideoorientation)
...
| 获取混音管理接口 | [getAudioMixingManager](70086#getaudiomixingmanager)|
| 开启 PCM 音频数据混音 | [startAudioMixing](70086#enableaudiomixingframe-type)|
| 关闭PCM 混音 | [disableAudioMixingFrame:](70086#disableaudiomixingframe) |
| 创建 RTCRoom 实例 |[createRTCRoom:](70086#creatertcroom) |
| 设置房间事件处理器|[setRTCRoomDelegate:](70086#setrtcroomdelegate) |
| 加入 RTC 房间 | [joinRoom:userInfo:roomConfig:](70086#joinroom-userinfo-roomconfig) |
| 切换前后置摄像头 |[switchCamera](70086#switchcamera)|
...
| 销毁引擎实例对象 |[destroyRTCVideo](70086#destroyrtcvideo) |

### 回调

|  功能点 | 回调  |
| --- | --- |
| 用户开启音频采集 | [rtcEngine:onUserStartAudioCapture:uid:](70087#rtcengine-onuserstartaudiocapture-uid)   |  
| 用户停止音频采集 | [rtcEngine:onUserStopAudioCapture:uid:](70087#rtcengine-onuserstopaudiocapture-uid) | 
| 用户开启视频采集 | [rtcEngine:onUserStartVideoCapture:uid:](70087#rtcengine-onuserstartvideocapture-uid)   | 
| 用户停止视频采集 | [rtcEngine:onUserStopVideoCapture:uid:](70087#rtcengine-onuserstopvideocapture-uid)  | 
| 用户停止视频采集 | [rtcEngine:onUserStopVideoCapture:uid:](70087#rtcengine-onuserstopvideocapture-uid)  | 
| 音频混音文件播放状态改变 |[rtcEngine:onAudioMixingStateChanged:state:error:](70087#rtcengine-onaudiomixingstatechanged-state-error)|
| 远端首帧解码    |  [rtcEngine:onFirstRemoteVideoFrameDecoded:withFrameInfo:](70087#rtcengine-onfirstremotevideoframedecoded-withframeinfo)  |
| 房间 token 即将失效回调|  [onTokenWillExpire:](70087#ontokenwillexpire)   |
| 本地进房成功回调 | [rtcRoom:onRoomStateChanged:withUid:state:extraInfo:](70087#rtcroom-onroomstatechanged-withuid-state-extrainfo) |
