...
| kErrorCodeJoinRoomServerLicenseExpired | -1017 | 加入房间错误。 <br><br/>服务端license过期，拒绝进房。 |
| kErrorCodeJoinRoomExceedsTheUpperLimit | -1018 | 加入房间错误。 <br><br/>超过服务端license许可的并发量上限，拒绝进房。 |
