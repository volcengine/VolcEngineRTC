...
| 设置默认音频播放路由 | [setDefaultAudioRoute](Android-api#setdefaultaudioroute)
| 设置视频朝向 |[setVideoOrientation](Android-api#setvideoorientation)
...
| 获取混音管理接口 | [getAudioMixingManager](Android-api#getaudiomixingmanager)|
| 开启 PCM 音频数据混音 | [startAudioMixing](Android-api#startaudiomixing)|
| 关闭PCM 混音 | [disableAudioMixingFrame](Android-api#disableaudiomixingframe) |
| 创建 RTCRoom 实例 |[createRTCRoom](Android-api#creatertcroom) |
| 设置房间事件处理器|[setRTCRoomEventHandler](Android-api#setrtcroomeventhandler) |
| 加入 RTC 房间 | [joinRoom](Android-api#joinroom) |
| 切换前后置摄像头 |[switchCamera](Android-api#switchcamera)|
...
| 销毁引擎实例对象 |[destroyRTCVideo](Android-api#destroyrtcvideo) |

### 回调

|  功能点 | 回调  |
| --- | --- |
| 用户开启音频采集 | [onUserStartAudioCapture](Android-callback#onuserstartaudiocapture)   |  
| 用户停止音频采集 |  [onUserStopAudioCapture](Android-callback#onuserstopaudiocapture) | 
| 用户开启视频采集 |  [onUserStartVideoCapture](Android-callback#onuserstartvideocapture)   | 
| 用户停止视频采集 |  [onUserStopVideoCapture](Android-callback#onuserstopvideocapture)  | 
| 用户停止视频采集 |  [onUserStopVideoCapture](Android-callback#onuserstopvideocapture)  | 
| 音频混音文件播放状态改变 |[onAudioMixingStateChanged](Android-callback#onaudiomixingstatechanged)|
| 远端首帧解码|    [onFirstRemoteVideoFrameDecoded](Android-callback#onfirstremotevideoframedecoded)  |
| 房间 token 即将失效回调|  [onTokenWillExpire](Android-callback#ontokenwillexpire)   |
