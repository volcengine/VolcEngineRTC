...
| 设置默认音频播放路由 | [setDefaultAudioRoute](70080#setdefaultaudioroute)
| 设置视频朝向 |[setVideoOrientation](70080#setvideoorientation)
...
| 获取混音管理接口 | [getAudioMixingManager](70080#getaudiomixingmanager)|
| 开启 PCM 音频数据混音 | [startAudioMixing](70080#startaudiomixing)|
| 关闭PCM 混音 | [disableAudioMixingFrame](70080#disableaudiomixingframe) |
| 创建 RTCRoom 实例 |[createRTCRoom](70080#creatertcroom) |
| 设置房间事件处理器|[setRTCRoomEventHandler](70080#setrtcroomeventhandler) |
| 加入 RTC 房间 | [joinRoom](70080#joinroom) |
| 切换前后置摄像头 |[switchCamera](70080#switchcamera)|
...
| 销毁引擎实例对象 |[destroyRTCVideo](70080#destroyrtcvideo) |

### 回调

|  功能点 | 回调  |
| --- | --- |
| 用户开启音频采集 | [onUserStartAudioCapture](70081#onuserstartaudiocapture)   |  
| 用户停止音频采集 |  [onUserStopAudioCapture](70081#onuserstopaudiocapture) | 
| 用户开启视频采集 |  [onUserStartVideoCapture](70081#onuserstartvideocapture)   | 
| 用户停止视频采集 |  [onUserStopVideoCapture](70081#onuserstopvideocapture)  | 
| 用户停止视频采集 |  [onUserStopVideoCapture](70081#onuserstopvideocapture)  | 
| 音频混音文件播放状态改变 |[onAudioMixingStateChanged](70081#onaudiomixingstatechanged)|
| 远端首帧解码|    [onFirstRemoteVideoFrameDecoded](70081#onfirstremotevideoframedecoded)  |
| 房间 token 即将失效回调|  [onTokenWillExpire](70081#ontokenwillexpire)   |
