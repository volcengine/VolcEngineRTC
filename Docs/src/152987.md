...
![alt](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_9728884d516036faa136428d3eb1b38f.jpg =60%x)#{style="margin: auto"}#
...
| 开启内部视频采集 | [startVideoCapture](70086#startvideocapture) |
| 创建 RTC 房间 | [createRTCRoom:](70086#creatertcroom) |
...
| 开始播放音频文件 | [open:config:](70086#ByteRTCMediaPlayer-open-config)  |
| 设置混音时音频文件播放进度回调的间隔 | [setProgressInterval:](70086#ByteRTCMediaPlayer-setprogressinterval) |
| 发送音频流同步信息 | [sendStreamSyncInfo:config:](70086#sendstreamsyncinfo-config) |
| 订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [subscribeStream:mediaStreamType:](70086#subscribestream-mediastreamtype) |
| 取消订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [unSubscribeStream:mediaStreamType:](70086#unsubscribestream-mediastreamtype) |
| 启动 PCM 音频数据混音 | [openWithCustomSource:config:](70086#openwithcustomsource-config) |
| 注册音频数据回调观察者。 | [registerAudioFrameObserver:](70086#registeraudioframeobserver) |
| 开启音频回调 |[enableAudioFrameCallback:format:](70086#enableaudioframecallback-format) |
...
| 设置当前音频文件的声道模式 | [setAudioDualMonoMode:](70086#ByteRTCMediaPlayer-setaudiodualmonomode)|
| 暂停混音播放 | [pause](70086#ByteRTCMediaPlayer-pause) |
| 恢复混音播放 | [resume](70086#ByteRTCMediaPlayer-resume)|
| 打开/关闭耳返功能 |  [setEarMonitorMode:](70086#setearmonitormode) |
| 设置耳返音量 |  [setEarMonitorVolume:](70086#setearmonitorvolume) |
| 调节音频采集音量 |  [setCaptureVolume:volume:](70086#setcapturevolume-volume) |
| 设置混响特效类型 |  [setVoiceReverbType:](70086#setvoicereverbtype) |
| 离开 RTC 房间 | [leaveRoom](70086#leaveroom)  |
| 销毁 RTC 房间引擎 | [destroy](70086#destroy) |
| 关闭内部音频采集 |  [stopAudioCapture](70086#stopaudiocapture) |
| 销毁 RTCVideo 对象 |  [destroyRTCVideo](70086#destroyrtcvideo) |

### 回调
| 功能点 | 回调| 
| :-: | :-: | 
| 本地用户加入 RTC 回调 | [rtcRoom:onRoomStateChanged:uid:state:extraInfo](70087#rtcroom-onroomstatechanged-withuid-state-extrainfo) |
| 音频流同步信息回调 | [rtcEngine:onStreamSyncInfoReceived:streamType:data:](70087#rtcengine-onstreamsyncinforeceived-streamtype-data) |
| 返回远端单个用户的音频数据 | [onRemoteUserAudioFrame:audioFrame:](70087#onremoteuseraudioframe-audioframe) |
| 本地音频的相关信息回调|[rtcEngine:onLocalAudioPropertiesReport:](70087#rtcengine-onlocalaudiopropertiesreport) |
| 订阅的远端用户的音频信息回调 | [rtcEngine:onRemoteAudioPropertiesReport:totalRemoteVolume:](70087#rtcengine-onremoteaudiopropertiesreport-totalremotevolume) |
| 音频混音文件播放状态改变时回调 | [onMediaPlayerStateChanged:state:error: ](70087#onmediaplayerstatechanged-state-error)|
| 音频播放路由变化回调 |[rtcEngine:onAudioRouteChanged:](70087#rtcengine-onaudioroutechanged) |
| 混音音频文件播放进度回调 | [onMediaPlayerPlayingProgress:progress:](70087#onmediaplayerplayingprogress-progress) |
| 远端视频流的状态改变回调 | [rtcEngine:onRemoteVideoStateChanged:withVideoState:withVideoStateReason:](70087#rtcengine-onremotevideostatechanged-withvideostate-withvideostatereason) |
