...
| 开启内部视频采集 | [startVideoCapture](iOS-api.md#startvideocapture) |
| 创建 RTC 房间 | [createRTCRoom:](iOS-api.md#creatertcroom) |
...
| 开始播放音频文件 | [startAudioMixing:filePath:config:](iOS-api.md#startaudiomixing-filepath-config)  |
...
| 订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [subscribeStream:mediaStreamType:](iOS-api.md#subscribestream-mediastreamtype) |
| 取消订阅房间内指定的通过摄像头/麦克风采集的媒体流 | [unSubscribeStream:mediaStreamType:](iOS-api.md#unsubscribestream-mediastreamtype) |
| 启动 PCM 音频数据混音 | [enableAudioMixingFrame:type:](iOS-api.md#enableaudiomixingframe-type) |
| 注册音频数据回调观察者。 | [registerAudioFrameObserver:](iOS-api.md#registeraudioframeobserver) |
| 开启音频回调 |[enableAudioFrameCallback:format:](iOS-api.md#enableaudioframecallback-format) |
| 推送 PCM 音频帧数据用于混音 |[pushAudioMixingFrame:audioFrame:](iOS-api.md#pushaudiomixingframe-audioframe) |
| 关闭 PCM 混音 |  [disableAudioMixingFrame:](iOS-api.md#disableaudiomixingframe) |
...
| 暂停播放音频文件 | [pauseAudioMixing:](iOS-api.md#pauseaudiomixing)  |
| 恢复播放音频文件 |  [resumeAudioMixing:](iOS-api.md#resumeaudiomixing)|
| 打开/关闭耳返功能 |  [setEarMonitorMode:](iOS-api.md#setearmonitormode) |
| 设置耳返音量 |  [setEarMonitorVolume:](iOS-api.md#setearmonitorvolume) |
...
| 销毁 RTC 房间引擎 | [destroy](iOS-api.md#destroy) |
...
| 音频流同步信息回调 | [rtcEngine:onStreamSyncInfoReceived:streamType:data:](iOS-callback.md#rtcengine-onstreamsyncinforeceived-streamtype-data) |
| 返回远端单个用户的音频数据 | [onRemoteUserAudioFrame:audioFrame:](iOS-callback.md#onremoteuseraudioframe-audioframe) |
...
| 音频混音文件播放状态改变时回调 | [rtcEngine:onAudioMixingStateChanged:state:error: ](iOS-callback.md#rtcengine-onaudiomixingstatechanged-state-error)|
| 音频播放路由变化回调 |[rtcEngine:onAudioRouteChanged:](iOS-callback.md#rtcengine-onaudioroutechanged) |
| 混音音频文件播放进度回调 | [rtcEngine:onAudioMixingPlayingProgress:progress:](iOS-callback.md#rtcengine-onaudiomixingplayingprogress-progress)|
| 远端视频流的状态改变回调 | [rtcEngine:onRemoteVideoStateChanged:withVideoState:withVideoStateReason:](iOS-callback.md#rtcengine-onremotevideostatechanged-withvideostate-withvideostatereason) |