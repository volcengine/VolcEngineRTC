...
音频场景类型
选择音频场景后，SDK 会根据操作系统和开麦、闭麦状态，应用通话音量或媒体音量。参看 [Android](https://www.volcengine.com/docs/6348/70083#audioscenariotype) / [iOS](https://www.volcengine.com/docs/6348/70088#bytertcaudioscenariotype) 的 API 文档了解对应操作系统下的音量类型配置情况。参看[通话音量与媒体音量](https://www.volcengine.com/docs/6348/651068)了解更多相关信息。
