...
如果转推直播任务状态发生变化，你在[控制台](https://console.volcengine.com/rtc/cloudRTC?tab=callback)上设置的回调地址会接收[任务状态相关回调](https://www.volcengine.com/docs/6348/75125#transcodestarted)。
## 使用说明
### 接口行为
...
<APILink link="https://api.volcengine.com/api-explorer/debug?action=StartPushMixedStreamToCDN&serviceCode=rtc&version=2023-11-01&groupName=转推直播" />
