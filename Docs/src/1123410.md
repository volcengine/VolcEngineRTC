...
| [onCreateWhiteBoard](#iwhiteboardroomevents-oncreatewhiteboard) | 白板创建回调。调用 [createWhiteBoard](1123409#iwhiteboardroom-createwhiteboard) 成功创建白板后，房间内所有用户收到本回调。 |
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>{ errorCode: [ErrorCode](1123412#errorcode); message?: string | undefined; }</code>
...
白板创建回调。调用 [createWhiteBoard](1123409#iwhiteboardroom-createwhiteboard) 成功创建白板后，房间内所有用户收到本回调。
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[CreateWhiteBoardResult](1123412#createwhiteboardresult)</code>
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[SwitchBoardResult](1123412#switchboardresult)</code>
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[RemoveWhiteBoardResult](1123412#removewhiteboardresult)</code>
...
- **注意**
  ...
  调用 [createPages](1123409#iwhiteboard-createpages) 后，房间中所有用户将收到本回调。

- **参数**

  - **event**

    类型: <code>[CreatePageProgressResult](1123412#createpageprogressresult)</code>
...
- **注意**
  ...
  成功调用 [flipPage](1123409#iwhiteboard-flippage)、[flipNextPage](1123409#iwhiteboard-flipnextpage)或 [flipPrevPage](1123409#iwhiteboard-flipprevpage) 后，在本端和远端触发本回调。

- **参数**

  - **event**

    类型: <code>[FlipPageResult](1123412#flippageresult)</code>
...
- **注意**
  ...
  成功调用 [createPages](1123409#iwhiteboard-createpages) 后，在本端和远端触发本回调。
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>{ status: [ImageLoadStatus](1123412#imageloadstatus); pageId: string; boardId: number; imageUrl: string; }</code>
