...
> 	- Android: [setVideoOrientation](70080#RTCVideo-setvideoorientation)
> 	- iOS: [setVideoOrientation:](70086#setvideoorientation)
## 使用说明
### 接口行为
...
<APILink link="https://api.volcengine.com/api-explorer/debug?action=StartPushSingleStreamToCDN&serviceCode=rtc&version=2020-12-01&groupName=转推直播" />
