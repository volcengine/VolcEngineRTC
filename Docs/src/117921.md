...
| 关闭麦克风采集 | [stopVideoCapture](70086#stopvideocapture)|
| 设置音频路由模式 | [setDefaultAudioRoute:](70086#setdefaultaudioroute) |
| 开启发言者音量监听 | [enableAudioPropertiesReport:](70086#enableaudiopropertiesreport)
...
| 混音管理接口创建 | [getMediaPlayer:](70086#ByteRTCVideo-getmediaplayer) |
...
| 设置混音音量 | [setVolume:volume:](70086#ByteRTCAudioEffectPlayer-setvolume-volume) |
| 设置麦克风采集音量 | [setCaptureVolume:volume:](70086#setcapturevolume-volume) |
