...
| 关闭麦克风采集 | [stopVideoCapture](iOS-api#stopvideocapture)|
| 设置音频路由模式 | [setDefaultAudioRoute:](iOS-api#setdefaultaudioroute) |
| 开启发言者音量监听 | [enableAudioPropertiesReport:](iOS-api#enableaudiopropertiesreport)
...
| 混音管理接口创建 | [getMediaPlayer:](iOS-api#ByteRTCVideo-getmediaplayer) |
...
| 设置混音音量 | [setVolume:volume:](iOS-api#ByteRTCAudioEffectPlayer-setvolume-volume) |
| 设置麦克风采集音量 | [setCaptureVolume:volume:](iOS-api#setcapturevolume-volume) |
