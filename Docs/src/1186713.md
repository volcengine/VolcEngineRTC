...
在实时音视频场景中，你可以通过调用此接口获取账号下已创建应用的详细信息。
## 使用说明
### 接口行为
...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=ListApps&Version=2023-11-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=ListApps&serviceCode=rtc&version=2023-11-01&groupName=" />
...
const data = [
  {
    ...
    "children": [
      ...
      },
      {
        "name": "Status",
        "key": "0-1-0-3",
        "title": "服务状态。取值及含义如下：<br>\n<code>0</code>: 创建中——指 AppID 在初始化<br>\n<code>1</code>: 运行中——指当前 AppID 为正常服务状态<br>\n<code>6</code>: 欠费关停<br>\n<code>98</code>: 已停用——指调用服务端停用接口，当前 AppID 被设置为不可用状态",
        "example": "<code>1</code>",
        "type": "Integer"
      },
      {
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=ListApps&Version=2023-11-01
{
    "AppId": "661e****543cf",
    "Reverse": 1,
    "Offset": "50",
