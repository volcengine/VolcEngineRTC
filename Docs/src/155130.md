...
## 请求说明
- 请求方式：**POST**
- 请求地址：**https://rtc.volcengineapi.com?Action=UpdateSegment&Version=2022-06-01**
## 调试

<APILink link="https://api.volcengine.com/api-explorer/debug?action=UpdateSegment&serviceCode=rtc&version=2022-06-01&groupName=音频切片" />
...
const data = [
  ...
  },
  {
    "name": "Duration",
    "key": "0-6",
    "title": "音频切片的时长。单位为秒。范围为 <code>[1, 600]</code>，默认值为 <code>20秒</code>。值不合法时，自动调整为默认值。 更新该字段后，计时器会重新启动，当前切片立即停止，生成一个新切片。",
...
## 请求示例
```json
POST https://rtc.volcengineapi.com?Action=UpdateSegment&Version=2022-06-01
{
    "AppId": "Your_AppId",
