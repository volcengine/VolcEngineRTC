...
func (p *VCControlHandleMeetingEventResult) SetSuccess(x interface{}) {
	p.Success = x.(*TEventResp)
}
...
func (p *VCControlHandleRecordCallbackResult) SetSuccess(x interface{}) {
	p.Success = x.(*THTTPResp)
}
