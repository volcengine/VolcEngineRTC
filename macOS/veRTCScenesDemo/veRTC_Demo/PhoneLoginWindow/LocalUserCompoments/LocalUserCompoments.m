...
#import "LocalUserCompoments.h"

@implementation LocalUserCompoments

#pragma mark - Publish Action

+ (BaseUserModel *)userModel {
    NSData *data = [[NSUserDefaults standardUserDefaults] objectForKey:@"userinfoDic"];
