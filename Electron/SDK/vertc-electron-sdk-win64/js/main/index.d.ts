...
import { SubscribeConfig, RenderOptions, ByteStream, AudioVolumeInfo, RtcRoomStats, VideoFrame, ErrorCode, WarningCode, SubscribeState, ConnectionState, UserOfflineReasonType, MediaDeviceType, MediaDeviceState, Rectangle, VideoSolution, ScreenCaptureSourceInfo, ScreenCaptureSourceType, ThumbnailInfo, StreamRemoveReason, MessageSendResultCode, AudioMixingState, AudioMixingError, NetworkType, PerformanceAlarmMode, PerformanceAlarmReason, MediaDeviceError, JoinRoomType, LocalStreamStats, RemoteStreamStats, MuteState, StreamIndex, RemoteStreamKey, RemoteStreamSwitch, VideoFrameInfo, LocalAudioStreamState, LocalAudioStreamError, RemoteAudioState, RemoteAudioStateChangeReason, LocalVideoStreamState, LocalVideoStreamError, RemoteVideoState, RemoteVideoStateChangeReason, RtcUser, FirstFrameSendState, FirstFramePlayState, RemoteUserPriority, RTCRoomConfig, SubscribeVideoConfig, MirrorMode, PauseResumeControlMediaType, AudioMixingConfig, MouseCursorCaptureState, ScreenCaptureParameters, HighlightConfig, SysStats, StreamMixingEvent, StreamMixingType, RecordingConfig, RTCASRConfig, RecordingInfo, RecordingProgress, TranscoderParam } from "../types";
 ...
 * @detail 85532
 */
declare class veRTCEngine extends EventEmitter {
    private instance;
    private remoteUsers;
     ...
     * @region 引擎管理
     */
    init(appId: string, documentPath: string, params: string): number;
    /** {zh}
     * @brief 销毁引擎
     * @return
     * + 0：成功
     ...
     */
    joinRoom(token: string, room_id: string, uid: string, info: string, roomConfig: RTCRoomConfig): number;
    /** {zh}
     * @region 房间管理
     * @brief 设置用户可见性。默认为可见。
     ...
     */
    muteLocalAudio(muteState: number): number;
    /** {zh}
     * @region 多房间
     ...
     */
    setAudioVolumeIndicationInterval(interval: number): number;
    /** {zh}
     * @region 音频管理
     ...
     * + !0：失败<br>
     */
    setRemoteAudioPlaybackVolume(strUserId: string, volume: number): number;
    /** {zh}
     * @region 媒体流管理
     * @brief 恢复接收来自远端的媒体流
     ...
     */
    resumeAllSubscribedStream(type: PauseResumeControlMediaType): number;
    /** {zh}
    * @region 视频管理
    ...
    */
     ...
     * + 屏幕流只取视频参数数组的第一组数据。
     */
    setVideoEncoderConfig(index: number, solutions: VideoSolution[]): number;
    /** {zh}
     * @region 视频管理
     ...
     */
    muteLocalVideo(muteState: number): number;
    /** {zh}
     * @type api
     * @region 视频管理
     ...
     */
    switchCamera(camera_id: number): number;
    /** {zh}
     * @region 视频管理
     ...
     * + !0：失败<br>
     */
    setLocalVideoMirrorMode(nMode: MirrorMode): number;
    /** {zh}
     * @region 媒体流处理
     * @brief 暂停接收来自远端的媒体流。
     * @param type 媒体流类型，指定需要暂停接收音频还是视频流
     ...
     */
    pauseAllSubscribedStream(type: PauseResumeControlMediaType): number;
    /** {zh}
     * @region 屏幕共享
     ...
     */
    startScreenVideoCapture(info: ScreenCaptureSourceInfo, params: ScreenCaptureParameters): number;
    /** {zh}
     * @region 屏幕共享
     * @brief 更新屏幕共享区域。
     ...
     */
    UpdateScreenCaptureMouseCursor(state: MouseCursorCaptureState): number;
    /** {zh}
     * @region 屏幕共享
     ...
     */
    updateScreenCaptureFilterConfig(screenFilterConfig: number[]): number;
    /** {zh}
     * @region 屏幕共享
     * @brief 停止屏幕视频流采集。
     * @return
     ...
     * @return 屏幕共享对象
     */
    getThumbnail(type: ScreenCaptureSourceType, sourceId: number, maxWidth: number, maxHeight: number): ThumbnailInfo;
    /** {zh}
     * @region 屏幕共享
     * @brief 发布本地屏幕共享流到房间。
     * @return
     ...
     */
    startAudioMixing(id: number, file_path: string, mixingconfig: AudioMixingConfig): number;
    /** {zh}
     * @region 混音
     * @brief 停止播放音乐文件及混音
     * @param id 混音 ID
     ...
     */
    stopAudioMixing(id: number): number;
    /**
     * @type api
     * @region 混音
     * @brief 暂停播放音乐文件及混音
     ...
     */
    pauseAudioMixing(id: number): number;
    /** {zh}
     * @region 混音
     * @brief 恢复播放音乐文件及混音
     * @param id
     ...
     */
    resumeAudioMixing(id: number): number;
    /** {zh}
     * @region 混音
     ...
     */
    setAudioMixingVolume(id: number, volume: number, type: number): number;
    /** {zh}
     * @region 混音
     * @brief 获取音乐文件时长
     * @param id 混音 ID
     ...
     */
    setAudioMixingPosition(id: number, pos: number): number;
    /** {zh}
     * @type api
     * @region 混音
     * @brief 预加载指定音乐文件到内存中
     ...
     */
    preloadAudioMixing(id: number, file_path: string): number;
    /** {zh}
     * @type api
     * @region 混音
     * @brief 卸载指定音乐文件
     ...
     */
    unloadAudioMixing(id: number): number;
    /** {zh}
     * @type api
     * @region 视频设备管理
     ...
     */
    enumerateVideoCaptureDevices(): Object;
    /** {zh}
     * @type api
     * @region 视频设备管理
     * @brief 设置当前视频采集设备
     ...
     * + !0：方法调用失败<br>
     */
    setVideoCaptureDevice(deviceId: string): number;
    /** {zh}
     * @type api
     * @region 视频设备管理
    ...
    */
    enumerateAudioPlaybackDevices(): Object;
    /** {zh}
     * @type api
     * @region 音频设备管理
     ...
     */
    enumerateAudioCaptureDevices(): Object;
    /** {zh}
     * @type api
     * @region 音频设备管理
     * @brief 设置音频播放设备。
     ...
     * + <0：方法调用失败<br>
     */
    setAudioCaptureDevice(deviceId: string): number;
    /** {zh}
     * @type api
     * @region 音频设备管理
     * @brief 获取当前音频播放设备 ID。
     ...
     */
    startAudioPlaybackDeviceTest(test_audio_file_path: String): number;
    /** {zh}
      * @type api
      * @region 音频设备管理
      * @brief 停止音频播放设备测试。
     ...
     */
    startAudioCaptureDeviceTest(indication_interval: number): number;
    /** {zh}
     * @type api
     * @region 音频设备管理
     * @brief 停止音频采集设备测试。
     ...
     */
    stopAudioCaptureDeviceTest(): number;
    /** {zh}
     * @type api
     * @region 音频设备管理
     * @brief 设置当前音频播放设备音量
    ...
    */
     ...
     */
    startAudioDeviceLoopbackTest(indication_interval: number): number;
    /** {zh}
     * @type api
     * @region 音频设备管理
     * @brief 停止音频设备回路测试。
     ...
     */
    initAudioPlaybackDeviceForTest(deviceId: string): number;
    /** {zh}
     * @type api
     * @region 音频设备管理
     * @brief 尝试初始化音频播放设备，可检测出设备不存在、权限被拒绝/禁用等异常问题。
     ...
     *        2. 检测成功不代表设备一定可以启动成功，还可能因设备被其他应用进程独占，或 CPU/内存不足等原因导致启动失败。
     */
    initAudioCaptureDeviceForTest(deviceId: string): number;
    /** {zh}
     * @type api
     * @region 音频设备管理
     ...
     */
    setRemoteUserPriority(userId: string, priority: RemoteUserPriority): number;
    /** {zh}
     ...
     */
    subscribeUserStream(user_id: string, stream_type: number, media_type: number, subConfig: SubscribeVideoConfig): number;
    /** {zh}
     ...
     * */
    unsubscribe(userId: string, isScreen: boolean): number;
    /** {zh}
     * @region 流消息
     ...
     */
    sendUserMessage(userId: string, message: string): number;
    /** {zh}
       * @type api
       * @region 多房间
       ...
       */
    sendUserBinaryMessage(uid: string, length: number, message: Uint8Array): number;
    /** {zh}
       * @type api
       * @region 音频数据回调
       ...
       */
    setRecordingAudioFrameParameters(sample_rate: number, channels: number): number;
    /** {zh}
     * @type api
     * @region 音频数据回调
     ...
     */
    setPlaybackAudioFrameParameters(sample_rate: number, channels: number): number;
    /** {zh}
     * @type api
     * @region 音频数据回调
     ...
     */
    setMixedAudioFrameParameters(sample_rate: number, channels: number): number;
    /** {zh}
      * @type api
      * @region 本地录制
      ...
      */
    startFileRecording(type: Number, config: RecordingConfig): number;
    /** {zh}
       * @type api
       * @region 本地录制
       * @brief 停止本地录制
    ...
    /** {zh}
      ...
      * + <0: 方法调用失败<br>
    */
    startASR(asr_config: RTCASRConfig): number;
    /** {zh}
     * @type api
     * @region 语音识别服务
     * @brief 关闭语音识别服务
    ...
    /** {zh}
       ...
       */
    SendUserMessageOutsideRoom(uid: String, message: String): number;
    /** {zh}
     * @type api
     * @region 错误码
     * @brief 获取错误码的描述
    ...
    /** {zh}
       ...
       */
    sendUserBinaryMessageOutsideRoom(uid: String, length: number, message: String): number;
    /** {zh}
     * @type api
     * @region 实时消息通信
     ...
     */
    sendServerBinaryMessage(length: number, message: String): number;
    /** {zh}
     * @hidden
     * @brief 关闭背景
     * @return + 0: 方法调用成功
     ...
     */
    setBackgroundSticker(effectNodePaths: string, source_path: string): any;
    /** {zh}
     * @type api
     * @region 视频特效
     * @brief 视频特效许可证检查
     ...
     */
    checkLicense(licensePath: string): number;
    /** {zh}
     * @type api
     * @region 视频特效
     ...
     */
    enableEffect(enabled: boolean): number;
    /** {zh}
       * @region 视频特效
       * @brief 设置视频特效算法模型路径
       ...
       * + !0：失败<br>
       */
    setAlgoModelPath(modelPath: string): number;
    /** {zh}
     * @type api
     * @region 视频特效
     ...
     */
    setEffectNodes(effectNodePaths: string[]): number;
    /** {zh}
     * @type api
     * @region 视频特效
     * @brief 设置特效强度
     ...
     * + <0: 调用失败，具体错误码，请参考 [CV SDK 文档](https://www.volcengine.com/docs/6705/102042)。
     */
    updateNode(nodePath: string, nodeKey: string, nodeValue: number): number;
    /** {zh}
     * @type api
     * @region 视频特效
     * @brief 设置颜色滤镜
     ...
     * + <0: 调用失败，具体错误码，请参考 [CV SDK 文档](https://www.volcengine.com/docs/6705/102042)。
     */
    setColorFilter(resPath: string): number;
    /** {zh}
     * @type api
     * @region 视频特效
     * @brief 设置已启用颜色滤镜的强度
     ...
     */
    sendSEIMessage(stream_index: number, message: Uint8Array, repeat_count: number): number;
    /** {zh}
     * @type api
     * @region 屏幕共享
     ...
     */
    startScreenAudioCapture(): number;
    /** {zh}
      * @type api
      * @region 屏幕共享
    ...
    /** {zh}
       ...
       */
    setRuntimeParameters(json_string: String): void;
    /** {zh}
       * @region 加密
     ...
     */
    setEncryptInfo(encrypt_type: number, key: string): void;
    /** {zh}
     ...
     */
    startLiveTranscoding(param: TranscoderParam): number;
    /** {zh}
     * @brief 停止转推直播。<br>
     * @return
     * + 0：成功
     ...
     */
    updateLiveTranscoding(param: TranscoderParam): number;
    /** {zh}
     ...
     *         `-1`: 失败
     */
    setupLocalVideo(view: HTMLDivElement, renderOptions?: RenderOptions): number;
    /** {zh}
     ...
     *         `-1`: 失败
     */
    setupRemoteVideo(userId: string, view: HTMLDivElement, renderOptions?: RenderOptions): number;
    /** {zh}
     ...
     */
    removeRemoteVideo(userId: string): number;
    /** {zh}
     ...
     */
    setupLocalScreen(view: HTMLDivElement, renderOptions?: RenderOptions): number;
    /** {zh}
     * @brief 解绑屏幕共享流已绑定的视图
     * @return 0：成功<br>
     *         !0: 失败
     ...
     */
    setupRemoteScreen(userId: string, view: HTMLDivElement, renderOptions?: RenderOptions): number;
    /** {zh}
     ...
     */
    removeRemoteScreen(userId: string): number;
    /**
     * @private
     */
    OnLeaveRoom(): void;
     ...
     * @private
     */
    OnUserJoined(obj: any): void;
    /**
     * @private
     */
    OnUserLeave(obj: any): void;
    /**
     * @private
     */
    OnLocalVideoFrame(obj: any): void;
    /**
     * @private
     */
    OnLocalScreenFrame(obj: any): void;
    /**
     * @private
     */
    OnRemoteVideoFrame(obj: any): void;
    /**
     * @private
     */
    OnRemoteScreenFrame(obj: any): void;
    /**
     * @private
     */
    clearLocalVideoCanvas(): void;
    /**
     * @private
     */
    clearLocalScreenCanvas(): void;
    /**
     * @private
     */
    clearRemoteVideoCanvas(userId: string): void;
    /**
     * @private
     */
    clearAllRemoteVideoCanvas(): void;
    /**
     * @private
     */
    clearRemoteScreenCanvas(userId: string): void;
    /**
     * @private
     */
    cbEngine(obj: any): void;
    /**
     * @private
     */
     ...
     * @private
     */
    processCallback(obj: any): void;
    /**
     * @private
     */
    convertYUVBuffer(obj: any): void;
    /**
     * @private
     */
   ...
   */
    ...
    */
    ...
    /** {zh}
      ...
      * @param mix_type 合流类型
      */
    OnStreamMixingEvent(event: StreamMixingEvent, event_data: String, error: number, mix_type: StreamMixingType): void;
    /** {zh}
     * @type callback
     * @region 转推直播
     * @brief 合流视频帧回调
