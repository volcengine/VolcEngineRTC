...
export declare enum SubscribeState {
     ...
     * @hidden
     */
    SUB_STATE_FAILED_NOT_IN_ROOM = 1,
    /**
     * @brief 没有找到流
     */
    SUB_STATE_FAILED_STREAM_NOT_FOUND = 2
}
/**
 * @type keytype
 * @brief 订阅流配置参数。
 ...
 *      网络不好时的编码策略
 */
export declare enum EncodePreference {
    /**
     * @brief 关闭
     */
     ...
     * @brief 保持帧率
     */
    EncodePreferenceFramerate = 1,
    /**
     * @brief 保持画质
     */
    EncodePreferenceQuality = 2,
    /**
     * @brief 平衡模式
     */
    EncodePreferenceBalance = 3
}
