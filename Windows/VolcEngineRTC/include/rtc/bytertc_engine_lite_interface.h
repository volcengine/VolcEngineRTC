...
public:
     ...
     *       + 调用 StopAudioCapture{@link #StopAudioCapture} 可以关闭音频采集设备，否则，SDK
     * 只会在销毁引擎的时候自动关闭设备。  <br>
     ...
     * @param [in] index 主流 or 屏幕流。参看 StreamIndex{@link #StreamIndex}。
