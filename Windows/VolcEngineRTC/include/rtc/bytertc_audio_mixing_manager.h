...
public:
     ...
     * @param [in] file_path 用于混音文件路径。可以是本地文件的绝对路径或在线音频的 url。<br>
     *        不同平台支持的音频文件格式: <br>
     *        <table>
     ...
     * @notes <br>
     *        + 调用本方法设置音频文件的声道模式前，需要先调用 StartAudioMixing{@link #StartAudioMixing} 开始播放音频文件。<br>
     *        + 此方法对 EnableAudioMixingFrame{@link #EnableAudioMixingFrame} 播放的音乐无效。
     */
    virtual void SetAudioMixingDualMonoMode(int id, AudioMixingDualMonoMode mode) = 0;
