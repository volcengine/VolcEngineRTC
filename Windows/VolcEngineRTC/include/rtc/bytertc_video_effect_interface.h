...
public:
     ...
     *      + <0: 调用失败，具体错误码请参考 <a href="http://ailab-cv-sdk.bytedance.com/docs/2036/99783/">CV SDK 文档 </a>。
     ...
     *          通过此接口获取授权消息后，你必须参考 <a href="http://ailab-cv-sdk.bytedance.com/docs/2036/99798/">在线授权说明</a>，  <br>
     ...
     *        特效素材包路径
     * @param [in] nodeKey  <br>
     *        需要设置的素材 key 名称，取值请参考 <a href="http://ailab-cv-sdk.bytedance.com/docs/2036/99769/"> 素材 key 对应说明 </a>。
