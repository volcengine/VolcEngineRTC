...
namespace sio
{
    ...
    public:
        ...
        void connect(const std::string& uri, const std::string &path);

        void connect(const std::string& uri, const std::string &path, const std::map<std::string,std::string>& query);
