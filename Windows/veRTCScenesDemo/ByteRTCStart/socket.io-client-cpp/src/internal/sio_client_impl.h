...
#undef SYNTHESIS_SETTER
        ...
        void connect(const std::string& uri, const std::string &path, const std::map<std::string, std::string>& queryString,
    ...
    private:
        ...
        void connect_impl(const std::string& uri, const std::string &path, const std::string& query);
