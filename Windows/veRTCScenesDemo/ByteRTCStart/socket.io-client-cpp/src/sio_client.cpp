...
namespace sio
{
    ...
    void client::connect(const std::string& uri, const std::string &path)
    {
        m_impl->connect(uri, path, {}, {});
    }

    void client::connect(const std::string& uri, const std::string &path, const std::map<string,string>& query)
    {
        m_impl->connect(uri, path, query, {});
    }

    void client::connect(const std::string& uri, const std::string &path, const std::map<std::string,std::string>& query,
                         const std::map<std::string,std::string>& http_extra_headers)
    {
        m_impl->connect(uri, path, query, http_extra_headers);
    }
