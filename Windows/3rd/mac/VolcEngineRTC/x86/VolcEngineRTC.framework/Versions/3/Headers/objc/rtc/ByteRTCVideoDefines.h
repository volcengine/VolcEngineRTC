 ...
 * @locale zh
 * @type keytype
 * @brief 编码Alpha通道视频帧的布局
 */
/** {en}
 * @type keytype
 * @brief The layout of the encoded alpha channel video frame
 */
typedef NS_ENUM(NSInteger, ByteRTCAlphaLayout) {
     ...
     */
    /** {en}
     * @brief Alpha data goes to the top
     */
     ...
     */
    /** {en}
     * @brief Alpha data goes to the bottom
     */
     ...
     */
    /** {en}
     * @brief Alpha data goes to the left
     */
     ...
     */
    /** {en}
     * @brief Alpha data goes to the right
     */
