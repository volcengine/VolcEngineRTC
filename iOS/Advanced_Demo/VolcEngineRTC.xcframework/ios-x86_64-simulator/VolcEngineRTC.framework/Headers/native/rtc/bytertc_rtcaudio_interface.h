...
public:
     ...
     * @region 音频设备管理
     * @brief 获取当前音频播放设备  <br>
     *        音频播放设备发生变化时，会收到 onAudioRouteChanged{@link #IRTCAudioEventHandler#onAudioRouteChanged}
     * 回调。
   ...
   virtual void disableAudioProcessor(AudioProcessorMethod method) = 0;
     ...
     * @notes  <br>
     *       + 成功调用本接口后，每 2s 会收到一次 onNetworkDetectionResult{@link #IRTCAudioEventHandler#onNetworkDetectionResult} 回调，通知探测结果；  <br>
