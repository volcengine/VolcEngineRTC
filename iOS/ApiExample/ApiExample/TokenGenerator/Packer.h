...
friend rtc::tools::Packer & operator<< (rtc::tools::Packer& p, const name & x) \
{	\
    p << x.name1; \
    return p;\
}\
friend rtc::tools::Unpacker & operator>> (rtc::tools::Unpacker & p, name & x) \
{			\
  p >> x.name1; \
    return p;\
}
